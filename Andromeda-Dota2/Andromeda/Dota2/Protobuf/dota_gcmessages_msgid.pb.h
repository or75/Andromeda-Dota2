...
#ifndef GOOGLE_PROTOBUF_INCLUDED_dota_5fgcmessages_5fmsgid_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_dota_5fgcmessages_5fmsgid_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_dota_5fgcmessages_5fmsgid_2eproto
...
struct TableStruct_dota_5fgcmessages_5fmsgid_2eproto {
  static const uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_dota_5fgcmessages_5fmsgid_2eproto;
PROTOBUF_NAMESPACE_OPEN
PROTOBUF_NAMESPACE_CLOSE
...
template<typename T>
inline const std::string& EDOTAGCMsg_Name(T enum_t_value) {
  static_assert(::std::is_same<T, EDOTAGCMsg>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function EDOTAGCMsg_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    EDOTAGCMsg_descriptor(), enum_t_value);
}
inline bool EDOTAGCMsg_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, EDOTAGCMsg* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<EDOTAGCMsg>(
...
template <> struct is_proto_enum< ::EDOTAGCMsg> : ::std::true_type {};
template <>
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_dota_5fgcmessages_5fmsgid_2eproto
