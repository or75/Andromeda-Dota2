...
class CMsgEventActionData;
struct CMsgEventActionDataDefaultTypeInternal;
extern CMsgEventActionDataDefaultTypeInternal _CMsgEventActionData_default_instance_;
...
class CMsgPeriodicResourceData;
struct CMsgPeriodicResourceDataDefaultTypeInternal;
extern CMsgPeriodicResourceDataDefaultTypeInternal _CMsgPeriodicResourceData_default_instance_;
class CSODOTALobby;
...
template<> ::CMsgEventActionData* Arena::CreateMaybeMessage<::CMsgEventActionData>(Arena*);
...
template<> ::CMsgPeriodicResourceData* Arena::CreateMaybeMessage<::CMsgPeriodicResourceData>(Arena*);
...
enum CSODOTALobby_LobbyType : int {
  ...
  CSODOTALobby_LobbyType_AUTOMATED_BOT_ONLY_MATCH = 16
};
...
constexpr CSODOTALobby_LobbyType CSODOTALobby_LobbyType_LobbyType_MAX = CSODOTALobby_LobbyType_AUTOMATED_BOT_ONLY_MATCH;
...
class CMsgEventActionData final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:CMsgEventActionData) */ {
 public:
  inline CMsgEventActionData() : CMsgEventActionData(nullptr) {}
  ~CMsgEventActionData() override;
  explicit PROTOBUF_CONSTEXPR CMsgEventActionData(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  CMsgEventActionData(const CMsgEventActionData& from);
  CMsgEventActionData(CMsgEventActionData&& from) noexcept
    : CMsgEventActionData() {
    *this = ::std::move(from);
  }

  inline CMsgEventActionData& operator=(const CMsgEventActionData& from) {
    CopyFrom(from);
    return *this;
  }
  inline CMsgEventActionData& operator=(CMsgEventActionData&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const CMsgEventActionData& default_instance() {
    return *internal_default_instance();
  }
  static inline const CMsgEventActionData* internal_default_instance() {
    return reinterpret_cast<const CMsgEventActionData*>(
               &_CMsgEventActionData_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    3;

  friend void swap(CMsgEventActionData& a, CMsgEventActionData& b) {
    a.Swap(&b);
  }
  inline void Swap(CMsgEventActionData* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(CMsgEventActionData* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  CMsgEventActionData* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<CMsgEventActionData>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const CMsgEventActionData& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const CMsgEventActionData& from) {
    CMsgEventActionData::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(CMsgEventActionData* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "CMsgEventActionData";
  }
  protected:
  explicit CMsgEventActionData(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  private:
  bool _internal_has_action_score() const;
  public:
  void clear_action_score();
  uint32_t action_score() const;
  void set_action_score(uint32_t value);
  private:
  uint32_t _internal_action_score() const;
  void _internal_set_action_score(uint32_t value);
  public:

  // @@protoc_insertion_point(class_scope:CMsgEventActionData)
 private:
  class _Internal;
...
class CMsgPeriodicResourceData final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:CMsgPeriodicResourceData) */ {
 public:
  inline CMsgPeriodicResourceData() : CMsgPeriodicResourceData(nullptr) {}
  ~CMsgPeriodicResourceData() override;
  explicit PROTOBUF_CONSTEXPR CMsgPeriodicResourceData(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  CMsgPeriodicResourceData(const CMsgPeriodicResourceData& from);
  CMsgPeriodicResourceData(CMsgPeriodicResourceData&& from) noexcept
    : CMsgPeriodicResourceData() {
    *this = ::std::move(from);
  }

  inline CMsgPeriodicResourceData& operator=(const CMsgPeriodicResourceData& from) {
    CopyFrom(from);
    return *this;
  }
  inline CMsgPeriodicResourceData& operator=(CMsgPeriodicResourceData&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const CMsgPeriodicResourceData& default_instance() {
    return *internal_default_instance();
  }
  static inline const CMsgPeriodicResourceData* internal_default_instance() {
    return reinterpret_cast<const CMsgPeriodicResourceData*>(
               &_CMsgPeriodicResourceData_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    4;

  friend void swap(CMsgPeriodicResourceData& a, CMsgPeriodicResourceData& b) {
    a.Swap(&b);
  }
  inline void Swap(CMsgPeriodicResourceData* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(CMsgPeriodicResourceData* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  CMsgPeriodicResourceData* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<CMsgPeriodicResourceData>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const CMsgPeriodicResourceData& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const CMsgPeriodicResourceData& from) {
    CMsgPeriodicResourceData::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(CMsgPeriodicResourceData* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "CMsgPeriodicResourceData";
  }
  protected:
  explicit CMsgPeriodicResourceData(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  // @@protoc_insertion_point(class_scope:CMsgPeriodicResourceData)
 private:
  class _Internal;
...
class CMsgLobbyEventPoints_AccountPoints final :
 ...
 public:
  ...
  enum : int {
    ...
    kExtraEventMessagesFieldNumber = 32,
  ...
  ::CMsgEventActionData* mutable_event_game_custom_actions(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CMsgEventActionData >*
      mutable_event_game_custom_actions();
  private:
  const ::CMsgEventActionData& _internal_event_game_custom_actions(int index) const;
  ::CMsgEventActionData* _internal_add_event_game_custom_actions();
  public:
  const ::CMsgEventActionData& event_game_custom_actions(int index) const;
  ::CMsgEventActionData* add_event_game_custom_actions();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CMsgEventActionData >&
  ...
  ::CMsgEventActionData* mutable_networked_event_actions(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CMsgEventActionData >*
      mutable_networked_event_actions();
  private:
  const ::CMsgEventActionData& _internal_networked_event_actions(int index) const;
  ::CMsgEventActionData* _internal_add_networked_event_actions();
  public:
  const ::CMsgEventActionData& networked_event_actions(int index) const;
  ::CMsgEventActionData* add_networked_event_actions();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CMsgEventActionData >&
  ...
  ::CMsgPeriodicResourceData* mutable_periodic_resources(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CMsgPeriodicResourceData >*
      mutable_periodic_resources();
  private:
  const ::CMsgPeriodicResourceData& _internal_periodic_resources(int index) const;
  ::CMsgPeriodicResourceData* _internal_add_periodic_resources();
  public:
  const ::CMsgPeriodicResourceData& periodic_resources(int index) const;
  ::CMsgPeriodicResourceData* add_periodic_resources();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CMsgPeriodicResourceData >&
 ...
 private:
  ...
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::internal::HasBits<1> _has_bits_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CMsgEventActionData > event_game_custom_actions_;
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CMsgEventActionData > networked_event_actions_;
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CMsgPeriodicResourceData > periodic_resources_;
...
class CSODOTALobby final :
 ...
 public:
  ...
  static constexpr LobbyType AUTOMATED_BOT_ONLY_MATCH =
    CSODOTALobby_LobbyType_AUTOMATED_BOT_ONLY_MATCH;
  ...
  enum : int {
    ...
    kRequestedHeroTeamsFieldNumber = 132,
    ...
    kCurrentPrimaryEventForDisplayFieldNumber = 104,
  ...
  int requested_hero_teams_size() const;
  private:
  int _internal_requested_hero_teams_size() const;
  public:
  void clear_requested_hero_teams();
  private:
  int32_t _internal_requested_hero_teams(int index) const;
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >&
      _internal_requested_hero_teams() const;
  void _internal_add_requested_hero_teams(int32_t value);
  ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >*
      _internal_mutable_requested_hero_teams();
  public:
  int32_t requested_hero_teams(int index) const;
  void set_requested_hero_teams(int index, int32_t value);
  void add_requested_hero_teams(int32_t value);
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >&
      requested_hero_teams() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >*
      mutable_requested_hero_teams();
  ...
  bool has_current_primary_event_for_display() const;
  private:
  bool _internal_has_current_primary_event_for_display() const;
  public:
  void clear_current_primary_event_for_display();
  ::EEvent current_primary_event_for_display() const;
  void set_current_primary_event_for_display(::EEvent value);
  private:
  ::EEvent _internal_current_primary_event_for_display() const;
  void _internal_set_current_primary_event_for_display(::EEvent value);
  public:
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t > requested_hero_teams_;
    ...
    int current_primary_event_for_display_;
...
class CSODOTAServerLobby final :
 ...
 public:
  ...
  bool has_broadcast_active() const;
  private:
  bool _internal_has_broadcast_active() const;
  public:
  void clear_broadcast_active();
  bool broadcast_active() const;
  void set_broadcast_active(bool value);
  private:
  bool _internal_broadcast_active() const;
  void _internal_set_broadcast_active(bool value);
  public:
...
class CSODOTAStaticLobby final :
 ...
 public:
  ...
  enum : int {
    ...
    kIsLastMatchInSeriesFieldNumber = 3,
  };
  ...
  bool has_is_last_match_in_series() const;
  private:
  bool _internal_has_is_last_match_in_series() const;
  public:
  void clear_is_last_match_in_series();
  bool is_last_match_in_series() const;
  void set_is_last_match_in_series(bool value);
  private:
  bool _internal_is_last_match_in_series() const;
  void _internal_set_is_last_match_in_series(bool value);
  public:
...
class CSODOTAServerStaticLobby final :
 ...
 public:
  ...
  bool has_broadcast_url() const;
  private:
  bool _internal_has_broadcast_url() const;
  public:
  void clear_broadcast_url();
  const std::string& broadcast_url() const;
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_broadcast_url(ArgT0&& arg0, ArgT... args);
  std::string* mutable_broadcast_url();
  PROTOBUF_NODISCARD std::string* release_broadcast_url();
  void set_allocated_broadcast_url(std::string* broadcast_url);
  private:
  const std::string& _internal_broadcast_url() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_broadcast_url(const std::string& value);
  std::string* _internal_mutable_broadcast_url();
  public:
...
// optional uint32 action_id = 1;
inline bool CMsgEventActionData::_internal_has_action_id() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline bool CMsgEventActionData::has_action_id() const {
  return _internal_has_action_id();
}
inline void CMsgEventActionData::clear_action_id() {
  _impl_.action_id_ = 0u;
  _impl_._has_bits_[0] &= ~0x00000001u;
}
inline uint32_t CMsgEventActionData::_internal_action_id() const {
  return _impl_.action_id_;
}
inline uint32_t CMsgEventActionData::action_id() const {
  // @@protoc_insertion_point(field_get:CMsgEventActionData.action_id)
  return _internal_action_id();
}
inline void CMsgEventActionData::_internal_set_action_id(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.action_id_ = value;
}
inline void CMsgEventActionData::set_action_id(uint32_t value) {
  _internal_set_action_id(value);
  // @@protoc_insertion_point(field_set:CMsgEventActionData.action_id)
}

// optional uint32 action_score = 2;
inline bool CMsgEventActionData::_internal_has_action_score() const {
  bool value = (_impl_._has_bits_[0] & 0x00000002u) != 0;
  return value;
}
inline bool CMsgEventActionData::has_action_score() const {
  return _internal_has_action_score();
}
inline void CMsgEventActionData::clear_action_score() {
  _impl_.action_score_ = 0u;
  _impl_._has_bits_[0] &= ~0x00000002u;
}
inline uint32_t CMsgEventActionData::_internal_action_score() const {
  return _impl_.action_score_;
}
inline uint32_t CMsgEventActionData::action_score() const {
  // @@protoc_insertion_point(field_get:CMsgEventActionData.action_score)
  return _internal_action_score();
}
inline void CMsgEventActionData::_internal_set_action_score(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000002u;
  _impl_.action_score_ = value;
}
inline void CMsgEventActionData::set_action_score(uint32_t value) {
  _internal_set_action_score(value);
  // @@protoc_insertion_point(field_set:CMsgEventActionData.action_score)
}
...
// optional uint32 periodic_resource_id = 1;
inline bool CMsgPeriodicResourceData::_internal_has_periodic_resource_id() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline bool CMsgPeriodicResourceData::has_periodic_resource_id() const {
  return _internal_has_periodic_resource_id();
}
inline void CMsgPeriodicResourceData::clear_periodic_resource_id() {
  _impl_.periodic_resource_id_ = 0u;
  _impl_._has_bits_[0] &= ~0x00000001u;
}
inline uint32_t CMsgPeriodicResourceData::_internal_periodic_resource_id() const {
  return _impl_.periodic_resource_id_;
}
inline uint32_t CMsgPeriodicResourceData::periodic_resource_id() const {
  // @@protoc_insertion_point(field_get:CMsgPeriodicResourceData.periodic_resource_id)
  return _internal_periodic_resource_id();
}
inline void CMsgPeriodicResourceData::_internal_set_periodic_resource_id(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.periodic_resource_id_ = value;
}
inline void CMsgPeriodicResourceData::set_periodic_resource_id(uint32_t value) {
  _internal_set_periodic_resource_id(value);
  // @@protoc_insertion_point(field_set:CMsgPeriodicResourceData.periodic_resource_id)
}

// optional uint32 remaining = 2;
inline bool CMsgPeriodicResourceData::_internal_has_remaining() const {
  bool value = (_impl_._has_bits_[0] & 0x00000002u) != 0;
  return value;
}
inline bool CMsgPeriodicResourceData::has_remaining() const {
  return _internal_has_remaining();
}
inline void CMsgPeriodicResourceData::clear_remaining() {
  _impl_.remaining_ = 0u;
  _impl_._has_bits_[0] &= ~0x00000002u;
}
inline uint32_t CMsgPeriodicResourceData::_internal_remaining() const {
  return _impl_.remaining_;
}
inline uint32_t CMsgPeriodicResourceData::remaining() const {
  // @@protoc_insertion_point(field_get:CMsgPeriodicResourceData.remaining)
  return _internal_remaining();
}
inline void CMsgPeriodicResourceData::_internal_set_remaining(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000002u;
  _impl_.remaining_ = value;
}
inline void CMsgPeriodicResourceData::set_remaining(uint32_t value) {
  _internal_set_remaining(value);
  // @@protoc_insertion_point(field_set:CMsgPeriodicResourceData.remaining)
}

// optional uint32 max = 3;
inline bool CMsgPeriodicResourceData::_internal_has_max() const {
  bool value = (_impl_._has_bits_[0] & 0x00000004u) != 0;
  return value;
}
inline bool CMsgPeriodicResourceData::has_max() const {
  return _internal_has_max();
}
inline void CMsgPeriodicResourceData::clear_max() {
  _impl_.max_ = 0u;
  _impl_._has_bits_[0] &= ~0x00000004u;
}
inline uint32_t CMsgPeriodicResourceData::_internal_max() const {
  return _impl_.max_;
}
inline uint32_t CMsgPeriodicResourceData::max() const {
  // @@protoc_insertion_point(field_get:CMsgPeriodicResourceData.max)
  return _internal_max();
}
inline void CMsgPeriodicResourceData::_internal_set_max(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000004u;
  _impl_.max_ = value;
}
inline void CMsgPeriodicResourceData::set_max(uint32_t value) {
  _internal_set_max(value);
  // @@protoc_insertion_point(field_set:CMsgPeriodicResourceData.max)
}
...
inline ::CMsgEventActionData* CMsgLobbyEventPoints_AccountPoints::mutable_event_game_custom_actions(int index) {
...
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CMsgEventActionData >*
...
inline const ::CMsgEventActionData& CMsgLobbyEventPoints_AccountPoints::_internal_event_game_custom_actions(int index) const {
  return _impl_.event_game_custom_actions_.Get(index);
}
inline const ::CMsgEventActionData& CMsgLobbyEventPoints_AccountPoints::event_game_custom_actions(int index) const {
...
inline ::CMsgEventActionData* CMsgLobbyEventPoints_AccountPoints::_internal_add_event_game_custom_actions() {
  return _impl_.event_game_custom_actions_.Add();
}
inline ::CMsgEventActionData* CMsgLobbyEventPoints_AccountPoints::add_event_game_custom_actions() {
  ::CMsgEventActionData* _add = _internal_add_event_game_custom_actions();
  // @@protoc_insertion_point(field_add:CMsgLobbyEventPoints.AccountPoints.event_game_custom_actions)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CMsgEventActionData >&
...
inline ::CMsgEventActionData* CMsgLobbyEventPoints_AccountPoints::mutable_networked_event_actions(int index) {
...
inline const ::CMsgEventActionData& CMsgLobbyEventPoints_AccountPoints::_internal_networked_event_actions(int index) const {
  return _impl_.networked_event_actions_.Get(index);
}
inline const ::CMsgEventActionData& CMsgLobbyEventPoints_AccountPoints::networked_event_actions(int index) const {
...
inline ::CMsgEventActionData* CMsgLobbyEventPoints_AccountPoints::_internal_add_networked_event_actions() {
  return _impl_.networked_event_actions_.Add();
}
inline ::CMsgEventActionData* CMsgLobbyEventPoints_AccountPoints::add_networked_event_actions() {
  ::CMsgEventActionData* _add = _internal_add_networked_event_actions();
...
inline ::CMsgPeriodicResourceData* CMsgLobbyEventPoints_AccountPoints::mutable_periodic_resources(int index) {
...
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CMsgPeriodicResourceData >*
...
inline const ::CMsgPeriodicResourceData& CMsgLobbyEventPoints_AccountPoints::_internal_periodic_resources(int index) const {
  return _impl_.periodic_resources_.Get(index);
}
inline const ::CMsgPeriodicResourceData& CMsgLobbyEventPoints_AccountPoints::periodic_resources(int index) const {
...
inline ::CMsgPeriodicResourceData* CMsgLobbyEventPoints_AccountPoints::_internal_add_periodic_resources() {
  return _impl_.periodic_resources_.Add();
}
inline ::CMsgPeriodicResourceData* CMsgLobbyEventPoints_AccountPoints::add_periodic_resources() {
  ::CMsgPeriodicResourceData* _add = _internal_add_periodic_resources();
  // @@protoc_insertion_point(field_add:CMsgLobbyEventPoints.AccountPoints.periodic_resources)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CMsgPeriodicResourceData >&
...
// repeated .CExtraMsgBlock extra_event_messages = 32;
inline int CMsgLobbyEventPoints_AccountPoints::_internal_extra_event_messages_size() const {
  return _impl_.extra_event_messages_.size();
}
inline int CMsgLobbyEventPoints_AccountPoints::extra_event_messages_size() const {
  return _internal_extra_event_messages_size();
}
inline ::CExtraMsgBlock* CMsgLobbyEventPoints_AccountPoints::mutable_extra_event_messages(int index) {
  // @@protoc_insertion_point(field_mutable:CMsgLobbyEventPoints.AccountPoints.extra_event_messages)
  return _impl_.extra_event_messages_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CExtraMsgBlock >*
CMsgLobbyEventPoints_AccountPoints::mutable_extra_event_messages() {
  // @@protoc_insertion_point(field_mutable_list:CMsgLobbyEventPoints.AccountPoints.extra_event_messages)
  return &_impl_.extra_event_messages_;
}
inline const ::CExtraMsgBlock& CMsgLobbyEventPoints_AccountPoints::_internal_extra_event_messages(int index) const {
  return _impl_.extra_event_messages_.Get(index);
}
inline const ::CExtraMsgBlock& CMsgLobbyEventPoints_AccountPoints::extra_event_messages(int index) const {
  // @@protoc_insertion_point(field_get:CMsgLobbyEventPoints.AccountPoints.extra_event_messages)
  return _internal_extra_event_messages(index);
}
inline ::CExtraMsgBlock* CMsgLobbyEventPoints_AccountPoints::_internal_add_extra_event_messages() {
  return _impl_.extra_event_messages_.Add();
}
inline ::CExtraMsgBlock* CMsgLobbyEventPoints_AccountPoints::add_extra_event_messages() {
  ::CExtraMsgBlock* _add = _internal_add_extra_event_messages();
  // @@protoc_insertion_point(field_add:CMsgLobbyEventPoints.AccountPoints.extra_event_messages)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CExtraMsgBlock >&
CMsgLobbyEventPoints_AccountPoints::extra_event_messages() const {
  // @@protoc_insertion_point(field_list:CMsgLobbyEventPoints.AccountPoints.extra_event_messages)
  return _impl_.extra_event_messages_;
}
...
// optional .EEvent current_primary_event_for_display = 104 [default = EVENT_ID_NONE];
inline bool CSODOTALobby::_internal_has_current_primary_event_for_display() const {
  bool value = (_impl_._has_bits_[1] & 0x10000000u) != 0;
  return value;
}
inline bool CSODOTALobby::has_current_primary_event_for_display() const {
  return _internal_has_current_primary_event_for_display();
}
inline void CSODOTALobby::clear_current_primary_event_for_display() {
  _impl_.current_primary_event_for_display_ = 0;
  _impl_._has_bits_[1] &= ~0x10000000u;
}
inline ::EEvent CSODOTALobby::_internal_current_primary_event_for_display() const {
  return static_cast< ::EEvent >(_impl_.current_primary_event_for_display_);
}
inline ::EEvent CSODOTALobby::current_primary_event_for_display() const {
  // @@protoc_insertion_point(field_get:CSODOTALobby.current_primary_event_for_display)
  return _internal_current_primary_event_for_display();
}
inline void CSODOTALobby::_internal_set_current_primary_event_for_display(::EEvent value) {
  assert(::EEvent_IsValid(value));
  _impl_._has_bits_[1] |= 0x10000000u;
  _impl_.current_primary_event_for_display_ = value;
}
inline void CSODOTALobby::set_current_primary_event_for_display(::EEvent value) {
  _internal_set_current_primary_event_for_display(value);
  // @@protoc_insertion_point(field_set:CSODOTALobby.current_primary_event_for_display)
}
...
// repeated int32 requested_hero_teams = 132;
inline int CSODOTALobby::_internal_requested_hero_teams_size() const {
  return _impl_.requested_hero_teams_.size();
}
inline int CSODOTALobby::requested_hero_teams_size() const {
  return _internal_requested_hero_teams_size();
}
inline void CSODOTALobby::clear_requested_hero_teams() {
  _impl_.requested_hero_teams_.Clear();
}
inline int32_t CSODOTALobby::_internal_requested_hero_teams(int index) const {
  return _impl_.requested_hero_teams_.Get(index);
}
inline int32_t CSODOTALobby::requested_hero_teams(int index) const {
  // @@protoc_insertion_point(field_get:CSODOTALobby.requested_hero_teams)
  return _internal_requested_hero_teams(index);
}
inline void CSODOTALobby::set_requested_hero_teams(int index, int32_t value) {
  _impl_.requested_hero_teams_.Set(index, value);
  // @@protoc_insertion_point(field_set:CSODOTALobby.requested_hero_teams)
}
inline void CSODOTALobby::_internal_add_requested_hero_teams(int32_t value) {
  _impl_.requested_hero_teams_.Add(value);
}
inline void CSODOTALobby::add_requested_hero_teams(int32_t value) {
  _internal_add_requested_hero_teams(value);
  // @@protoc_insertion_point(field_add:CSODOTALobby.requested_hero_teams)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >&
CSODOTALobby::_internal_requested_hero_teams() const {
  return _impl_.requested_hero_teams_;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >&
CSODOTALobby::requested_hero_teams() const {
  // @@protoc_insertion_point(field_list:CSODOTALobby.requested_hero_teams)
  return _internal_requested_hero_teams();
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >*
CSODOTALobby::_internal_mutable_requested_hero_teams() {
  return &_impl_.requested_hero_teams_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >*
CSODOTALobby::mutable_requested_hero_teams() {
  // @@protoc_insertion_point(field_mutable_list:CSODOTALobby.requested_hero_teams)
  return _internal_mutable_requested_hero_teams();
}
...
// optional bool broadcast_active = 3;
inline bool CSODOTAServerLobby::_internal_has_broadcast_active() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline bool CSODOTAServerLobby::has_broadcast_active() const {
  return _internal_has_broadcast_active();
}
inline void CSODOTAServerLobby::clear_broadcast_active() {
  _impl_.broadcast_active_ = false;
  _impl_._has_bits_[0] &= ~0x00000001u;
}
inline bool CSODOTAServerLobby::_internal_broadcast_active() const {
  return _impl_.broadcast_active_;
}
inline bool CSODOTAServerLobby::broadcast_active() const {
  // @@protoc_insertion_point(field_get:CSODOTAServerLobby.broadcast_active)
  return _internal_broadcast_active();
}
inline void CSODOTAServerLobby::_internal_set_broadcast_active(bool value) {
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.broadcast_active_ = value;
}
inline void CSODOTAServerLobby::set_broadcast_active(bool value) {
  _internal_set_broadcast_active(value);
  // @@protoc_insertion_point(field_set:CSODOTAServerLobby.broadcast_active)
}
...
// optional bool is_last_match_in_series = 3;
inline bool CSODOTAStaticLobby::_internal_has_is_last_match_in_series() const {
  bool value = (_impl_._has_bits_[0] & 0x00000002u) != 0;
  return value;
}
inline bool CSODOTAStaticLobby::has_is_last_match_in_series() const {
  return _internal_has_is_last_match_in_series();
}
inline void CSODOTAStaticLobby::clear_is_last_match_in_series() {
  _impl_.is_last_match_in_series_ = false;
  _impl_._has_bits_[0] &= ~0x00000002u;
}
inline bool CSODOTAStaticLobby::_internal_is_last_match_in_series() const {
  return _impl_.is_last_match_in_series_;
}
inline bool CSODOTAStaticLobby::is_last_match_in_series() const {
  // @@protoc_insertion_point(field_get:CSODOTAStaticLobby.is_last_match_in_series)
  return _internal_is_last_match_in_series();
}
inline void CSODOTAStaticLobby::_internal_set_is_last_match_in_series(bool value) {
  _impl_._has_bits_[0] |= 0x00000002u;
  _impl_.is_last_match_in_series_ = value;
}
inline void CSODOTAStaticLobby::set_is_last_match_in_series(bool value) {
  _internal_set_is_last_match_in_series(value);
  // @@protoc_insertion_point(field_set:CSODOTAStaticLobby.is_last_match_in_series)
}
...
// optional string broadcast_url = 4;
inline bool CSODOTAServerStaticLobby::_internal_has_broadcast_url() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline bool CSODOTAServerStaticLobby::has_broadcast_url() const {
  return _internal_has_broadcast_url();
}
inline void CSODOTAServerStaticLobby::clear_broadcast_url() {
  _impl_.broadcast_url_.ClearToEmpty();
  _impl_._has_bits_[0] &= ~0x00000001u;
}
inline const std::string& CSODOTAServerStaticLobby::broadcast_url() const {
  // @@protoc_insertion_point(field_get:CSODOTAServerStaticLobby.broadcast_url)
  return _internal_broadcast_url();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void CSODOTAServerStaticLobby::set_broadcast_url(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000001u;
 _impl_.broadcast_url_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:CSODOTAServerStaticLobby.broadcast_url)
}
inline std::string* CSODOTAServerStaticLobby::mutable_broadcast_url() {
  std::string* _s = _internal_mutable_broadcast_url();
  // @@protoc_insertion_point(field_mutable:CSODOTAServerStaticLobby.broadcast_url)
  return _s;
}
inline const std::string& CSODOTAServerStaticLobby::_internal_broadcast_url() const {
  return _impl_.broadcast_url_.Get();
}
inline void CSODOTAServerStaticLobby::_internal_set_broadcast_url(const std::string& value) {
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.broadcast_url_.Set(value, GetArenaForAllocation());
}
inline std::string* CSODOTAServerStaticLobby::_internal_mutable_broadcast_url() {
  _impl_._has_bits_[0] |= 0x00000001u;
  return _impl_.broadcast_url_.Mutable(GetArenaForAllocation());
}
inline std::string* CSODOTAServerStaticLobby::release_broadcast_url() {
  // @@protoc_insertion_point(field_release:CSODOTAServerStaticLobby.broadcast_url)
  if (!_internal_has_broadcast_url()) {
    return nullptr;
  }
  _impl_._has_bits_[0] &= ~0x00000001u;
  auto* p = _impl_.broadcast_url_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.broadcast_url_.IsDefault()) {
    _impl_.broadcast_url_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  return p;
}
inline void CSODOTAServerStaticLobby::set_allocated_broadcast_url(std::string* broadcast_url) {
  if (broadcast_url != nullptr) {
    _impl_._has_bits_[0] |= 0x00000001u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000001u;
  }
  _impl_.broadcast_url_.SetAllocated(broadcast_url, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.broadcast_url_.IsDefault()) {
    _impl_.broadcast_url_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:CSODOTAServerStaticLobby.broadcast_url)
}
