...
PROTOBUF_CONSTEXPR CMsgDOTAChatMessage_ChatWheelMessage::CMsgDOTAChatMessage_ChatWheelMessage(
  ...
  , /*decltype(_impl_.hero_badge_tier_)*/0u
...
PROTOBUF_CONSTEXPR CMsgDOTAChatMessage::CMsgDOTAChatMessage(
  ...
  , /*decltype(_impl_.requested_hero_id_)*/0
  , /*decltype(_impl_.requested_hero_facet_key_)*/uint64_t{0u}
...
const uint32_t TableStruct_dota_5fgcmessages_5fclient_5fchat_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::CMsgDOTAChatMessage_ChatWheelMessage, _impl_.message_text_),
  PROTOBUF_FIELD_OFFSET(::CMsgDOTAChatMessage_ChatWheelMessage, _impl_.hero_badge_tier_),
  3,
  1,
  0,
  2,
  ...
  PROTOBUF_FIELD_OFFSET(::CMsgDOTAChatMessage, _impl_.requested_hero_id_),
  PROTOBUF_FIELD_OFFSET(::CMsgDOTAChatMessage, _impl_.requested_hero_facet_key_),
  10,
  9,
  0,
  1,
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 146, 194, -1, sizeof(::CMsgDOTAChatMessage)},
  { 236, 246, -1, sizeof(::CMsgDOTAChatMember)},
  { 250, 267, -1, sizeof(::CMsgDOTAJoinChatChannelResponse)},
  { 278, 289, -1, sizeof(::CMsgDOTAOtherJoinedChatChannel)},
  { 294, 303, -1, sizeof(::CMsgDOTAOtherLeftChatChannel)},
  { 306, -1, -1, sizeof(::CMsgDOTARequestChatChannelList)},
  { 312, 321, -1, sizeof(::CMsgDOTARequestChatChannelListResponse_ChatChannel)},
  { 324, -1, -1, sizeof(::CMsgDOTARequestChatChannelListResponse)},
  { 331, 341, -1, sizeof(::CMsgDOTAChatGetUserListResponse_Member)},
  { 345, 353, -1, sizeof(::CMsgDOTAChatGetUserListResponse)},
  { 355, 363, -1, sizeof(::CMsgDOTAChatGetMemberCount)},
  { 365, 374, -1, sizeof(::CMsgDOTAChatGetMemberCountResponse)},
  { 377, 387, -1, sizeof(::CMsgDOTAChatRegionsEnabled_Region)},
  { 391, 399, -1, sizeof(::CMsgDOTAChatRegionsEnabled)},
};
...
const char descriptor_table_protodef_dota_5fgcmessages_5fclient_5fchat_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\n\027suggest_pick_hero_facet\030+ \001(\r\022\031\n\021reque"
  "sted_hero_id\030, \001(\005\022 \n\030requested_hero_fac"
  "et_key\030- \001(\004\032>\n\010DiceRoll\022\020\n\010roll_min\030\001 \001"
  ...
  "answer_index\030\002 \001(\r\022\037\n\027party_questions_co"
  "rrect\030\003 \001(\r\022\036\n\026party_questions_viewed\030\004 "
  "\001(\r\022\033\n\023party_trivia_points\030\005 \001(\r\0326\n\017Play"
  "erDraftPick\022\025\n\tplayer_id\030\001 \001(\005:\002-1\022\014\n\004te"
  "am\030\002 \001(\005\032v\n\020ChatWheelMessage\022\036\n\nmessage_"
  "id\030\001 \001(\r:\n4294967295\022\023\n\013emoticon_id\030\002 \001("
  "\r\022\024\n\014message_text\030\003 \001(\t\022\027\n\017hero_badge_ti"
...
const ::_pbi::DescriptorTable descriptor_table_dota_5fgcmessages_5fclient_5fchat_2eproto = {
    false, false, 5378, descriptor_table_protodef_dota_5fgcmessages_5fclient_5fchat_2eproto,
...
class CMsgDOTAChatMessage_ChatWheelMessage::_Internal {
 public:
  ...
  static void set_has_hero_badge_tier(HasBits* has_bits) {
    (*has_bits)[0] |= 4u;
  }
};
...
CMsgDOTAChatMessage_ChatWheelMessage::CMsgDOTAChatMessage_ChatWheelMessage(const CMsgDOTAChatMessage_ChatWheelMessage& from)
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.hero_badge_tier_){}
...
// @@protoc_insertion_point(message_clear_start:CMsgDOTAChatMessage.ChatWheelMessage)
  ...
  if (cached_has_bits & 0x0000000eu) {
    ::memset(&_impl_.emoticon_id_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&_impl_.hero_badge_tier_) -
        reinterpret_cast<char*>(&_impl_.emoticon_id_)) + sizeof(_impl_.hero_badge_tier_));
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 26)) {
          ...
          CHK_(ptr);
          #ifndef NDEBUG
          ::_pbi::VerifyUTF8(str, "CMsgDOTAChatMessage.ChatWheelMessage.message_text");
          #endif  // !NDEBUG
        } else
          goto handle_unusual;
        continue;
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 32)) {
          _Internal::set_has_hero_badge_tier(&has_bits);
          _impl_.hero_badge_tier_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* CMsgDOTAChatMessage_ChatWheelMessage::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000001u) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormat::VerifyUTF8StringNamedField(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormat::SERIALIZE,
      "CMsgDOTAChatMessage.ChatWheelMessage.message_text");
    target = stream->WriteStringMaybeAliased(
  ...
  if (cached_has_bits & 0x00000004u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt32ToArray(4, this->_internal_hero_badge_tier(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:CMsgDOTAChatMessage.ChatWheelMessage)
  ...
  if (cached_has_bits & 0x0000000fu) {
    ...
    // optional uint32 hero_badge_tier = 4;
    if (cached_has_bits & 0x00000004u) {
      total_size += ::_pbi::WireFormatLite::UInt32SizePlusOne(this->_internal_hero_badge_tier());
    }
...
void CMsgDOTAChatMessage_ChatWheelMessage::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (cached_has_bits & 0x0000000fu) {
    ...
    if (cached_has_bits & 0x00000004u) {
      _this->_impl_.hero_badge_tier_ = from._impl_.hero_badge_tier_;
    }
    if (cached_has_bits & 0x00000008u) {
...
void CMsgDOTAChatMessage_ChatWheelMessage::InternalSwap(CMsgDOTAChatMessage_ChatWheelMessage* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(CMsgDOTAChatMessage_ChatWheelMessage, _impl_.hero_badge_tier_)
      + sizeof(CMsgDOTAChatMessage_ChatWheelMessage::_impl_.hero_badge_tier_)
      - PROTOBUF_FIELD_OFFSET(CMsgDOTAChatMessage_ChatWheelMessage, _impl_.emoticon_id_)>(
          reinterpret_cast<char*>(&_impl_.emoticon_id_),
          reinterpret_cast<char*>(&other->_impl_.emoticon_id_));
...
class CMsgDOTAChatMessage::_Internal {
 public:
  ...
  static void set_has_requested_hero_id(HasBits* has_bits) {
    (*has_bits)[1] |= 32u;
  }
  static void set_has_requested_hero_facet_key(HasBits* has_bits) {
    (*has_bits)[1] |= 64u;
  }
};
...
CMsgDOTAChatMessage::CMsgDOTAChatMessage(const CMsgDOTAChatMessage& from)
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.requested_hero_id_){}
    , decltype(_impl_.requested_hero_facet_key_){}
...
// @@protoc_insertion_point(message_clear_start:CMsgDOTAChatMessage)
  ...
  if (cached_has_bits & 0x000000ffu) {
    ::memset(&_impl_.ctrl_is_down_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&_impl_.requested_hero_facet_key_) -
        reinterpret_cast<char*>(&_impl_.ctrl_is_down_)) + sizeof(_impl_.requested_hero_facet_key_));
    ...
    switch (tag >> 3) {
      ...
      case 44:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 96)) {
          _Internal::set_has_requested_hero_id(&_impl_._has_bits_);
          _impl_.requested_hero_id_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 45:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 104)) {
          _Internal::set_has_requested_hero_facet_key(&_impl_._has_bits_);
          _impl_.requested_hero_facet_key_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* CMsgDOTAChatMessage::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000020u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteInt32ToArray(44, this->_internal_requested_hero_id(), target);
  }

  // optional uint64 requested_hero_facet_key = 45;
  if (cached_has_bits & 0x00000040u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt64ToArray(45, this->_internal_requested_hero_facet_key(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:CMsgDOTAChatMessage)
  ...
  if (cached_has_bits & 0x000000ffu) {
    ...
    if (cached_has_bits & 0x00000020u) {
      total_size += 2 +
        ::_pbi::WireFormatLite::Int32Size(
          this->_internal_requested_hero_id());
    }
    ...
    if (cached_has_bits & 0x00000040u) {
      total_size += 2 +
        ::_pbi::WireFormatLite::UInt64Size(
          this->_internal_requested_hero_facet_key());
    }
...
void CMsgDOTAChatMessage::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (cached_has_bits & 0x000000ffu) {
    ...
    if (cached_has_bits & 0x00000020u) {
      _this->_impl_.requested_hero_id_ = from._impl_.requested_hero_id_;
    }
    if (cached_has_bits & 0x00000040u) {
      _this->_impl_.requested_hero_facet_key_ = from._impl_.requested_hero_facet_key_;
    }
    if (cached_has_bits & 0x00000080u) {
...
void CMsgDOTAChatMessage::InternalSwap(CMsgDOTAChatMessage* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(CMsgDOTAChatMessage, _impl_.requested_hero_facet_key_)
      + sizeof(CMsgDOTAChatMessage::_impl_.requested_hero_facet_key_)
      - PROTOBUF_FIELD_OFFSET(CMsgDOTAChatMessage, _impl_.dice_roll_)>(
