...
enum CMsgBotWorldState_CourierState : int {
  ...
  CMsgBotWorldState_CourierState_COURIER_STATE_GOING_TO_SECRET_SHOP = 6,
  CMsgBotWorldState_CourierState_COURIER_STATE_AT_SECRET_SHOP = 7
};
...
constexpr CMsgBotWorldState_CourierState CMsgBotWorldState_CourierState_CourierState_MAX = CMsgBotWorldState_CourierState_COURIER_STATE_AT_SECRET_SHOP;
...
class CMsgBotWorldState final :
 ...
 public:
  ...
  static constexpr CourierState COURIER_STATE_GOING_TO_SECRET_SHOP =
    CMsgBotWorldState_CourierState_COURIER_STATE_GOING_TO_SECRET_SHOP;
  static constexpr CourierState COURIER_STATE_AT_SECRET_SHOP =
    CMsgBotWorldState_CourierState_COURIER_STATE_AT_SECRET_SHOP;
