...
class CMsgDOTAChatMessage_ChatWheelMessage final :
 ...
 public:
  ...
  bool has_hero_badge_tier() const;
  private:
  bool _internal_has_hero_badge_tier() const;
  public:
  void clear_hero_badge_tier();
  uint32_t hero_badge_tier() const;
  void set_hero_badge_tier(uint32_t value);
  private:
  uint32_t _internal_hero_badge_tier() const;
  void _internal_set_hero_badge_tier(uint32_t value);
  public:
...
class CMsgDOTAChatMessage final :
 ...
 public:
  ...
  enum : int {
    ...
    kRequestedHeroIdFieldNumber = 44,
    kRequestedHeroFacetKeyFieldNumber = 45,
  ...
  bool has_requested_hero_id() const;
  private:
  bool _internal_has_requested_hero_id() const;
  public:
  void clear_requested_hero_id();
  int32_t requested_hero_id() const;
  void set_requested_hero_id(int32_t value);
  private:
  int32_t _internal_requested_hero_id() const;
  void _internal_set_requested_hero_id(int32_t value);
  public:

  // optional uint64 requested_hero_facet_key = 45;
  bool has_requested_hero_facet_key() const;
  private:
  bool _internal_has_requested_hero_facet_key() const;
  public:
  void clear_requested_hero_facet_key();
  uint64_t requested_hero_facet_key() const;
  void set_requested_hero_facet_key(uint64_t value);
  private:
  uint64_t _internal_requested_hero_facet_key() const;
  void _internal_set_requested_hero_facet_key(uint64_t value);
  public:
 ...
 private:
  ...
  struct Impl_ {
    ...
    int32_t requested_hero_id_;
    uint64_t requested_hero_facet_key_;
...
// optional string message_text = 3;
inline bool CMsgDOTAChatMessage_ChatWheelMessage::_internal_has_message_text() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline bool CMsgDOTAChatMessage_ChatWheelMessage::has_message_text() const {
  return _internal_has_message_text();
}
inline void CMsgDOTAChatMessage_ChatWheelMessage::clear_message_text() {
  _impl_.message_text_.ClearToEmpty();
  _impl_._has_bits_[0] &= ~0x00000001u;
}
inline const std::string& CMsgDOTAChatMessage_ChatWheelMessage::message_text() const {
  // @@protoc_insertion_point(field_get:CMsgDOTAChatMessage.ChatWheelMessage.message_text)
  return _internal_message_text();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void CMsgDOTAChatMessage_ChatWheelMessage::set_message_text(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000001u;
 _impl_.message_text_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:CMsgDOTAChatMessage.ChatWheelMessage.message_text)
}
inline std::string* CMsgDOTAChatMessage_ChatWheelMessage::mutable_message_text() {
  std::string* _s = _internal_mutable_message_text();
  // @@protoc_insertion_point(field_mutable:CMsgDOTAChatMessage.ChatWheelMessage.message_text)
  return _s;
}
inline const std::string& CMsgDOTAChatMessage_ChatWheelMessage::_internal_message_text() const {
  return _impl_.message_text_.Get();
}
inline void CMsgDOTAChatMessage_ChatWheelMessage::_internal_set_message_text(const std::string& value) {
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.message_text_.Set(value, GetArenaForAllocation());
}
inline std::string* CMsgDOTAChatMessage_ChatWheelMessage::_internal_mutable_message_text() {
  _impl_._has_bits_[0] |= 0x00000001u;
  return _impl_.message_text_.Mutable(GetArenaForAllocation());
}
inline std::string* CMsgDOTAChatMessage_ChatWheelMessage::release_message_text() {
  // @@protoc_insertion_point(field_release:CMsgDOTAChatMessage.ChatWheelMessage.message_text)
...
inline void CMsgDOTAChatMessage_ChatWheelMessage::set_allocated_message_text(std::string* message_text) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:CMsgDOTAChatMessage.ChatWheelMessage.message_text)
}

// optional uint32 hero_badge_tier = 4;
inline bool CMsgDOTAChatMessage_ChatWheelMessage::_internal_has_hero_badge_tier() const {
  bool value = (_impl_._has_bits_[0] & 0x00000004u) != 0;
  return value;
}
inline bool CMsgDOTAChatMessage_ChatWheelMessage::has_hero_badge_tier() const {
  return _internal_has_hero_badge_tier();
}
inline void CMsgDOTAChatMessage_ChatWheelMessage::clear_hero_badge_tier() {
  _impl_.hero_badge_tier_ = 0u;
  _impl_._has_bits_[0] &= ~0x00000004u;
}
inline uint32_t CMsgDOTAChatMessage_ChatWheelMessage::_internal_hero_badge_tier() const {
  return _impl_.hero_badge_tier_;
}
inline uint32_t CMsgDOTAChatMessage_ChatWheelMessage::hero_badge_tier() const {
  // @@protoc_insertion_point(field_get:CMsgDOTAChatMessage.ChatWheelMessage.hero_badge_tier)
  return _internal_hero_badge_tier();
}
inline void CMsgDOTAChatMessage_ChatWheelMessage::_internal_set_hero_badge_tier(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000004u;
  _impl_.hero_badge_tier_ = value;
}
inline void CMsgDOTAChatMessage_ChatWheelMessage::set_hero_badge_tier(uint32_t value) {
  _internal_set_hero_badge_tier(value);
  // @@protoc_insertion_point(field_set:CMsgDOTAChatMessage.ChatWheelMessage.hero_badge_tier)
}
...
// optional int32 requested_hero_id = 44;
inline bool CMsgDOTAChatMessage::_internal_has_requested_hero_id() const {
  bool value = (_impl_._has_bits_[1] & 0x00000020u) != 0;
  return value;
}
inline bool CMsgDOTAChatMessage::has_requested_hero_id() const {
  return _internal_has_requested_hero_id();
}
inline void CMsgDOTAChatMessage::clear_requested_hero_id() {
  _impl_.requested_hero_id_ = 0;
  _impl_._has_bits_[1] &= ~0x00000020u;
}
inline int32_t CMsgDOTAChatMessage::_internal_requested_hero_id() const {
  return _impl_.requested_hero_id_;
}
inline int32_t CMsgDOTAChatMessage::requested_hero_id() const {
  // @@protoc_insertion_point(field_get:CMsgDOTAChatMessage.requested_hero_id)
  return _internal_requested_hero_id();
}
inline void CMsgDOTAChatMessage::_internal_set_requested_hero_id(int32_t value) {
  _impl_._has_bits_[1] |= 0x00000020u;
  _impl_.requested_hero_id_ = value;
}
inline void CMsgDOTAChatMessage::set_requested_hero_id(int32_t value) {
  _internal_set_requested_hero_id(value);
  // @@protoc_insertion_point(field_set:CMsgDOTAChatMessage.requested_hero_id)
}

// optional uint64 requested_hero_facet_key = 45;
inline bool CMsgDOTAChatMessage::_internal_has_requested_hero_facet_key() const {
  bool value = (_impl_._has_bits_[1] & 0x00000040u) != 0;
  return value;
}
inline bool CMsgDOTAChatMessage::has_requested_hero_facet_key() const {
  return _internal_has_requested_hero_facet_key();
}
inline void CMsgDOTAChatMessage::clear_requested_hero_facet_key() {
  _impl_.requested_hero_facet_key_ = uint64_t{0u};
  _impl_._has_bits_[1] &= ~0x00000040u;
}
inline uint64_t CMsgDOTAChatMessage::_internal_requested_hero_facet_key() const {
  return _impl_.requested_hero_facet_key_;
}
inline uint64_t CMsgDOTAChatMessage::requested_hero_facet_key() const {
  // @@protoc_insertion_point(field_get:CMsgDOTAChatMessage.requested_hero_facet_key)
  return _internal_requested_hero_facet_key();
}
inline void CMsgDOTAChatMessage::_internal_set_requested_hero_facet_key(uint64_t value) {
  _impl_._has_bits_[1] |= 0x00000040u;
  _impl_.requested_hero_facet_key_ = value;
}
inline void CMsgDOTAChatMessage::set_requested_hero_facet_key(uint64_t value) {
  _internal_set_requested_hero_facet_key(value);
  // @@protoc_insertion_point(field_set:CMsgDOTAChatMessage.requested_hero_facet_key)
}
