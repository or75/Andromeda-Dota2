...
class CMsgDotaScenario_HeroNeutralChoice;
struct CMsgDotaScenario_HeroNeutralChoiceDefaultTypeInternal;
extern CMsgDotaScenario_HeroNeutralChoiceDefaultTypeInternal _CMsgDotaScenario_HeroNeutralChoice_default_instance_;
class CMsgDotaScenario_HeroNeutralTier;
struct CMsgDotaScenario_HeroNeutralTierDefaultTypeInternal;
extern CMsgDotaScenario_HeroNeutralTierDefaultTypeInternal _CMsgDotaScenario_HeroNeutralTier_default_instance_;
...
template<> ::CMsgDotaScenario_HeroNeutralChoice* Arena::CreateMaybeMessage<::CMsgDotaScenario_HeroNeutralChoice>(Arena*);
template<> ::CMsgDotaScenario_HeroNeutralTier* Arena::CreateMaybeMessage<::CMsgDotaScenario_HeroNeutralTier>(Arena*);
...
class CScenarioGame_RoshanSpawner final :
 ...
 public:
  ...
  private:
  bool _internal_has_killer_team() const;
  public:
  void clear_killer_team();
  int32_t killer_team() const;
  void set_killer_team(int32_t value);
  private:
  int32_t _internal_killer_team() const;
  void _internal_set_killer_team(int32_t value);
  public:
...
class CMsgDotaScenario_DamageStatsByType final :
 ...
 public:
  ...
  // optional float received_pre_reduction = 2;
  bool has_received_pre_reduction() const;
  private:
  bool _internal_has_received_pre_reduction() const;
  public:
  void clear_received_pre_reduction();
  float received_pre_reduction() const;
  void set_received_pre_reduction(float value);
  private:
  float _internal_received_pre_reduction() const;
  void _internal_set_received_pre_reduction(float value);
  public:

  // optional float received_post_reduction = 3;
  bool has_received_post_reduction() const;
  private:
  bool _internal_has_received_post_reduction() const;
  public:
  void clear_received_post_reduction();
  float received_post_reduction() const;
  void set_received_post_reduction(float value);
  private:
  float _internal_received_post_reduction() const;
  void _internal_set_received_post_reduction(float value);
  public:

  // optional float outgoing_pre_reduction = 4;
  bool has_outgoing_pre_reduction() const;
  private:
  bool _internal_has_outgoing_pre_reduction() const;
  public:
  void clear_outgoing_pre_reduction();
  float outgoing_pre_reduction() const;
  void set_outgoing_pre_reduction(float value);
  private:
  float _internal_outgoing_pre_reduction() const;
  void _internal_set_outgoing_pre_reduction(float value);
  public:

  // optional float outgoing_post_reduction = 5;
  bool has_outgoing_post_reduction() const;
  private:
  bool _internal_has_outgoing_post_reduction() const;
  public:
  void clear_outgoing_post_reduction();
  float outgoing_post_reduction() const;
  void set_outgoing_post_reduction(float value);
  private:
  float _internal_outgoing_post_reduction() const;
  void _internal_set_outgoing_post_reduction(float value);
  public:
 ...
 private:
  ...
  struct Impl_ {
    ...
    float received_pre_reduction_;
    float received_post_reduction_;
    float outgoing_pre_reduction_;
    float outgoing_post_reduction_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_dota_5fscenariomessages_2eproto;
};
...
class CMsgDotaScenario_HeroNeutralChoice final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:CMsgDotaScenario.HeroNeutralChoice) */ {
 public:
  inline CMsgDotaScenario_HeroNeutralChoice() : CMsgDotaScenario_HeroNeutralChoice(nullptr) {}
  ~CMsgDotaScenario_HeroNeutralChoice() override;
  explicit PROTOBUF_CONSTEXPR CMsgDotaScenario_HeroNeutralChoice(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  CMsgDotaScenario_HeroNeutralChoice(const CMsgDotaScenario_HeroNeutralChoice& from);
  CMsgDotaScenario_HeroNeutralChoice(CMsgDotaScenario_HeroNeutralChoice&& from) noexcept
    : CMsgDotaScenario_HeroNeutralChoice() {
    *this = ::std::move(from);
  }

  inline CMsgDotaScenario_HeroNeutralChoice& operator=(const CMsgDotaScenario_HeroNeutralChoice& from) {
    CopyFrom(from);
    return *this;
  }
  inline CMsgDotaScenario_HeroNeutralChoice& operator=(CMsgDotaScenario_HeroNeutralChoice&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const CMsgDotaScenario_HeroNeutralChoice& default_instance() {
    return *internal_default_instance();
  }
  static inline const CMsgDotaScenario_HeroNeutralChoice* internal_default_instance() {
    return reinterpret_cast<const CMsgDotaScenario_HeroNeutralChoice*>(
               &_CMsgDotaScenario_HeroNeutralChoice_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    14;

  friend void swap(CMsgDotaScenario_HeroNeutralChoice& a, CMsgDotaScenario_HeroNeutralChoice& b) {
    a.Swap(&b);
  }
  inline void Swap(CMsgDotaScenario_HeroNeutralChoice* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(CMsgDotaScenario_HeroNeutralChoice* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  CMsgDotaScenario_HeroNeutralChoice* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<CMsgDotaScenario_HeroNeutralChoice>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const CMsgDotaScenario_HeroNeutralChoice& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const CMsgDotaScenario_HeroNeutralChoice& from) {
    CMsgDotaScenario_HeroNeutralChoice::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(CMsgDotaScenario_HeroNeutralChoice* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "CMsgDotaScenario.HeroNeutralChoice";
  }
  protected:
  explicit CMsgDotaScenario_HeroNeutralChoice(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  bool has_enchantment_name() const;
  private:
  bool _internal_has_enchantment_name() const;
  public:
  void clear_enchantment_name();
  const std::string& enchantment_name() const;
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_enchantment_name(ArgT0&& arg0, ArgT... args);
  std::string* mutable_enchantment_name();
  PROTOBUF_NODISCARD std::string* release_enchantment_name();
  void set_allocated_enchantment_name(std::string* enchantment_name);
  private:
  const std::string& _internal_enchantment_name() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_enchantment_name(const std::string& value);
  std::string* _internal_mutable_enchantment_name();
  public:
  ...
  // @@protoc_insertion_point(class_scope:CMsgDotaScenario.HeroNeutralChoice)
 private:
  class _Internal;
  ...
  struct Impl_ {
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr enchantment_name_;
...
class CMsgDotaScenario_HeroNeutralTier final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:CMsgDotaScenario.HeroNeutralTier) */ {
 public:
  inline CMsgDotaScenario_HeroNeutralTier() : CMsgDotaScenario_HeroNeutralTier(nullptr) {}
  ~CMsgDotaScenario_HeroNeutralTier() override;
  explicit PROTOBUF_CONSTEXPR CMsgDotaScenario_HeroNeutralTier(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  CMsgDotaScenario_HeroNeutralTier(const CMsgDotaScenario_HeroNeutralTier& from);
  CMsgDotaScenario_HeroNeutralTier(CMsgDotaScenario_HeroNeutralTier&& from) noexcept
    : CMsgDotaScenario_HeroNeutralTier() {
    *this = ::std::move(from);
  }

  inline CMsgDotaScenario_HeroNeutralTier& operator=(const CMsgDotaScenario_HeroNeutralTier& from) {
    CopyFrom(from);
    return *this;
  }
  inline CMsgDotaScenario_HeroNeutralTier& operator=(CMsgDotaScenario_HeroNeutralTier&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const CMsgDotaScenario_HeroNeutralTier& default_instance() {
    return *internal_default_instance();
  }
  static inline const CMsgDotaScenario_HeroNeutralTier* internal_default_instance() {
    return reinterpret_cast<const CMsgDotaScenario_HeroNeutralTier*>(
               &_CMsgDotaScenario_HeroNeutralTier_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    15;

  friend void swap(CMsgDotaScenario_HeroNeutralTier& a, CMsgDotaScenario_HeroNeutralTier& b) {
    a.Swap(&b);
  }
  inline void Swap(CMsgDotaScenario_HeroNeutralTier* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(CMsgDotaScenario_HeroNeutralTier* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  CMsgDotaScenario_HeroNeutralTier* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<CMsgDotaScenario_HeroNeutralTier>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const CMsgDotaScenario_HeroNeutralTier& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const CMsgDotaScenario_HeroNeutralTier& from) {
    CMsgDotaScenario_HeroNeutralTier::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(CMsgDotaScenario_HeroNeutralTier* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "CMsgDotaScenario.HeroNeutralTier";
  }
  protected:
  explicit CMsgDotaScenario_HeroNeutralTier(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  enum : int {
    ...
    kTierFieldNumber = 1,
    kSelectedArtifactFieldNumber = 3,
    kSelectedEnchantmentFieldNumber = 4,
  };
  ...
  public:
  void clear_choices();
  ::CMsgDotaScenario_HeroNeutralChoice* mutable_choices(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CMsgDotaScenario_HeroNeutralChoice >*
      mutable_choices();
  private:
  const ::CMsgDotaScenario_HeroNeutralChoice& _internal_choices(int index) const;
  ::CMsgDotaScenario_HeroNeutralChoice* _internal_add_choices();
  public:
  const ::CMsgDotaScenario_HeroNeutralChoice& choices(int index) const;
  ::CMsgDotaScenario_HeroNeutralChoice* add_choices();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CMsgDotaScenario_HeroNeutralChoice >&
      choices() const;
  ...
  bool has_selected_artifact() const;
  private:
  bool _internal_has_selected_artifact() const;
  public:
  void clear_selected_artifact();
  int32_t selected_artifact() const;
  void set_selected_artifact(int32_t value);
  private:
  int32_t _internal_selected_artifact() const;
  void _internal_set_selected_artifact(int32_t value);
  public:

  // optional int32 selected_enchantment = 4;
  bool has_selected_enchantment() const;
  private:
  bool _internal_has_selected_enchantment() const;
  public:
  void clear_selected_enchantment();
  int32_t selected_enchantment() const;
  void set_selected_enchantment(int32_t value);
  private:
  int32_t _internal_selected_enchantment() const;
  void _internal_set_selected_enchantment(int32_t value);
  public:

  // @@protoc_insertion_point(class_scope:CMsgDotaScenario.HeroNeutralTier)
 private:
  class _Internal;
  ...
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::internal::HasBits<1> _has_bits_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CMsgDotaScenario_HeroNeutralChoice > choices_;
    uint32_t tier_;
    int32_t selected_artifact_;
    int32_t selected_enchantment_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_dota_5fscenariomessages_2eproto;
};
...
class CMsgDotaScenario_Hero final :
 ...
 public:
  ...
  enum : int {
    ...
    kTotalMadstoneFieldNumber = 154,
    kCurrentMadstoneFieldNumber = 155,
    kRefresherChargesUsedFieldNumber = 157,
  ...
  int neutral_tiers_size() const;
  private:
  int _internal_neutral_tiers_size() const;
  public:
  void clear_neutral_tiers();
  ::CMsgDotaScenario_HeroNeutralTier* mutable_neutral_tiers(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CMsgDotaScenario_HeroNeutralTier >*
      mutable_neutral_tiers();
  private:
  const ::CMsgDotaScenario_HeroNeutralTier& _internal_neutral_tiers(int index) const;
  ::CMsgDotaScenario_HeroNeutralTier* _internal_add_neutral_tiers();
  public:
  const ::CMsgDotaScenario_HeroNeutralTier& neutral_tiers(int index) const;
  ::CMsgDotaScenario_HeroNeutralTier* add_neutral_tiers();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CMsgDotaScenario_HeroNeutralTier >&
      neutral_tiers() const;
  ...
  // optional float hero_damage = 54;
  bool has_hero_damage() const;
  private:
  bool _internal_has_hero_damage() const;
  public:
  void clear_hero_damage();
  float hero_damage() const;
  void set_hero_damage(float value);
  private:
  float _internal_hero_damage() const;
  void _internal_set_hero_damage(float value);
  public:
  ...
  bool has_total_madstone() const;
  private:
  bool _internal_has_total_madstone() const;
  public:
  void clear_total_madstone();
  uint32_t total_madstone() const;
  void set_total_madstone(uint32_t value);
  private:
  uint32_t _internal_total_madstone() const;
  void _internal_set_total_madstone(uint32_t value);
  public:

  // optional uint32 current_madstone = 155;
  bool has_current_madstone() const;
  private:
  bool _internal_has_current_madstone() const;
  public:
  void clear_current_madstone();
  uint32_t current_madstone() const;
  void set_current_madstone(uint32_t value);
  private:
  uint32_t _internal_current_madstone() const;
  void _internal_set_current_madstone(uint32_t value);
  public:

  // optional int32 refresher_charges_used = 157;
  bool has_refresher_charges_used() const;
  private:
  bool _internal_has_refresher_charges_used() const;
  public:
  void clear_refresher_charges_used();
  int32_t refresher_charges_used() const;
  void set_refresher_charges_used(int32_t value);
  private:
  int32_t _internal_refresher_charges_used() const;
  void _internal_set_refresher_charges_used(int32_t value);
  public:
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CMsgDotaScenario_HeroNeutralTier > neutral_tiers_;
    ...
    uint32_t total_madstone_;
    uint32_t current_madstone_;
    int32_t refresher_charges_used_;
    int32_t player_id_;
...
class CMsgDotaScenario final :
 ...
 public:
  ...
  typedef CMsgDotaScenario_HeroNeutralChoice HeroNeutralChoice;
  typedef CMsgDotaScenario_HeroNeutralTier HeroNeutralTier;
...
// optional int32 killer_team = 4;
inline bool CScenarioGame_RoshanSpawner::_internal_has_killer_team() const {
  bool value = (_impl_._has_bits_[0] & 0x00000008u) != 0;
  return value;
}
inline bool CScenarioGame_RoshanSpawner::has_killer_team() const {
  return _internal_has_killer_team();
}
inline void CScenarioGame_RoshanSpawner::clear_killer_team() {
  _impl_.killer_team_ = 0;
  _impl_._has_bits_[0] &= ~0x00000008u;
}
inline int32_t CScenarioGame_RoshanSpawner::_internal_killer_team() const {
  return _impl_.killer_team_;
}
inline int32_t CScenarioGame_RoshanSpawner::killer_team() const {
  // @@protoc_insertion_point(field_get:CScenarioGame_RoshanSpawner.killer_team)
  return _internal_killer_team();
}
inline void CScenarioGame_RoshanSpawner::_internal_set_killer_team(int32_t value) {
  _impl_._has_bits_[0] |= 0x00000008u;
  _impl_.killer_team_ = value;
}
inline void CScenarioGame_RoshanSpawner::set_killer_team(int32_t value) {
  _internal_set_killer_team(value);
  // @@protoc_insertion_point(field_set:CScenarioGame_RoshanSpawner.killer_team)
}
...
// optional int32 tier = 3;
inline bool CMsgDotaScenario_TeamNeutralItem::_internal_has_tier() const {
  bool value = (_impl_._has_bits_[0] & 0x00000004u) != 0;
  return value;
}
inline bool CMsgDotaScenario_TeamNeutralItem::has_tier() const {
  return _internal_has_tier();
}
inline void CMsgDotaScenario_TeamNeutralItem::clear_tier() {
  _impl_.tier_ = 0;
  _impl_._has_bits_[0] &= ~0x00000004u;
}
inline int32_t CMsgDotaScenario_TeamNeutralItem::_internal_tier() const {
  return _impl_.tier_;
}
inline int32_t CMsgDotaScenario_TeamNeutralItem::tier() const {
  // @@protoc_insertion_point(field_get:CMsgDotaScenario.TeamNeutralItem.tier)
  return _internal_tier();
}
inline void CMsgDotaScenario_TeamNeutralItem::_internal_set_tier(int32_t value) {
  _impl_._has_bits_[0] |= 0x00000004u;
  _impl_.tier_ = value;
}
inline void CMsgDotaScenario_TeamNeutralItem::set_tier(int32_t value) {
  _internal_set_tier(value);
  // @@protoc_insertion_point(field_set:CMsgDotaScenario.TeamNeutralItem.tier)
}
...
inline float CMsgDotaScenario_DamageStatsByType::_internal_received_pre_reduction() const {
  return _impl_.received_pre_reduction_;
}
inline float CMsgDotaScenario_DamageStatsByType::received_pre_reduction() const {
...
inline void CMsgDotaScenario_DamageStatsByType::_internal_set_received_pre_reduction(float value) {
  _impl_._has_bits_[0] |= 0x00000002u;
  _impl_.received_pre_reduction_ = value;
}
inline void CMsgDotaScenario_DamageStatsByType::set_received_pre_reduction(float value) {
...
inline float CMsgDotaScenario_DamageStatsByType::_internal_received_post_reduction() const {
  return _impl_.received_post_reduction_;
}
inline float CMsgDotaScenario_DamageStatsByType::received_post_reduction() const {
...
inline void CMsgDotaScenario_DamageStatsByType::_internal_set_received_post_reduction(float value) {
  _impl_._has_bits_[0] |= 0x00000004u;
  _impl_.received_post_reduction_ = value;
}
inline void CMsgDotaScenario_DamageStatsByType::set_received_post_reduction(float value) {
...
inline float CMsgDotaScenario_DamageStatsByType::_internal_outgoing_pre_reduction() const {
  return _impl_.outgoing_pre_reduction_;
}
inline float CMsgDotaScenario_DamageStatsByType::outgoing_pre_reduction() const {
...
inline void CMsgDotaScenario_DamageStatsByType::_internal_set_outgoing_pre_reduction(float value) {
  _impl_._has_bits_[0] |= 0x00000008u;
  _impl_.outgoing_pre_reduction_ = value;
}
inline void CMsgDotaScenario_DamageStatsByType::set_outgoing_pre_reduction(float value) {
...
inline float CMsgDotaScenario_DamageStatsByType::_internal_outgoing_post_reduction() const {
  return _impl_.outgoing_post_reduction_;
}
inline float CMsgDotaScenario_DamageStatsByType::outgoing_post_reduction() const {
...
inline void CMsgDotaScenario_DamageStatsByType::_internal_set_outgoing_post_reduction(float value) {
  _impl_._has_bits_[0] |= 0x00000010u;
  _impl_.outgoing_post_reduction_ = value;
}
inline void CMsgDotaScenario_DamageStatsByType::set_outgoing_post_reduction(float value) {
...
// optional int32 choice_index = 1;
inline bool CMsgDotaScenario_HeroNeutralChoice::_internal_has_choice_index() const {
  bool value = (_impl_._has_bits_[0] & 0x00000004u) != 0;
  return value;
}
inline bool CMsgDotaScenario_HeroNeutralChoice::has_choice_index() const {
  return _internal_has_choice_index();
}
inline void CMsgDotaScenario_HeroNeutralChoice::clear_choice_index() {
  _impl_.choice_index_ = 0;
  _impl_._has_bits_[0] &= ~0x00000004u;
}
inline int32_t CMsgDotaScenario_HeroNeutralChoice::_internal_choice_index() const {
  return _impl_.choice_index_;
}
inline int32_t CMsgDotaScenario_HeroNeutralChoice::choice_index() const {
  // @@protoc_insertion_point(field_get:CMsgDotaScenario.HeroNeutralChoice.choice_index)
  return _internal_choice_index();
}
inline void CMsgDotaScenario_HeroNeutralChoice::_internal_set_choice_index(int32_t value) {
  _impl_._has_bits_[0] |= 0x00000004u;
  _impl_.choice_index_ = value;
}
inline void CMsgDotaScenario_HeroNeutralChoice::set_choice_index(int32_t value) {
  _internal_set_choice_index(value);
  // @@protoc_insertion_point(field_set:CMsgDotaScenario.HeroNeutralChoice.choice_index)
}

// optional string artifact_name = 2;
inline bool CMsgDotaScenario_HeroNeutralChoice::_internal_has_artifact_name() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline bool CMsgDotaScenario_HeroNeutralChoice::has_artifact_name() const {
  return _internal_has_artifact_name();
}
inline void CMsgDotaScenario_HeroNeutralChoice::clear_artifact_name() {
  _impl_.artifact_name_.ClearToEmpty();
  _impl_._has_bits_[0] &= ~0x00000001u;
}
inline const std::string& CMsgDotaScenario_HeroNeutralChoice::artifact_name() const {
  // @@protoc_insertion_point(field_get:CMsgDotaScenario.HeroNeutralChoice.artifact_name)
  return _internal_artifact_name();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void CMsgDotaScenario_HeroNeutralChoice::set_artifact_name(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000001u;
 _impl_.artifact_name_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:CMsgDotaScenario.HeroNeutralChoice.artifact_name)
}
inline std::string* CMsgDotaScenario_HeroNeutralChoice::mutable_artifact_name() {
  std::string* _s = _internal_mutable_artifact_name();
  // @@protoc_insertion_point(field_mutable:CMsgDotaScenario.HeroNeutralChoice.artifact_name)
  return _s;
}
inline const std::string& CMsgDotaScenario_HeroNeutralChoice::_internal_artifact_name() const {
  return _impl_.artifact_name_.Get();
}
inline void CMsgDotaScenario_HeroNeutralChoice::_internal_set_artifact_name(const std::string& value) {
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.artifact_name_.Set(value, GetArenaForAllocation());
}
inline std::string* CMsgDotaScenario_HeroNeutralChoice::_internal_mutable_artifact_name() {
  _impl_._has_bits_[0] |= 0x00000001u;
  return _impl_.artifact_name_.Mutable(GetArenaForAllocation());
}
inline std::string* CMsgDotaScenario_HeroNeutralChoice::release_artifact_name() {
  // @@protoc_insertion_point(field_release:CMsgDotaScenario.HeroNeutralChoice.artifact_name)
...
inline void CMsgDotaScenario_HeroNeutralChoice::set_allocated_artifact_name(std::string* artifact_name) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:CMsgDotaScenario.HeroNeutralChoice.artifact_name)
}

// optional string enchantment_name = 3;
inline bool CMsgDotaScenario_HeroNeutralChoice::_internal_has_enchantment_name() const {
  bool value = (_impl_._has_bits_[0] & 0x00000002u) != 0;
  return value;
}
inline bool CMsgDotaScenario_HeroNeutralChoice::has_enchantment_name() const {
  return _internal_has_enchantment_name();
}
inline void CMsgDotaScenario_HeroNeutralChoice::clear_enchantment_name() {
  _impl_.enchantment_name_.ClearToEmpty();
  _impl_._has_bits_[0] &= ~0x00000002u;
}
inline const std::string& CMsgDotaScenario_HeroNeutralChoice::enchantment_name() const {
  // @@protoc_insertion_point(field_get:CMsgDotaScenario.HeroNeutralChoice.enchantment_name)
  return _internal_enchantment_name();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void CMsgDotaScenario_HeroNeutralChoice::set_enchantment_name(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000002u;
 _impl_.enchantment_name_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:CMsgDotaScenario.HeroNeutralChoice.enchantment_name)
}
inline std::string* CMsgDotaScenario_HeroNeutralChoice::mutable_enchantment_name() {
  std::string* _s = _internal_mutable_enchantment_name();
  // @@protoc_insertion_point(field_mutable:CMsgDotaScenario.HeroNeutralChoice.enchantment_name)
  return _s;
}
inline const std::string& CMsgDotaScenario_HeroNeutralChoice::_internal_enchantment_name() const {
  return _impl_.enchantment_name_.Get();
}
inline void CMsgDotaScenario_HeroNeutralChoice::_internal_set_enchantment_name(const std::string& value) {
  _impl_._has_bits_[0] |= 0x00000002u;
  _impl_.enchantment_name_.Set(value, GetArenaForAllocation());
}
inline std::string* CMsgDotaScenario_HeroNeutralChoice::_internal_mutable_enchantment_name() {
  _impl_._has_bits_[0] |= 0x00000002u;
  return _impl_.enchantment_name_.Mutable(GetArenaForAllocation());
}
inline std::string* CMsgDotaScenario_HeroNeutralChoice::release_enchantment_name() {
  // @@protoc_insertion_point(field_release:CMsgDotaScenario.HeroNeutralChoice.enchantment_name)
  if (!_internal_has_enchantment_name()) {
    return nullptr;
  }
  _impl_._has_bits_[0] &= ~0x00000002u;
  auto* p = _impl_.enchantment_name_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.enchantment_name_.IsDefault()) {
    _impl_.enchantment_name_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  return p;
}
inline void CMsgDotaScenario_HeroNeutralChoice::set_allocated_enchantment_name(std::string* enchantment_name) {
  if (enchantment_name != nullptr) {
    _impl_._has_bits_[0] |= 0x00000002u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000002u;
  }
  _impl_.enchantment_name_.SetAllocated(enchantment_name, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.enchantment_name_.IsDefault()) {
    _impl_.enchantment_name_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:CMsgDotaScenario.HeroNeutralChoice.enchantment_name)
}
...
// optional uint32 tier = 1;
inline bool CMsgDotaScenario_HeroNeutralTier::_internal_has_tier() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline bool CMsgDotaScenario_HeroNeutralTier::has_tier() const {
  return _internal_has_tier();
}
inline void CMsgDotaScenario_HeroNeutralTier::clear_tier() {
  _impl_.tier_ = 0u;
  _impl_._has_bits_[0] &= ~0x00000001u;
}
inline uint32_t CMsgDotaScenario_HeroNeutralTier::_internal_tier() const {
  return _impl_.tier_;
}
inline uint32_t CMsgDotaScenario_HeroNeutralTier::tier() const {
  // @@protoc_insertion_point(field_get:CMsgDotaScenario.HeroNeutralTier.tier)
  return _internal_tier();
}
inline void CMsgDotaScenario_HeroNeutralTier::_internal_set_tier(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.tier_ = value;
}
inline void CMsgDotaScenario_HeroNeutralTier::set_tier(uint32_t value) {
  _internal_set_tier(value);
  // @@protoc_insertion_point(field_set:CMsgDotaScenario.HeroNeutralTier.tier)
}

// repeated .CMsgDotaScenario.HeroNeutralChoice choices = 2;
inline int CMsgDotaScenario_HeroNeutralTier::_internal_choices_size() const {
  return _impl_.choices_.size();
}
inline int CMsgDotaScenario_HeroNeutralTier::choices_size() const {
  return _internal_choices_size();
}
inline void CMsgDotaScenario_HeroNeutralTier::clear_choices() {
  _impl_.choices_.Clear();
}
inline ::CMsgDotaScenario_HeroNeutralChoice* CMsgDotaScenario_HeroNeutralTier::mutable_choices(int index) {
  // @@protoc_insertion_point(field_mutable:CMsgDotaScenario.HeroNeutralTier.choices)
  return _impl_.choices_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CMsgDotaScenario_HeroNeutralChoice >*
CMsgDotaScenario_HeroNeutralTier::mutable_choices() {
  // @@protoc_insertion_point(field_mutable_list:CMsgDotaScenario.HeroNeutralTier.choices)
  return &_impl_.choices_;
}
inline const ::CMsgDotaScenario_HeroNeutralChoice& CMsgDotaScenario_HeroNeutralTier::_internal_choices(int index) const {
  return _impl_.choices_.Get(index);
}
inline const ::CMsgDotaScenario_HeroNeutralChoice& CMsgDotaScenario_HeroNeutralTier::choices(int index) const {
  // @@protoc_insertion_point(field_get:CMsgDotaScenario.HeroNeutralTier.choices)
  return _internal_choices(index);
}
inline ::CMsgDotaScenario_HeroNeutralChoice* CMsgDotaScenario_HeroNeutralTier::_internal_add_choices() {
  return _impl_.choices_.Add();
}
inline ::CMsgDotaScenario_HeroNeutralChoice* CMsgDotaScenario_HeroNeutralTier::add_choices() {
  ::CMsgDotaScenario_HeroNeutralChoice* _add = _internal_add_choices();
  // @@protoc_insertion_point(field_add:CMsgDotaScenario.HeroNeutralTier.choices)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CMsgDotaScenario_HeroNeutralChoice >&
CMsgDotaScenario_HeroNeutralTier::choices() const {
  // @@protoc_insertion_point(field_list:CMsgDotaScenario.HeroNeutralTier.choices)
  return _impl_.choices_;
}

// optional int32 selected_artifact = 3;
inline bool CMsgDotaScenario_HeroNeutralTier::_internal_has_selected_artifact() const {
  bool value = (_impl_._has_bits_[0] & 0x00000002u) != 0;
  return value;
}
inline bool CMsgDotaScenario_HeroNeutralTier::has_selected_artifact() const {
  return _internal_has_selected_artifact();
}
inline void CMsgDotaScenario_HeroNeutralTier::clear_selected_artifact() {
  _impl_.selected_artifact_ = 0;
  _impl_._has_bits_[0] &= ~0x00000002u;
}
inline int32_t CMsgDotaScenario_HeroNeutralTier::_internal_selected_artifact() const {
  return _impl_.selected_artifact_;
}
inline int32_t CMsgDotaScenario_HeroNeutralTier::selected_artifact() const {
  // @@protoc_insertion_point(field_get:CMsgDotaScenario.HeroNeutralTier.selected_artifact)
  return _internal_selected_artifact();
}
inline void CMsgDotaScenario_HeroNeutralTier::_internal_set_selected_artifact(int32_t value) {
  _impl_._has_bits_[0] |= 0x00000002u;
  _impl_.selected_artifact_ = value;
}
inline void CMsgDotaScenario_HeroNeutralTier::set_selected_artifact(int32_t value) {
  _internal_set_selected_artifact(value);
  // @@protoc_insertion_point(field_set:CMsgDotaScenario.HeroNeutralTier.selected_artifact)
}

// optional int32 selected_enchantment = 4;
inline bool CMsgDotaScenario_HeroNeutralTier::_internal_has_selected_enchantment() const {
  bool value = (_impl_._has_bits_[0] & 0x00000004u) != 0;
  return value;
}
inline bool CMsgDotaScenario_HeroNeutralTier::has_selected_enchantment() const {
  return _internal_has_selected_enchantment();
}
inline void CMsgDotaScenario_HeroNeutralTier::clear_selected_enchantment() {
  _impl_.selected_enchantment_ = 0;
  _impl_._has_bits_[0] &= ~0x00000004u;
}
inline int32_t CMsgDotaScenario_HeroNeutralTier::_internal_selected_enchantment() const {
  return _impl_.selected_enchantment_;
}
inline int32_t CMsgDotaScenario_HeroNeutralTier::selected_enchantment() const {
  // @@protoc_insertion_point(field_get:CMsgDotaScenario.HeroNeutralTier.selected_enchantment)
  return _internal_selected_enchantment();
}
inline void CMsgDotaScenario_HeroNeutralTier::_internal_set_selected_enchantment(int32_t value) {
  _impl_._has_bits_[0] |= 0x00000004u;
  _impl_.selected_enchantment_ = value;
}
inline void CMsgDotaScenario_HeroNeutralTier::set_selected_enchantment(int32_t value) {
  _internal_set_selected_enchantment(value);
  // @@protoc_insertion_point(field_set:CMsgDotaScenario.HeroNeutralTier.selected_enchantment)
}
...
inline float CMsgDotaScenario_Hero::_internal_hero_damage() const {
  return _impl_.hero_damage_;
}
inline float CMsgDotaScenario_Hero::hero_damage() const {
  // @@protoc_insertion_point(field_get:CMsgDotaScenario.Hero.hero_damage)
  return _internal_hero_damage();
}
inline void CMsgDotaScenario_Hero::_internal_set_hero_damage(float value) {
  _impl_._has_bits_[1] |= 0x00000400u;
  _impl_.hero_damage_ = value;
}
inline void CMsgDotaScenario_Hero::set_hero_damage(float value) {
...
// optional uint32 total_madstone = 154;
inline bool CMsgDotaScenario_Hero::_internal_has_total_madstone() const {
  bool value = (_impl_._has_bits_[1] & 0x08000000u) != 0;
  return value;
}
inline bool CMsgDotaScenario_Hero::has_total_madstone() const {
  return _internal_has_total_madstone();
}
inline void CMsgDotaScenario_Hero::clear_total_madstone() {
  _impl_.total_madstone_ = 0u;
  _impl_._has_bits_[1] &= ~0x08000000u;
}
inline uint32_t CMsgDotaScenario_Hero::_internal_total_madstone() const {
  return _impl_.total_madstone_;
}
inline uint32_t CMsgDotaScenario_Hero::total_madstone() const {
  // @@protoc_insertion_point(field_get:CMsgDotaScenario.Hero.total_madstone)
  return _internal_total_madstone();
}
inline void CMsgDotaScenario_Hero::_internal_set_total_madstone(uint32_t value) {
  _impl_._has_bits_[1] |= 0x08000000u;
  _impl_.total_madstone_ = value;
}
inline void CMsgDotaScenario_Hero::set_total_madstone(uint32_t value) {
  _internal_set_total_madstone(value);
  // @@protoc_insertion_point(field_set:CMsgDotaScenario.Hero.total_madstone)
}

// optional uint32 current_madstone = 155;
inline bool CMsgDotaScenario_Hero::_internal_has_current_madstone() const {
  bool value = (_impl_._has_bits_[1] & 0x10000000u) != 0;
  return value;
}
inline bool CMsgDotaScenario_Hero::has_current_madstone() const {
  return _internal_has_current_madstone();
}
inline void CMsgDotaScenario_Hero::clear_current_madstone() {
  _impl_.current_madstone_ = 0u;
  _impl_._has_bits_[1] &= ~0x10000000u;
}
inline uint32_t CMsgDotaScenario_Hero::_internal_current_madstone() const {
  return _impl_.current_madstone_;
}
inline uint32_t CMsgDotaScenario_Hero::current_madstone() const {
  // @@protoc_insertion_point(field_get:CMsgDotaScenario.Hero.current_madstone)
  return _internal_current_madstone();
}
inline void CMsgDotaScenario_Hero::_internal_set_current_madstone(uint32_t value) {
  _impl_._has_bits_[1] |= 0x10000000u;
  _impl_.current_madstone_ = value;
}
inline void CMsgDotaScenario_Hero::set_current_madstone(uint32_t value) {
  _internal_set_current_madstone(value);
  // @@protoc_insertion_point(field_set:CMsgDotaScenario.Hero.current_madstone)
}

// repeated .CMsgDotaScenario.HeroNeutralTier neutral_tiers = 156;
inline int CMsgDotaScenario_Hero::_internal_neutral_tiers_size() const {
  return _impl_.neutral_tiers_.size();
}
inline int CMsgDotaScenario_Hero::neutral_tiers_size() const {
  return _internal_neutral_tiers_size();
}
inline void CMsgDotaScenario_Hero::clear_neutral_tiers() {
  _impl_.neutral_tiers_.Clear();
}
inline ::CMsgDotaScenario_HeroNeutralTier* CMsgDotaScenario_Hero::mutable_neutral_tiers(int index) {
  // @@protoc_insertion_point(field_mutable:CMsgDotaScenario.Hero.neutral_tiers)
  return _impl_.neutral_tiers_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CMsgDotaScenario_HeroNeutralTier >*
CMsgDotaScenario_Hero::mutable_neutral_tiers() {
  // @@protoc_insertion_point(field_mutable_list:CMsgDotaScenario.Hero.neutral_tiers)
  return &_impl_.neutral_tiers_;
}
inline const ::CMsgDotaScenario_HeroNeutralTier& CMsgDotaScenario_Hero::_internal_neutral_tiers(int index) const {
  return _impl_.neutral_tiers_.Get(index);
}
inline const ::CMsgDotaScenario_HeroNeutralTier& CMsgDotaScenario_Hero::neutral_tiers(int index) const {
  // @@protoc_insertion_point(field_get:CMsgDotaScenario.Hero.neutral_tiers)
  return _internal_neutral_tiers(index);
}
inline ::CMsgDotaScenario_HeroNeutralTier* CMsgDotaScenario_Hero::_internal_add_neutral_tiers() {
  return _impl_.neutral_tiers_.Add();
}
inline ::CMsgDotaScenario_HeroNeutralTier* CMsgDotaScenario_Hero::add_neutral_tiers() {
  ::CMsgDotaScenario_HeroNeutralTier* _add = _internal_add_neutral_tiers();
  // @@protoc_insertion_point(field_add:CMsgDotaScenario.Hero.neutral_tiers)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CMsgDotaScenario_HeroNeutralTier >&
CMsgDotaScenario_Hero::neutral_tiers() const {
  // @@protoc_insertion_point(field_list:CMsgDotaScenario.Hero.neutral_tiers)
  return _impl_.neutral_tiers_;
}

// optional int32 refresher_charges_used = 157;
inline bool CMsgDotaScenario_Hero::_internal_has_refresher_charges_used() const {
  bool value = (_impl_._has_bits_[1] & 0x20000000u) != 0;
  return value;
}
inline bool CMsgDotaScenario_Hero::has_refresher_charges_used() const {
  return _internal_has_refresher_charges_used();
}
inline void CMsgDotaScenario_Hero::clear_refresher_charges_used() {
  _impl_.refresher_charges_used_ = 0;
  _impl_._has_bits_[1] &= ~0x20000000u;
}
inline int32_t CMsgDotaScenario_Hero::_internal_refresher_charges_used() const {
  return _impl_.refresher_charges_used_;
}
inline int32_t CMsgDotaScenario_Hero::refresher_charges_used() const {
  // @@protoc_insertion_point(field_get:CMsgDotaScenario.Hero.refresher_charges_used)
  return _internal_refresher_charges_used();
}
inline void CMsgDotaScenario_Hero::_internal_set_refresher_charges_used(int32_t value) {
  _impl_._has_bits_[1] |= 0x20000000u;
  _impl_.refresher_charges_used_ = value;
}
inline void CMsgDotaScenario_Hero::set_refresher_charges_used(int32_t value) {
  _internal_set_refresher_charges_used(value);
  // @@protoc_insertion_point(field_set:CMsgDotaScenario.Hero.refresher_charges_used)
}
...
// optional int32 level = 10 [default = 1];
inline bool CMsgDotaScenario_Item::_internal_has_level() const {
  bool value = (_impl_._has_bits_[0] & 0x00000200u) != 0;
  return value;
}
inline bool CMsgDotaScenario_Item::has_level() const {
  return _internal_has_level();
}
inline void CMsgDotaScenario_Item::clear_level() {
  _impl_.level_ = 1;
  _impl_._has_bits_[0] &= ~0x00000200u;
}
inline int32_t CMsgDotaScenario_Item::_internal_level() const {
  return _impl_.level_;
}
inline int32_t CMsgDotaScenario_Item::level() const {
  // @@protoc_insertion_point(field_get:CMsgDotaScenario.Item.level)
  return _internal_level();
}
inline void CMsgDotaScenario_Item::_internal_set_level(int32_t value) {
  _impl_._has_bits_[0] |= 0x00000200u;
  _impl_.level_ = value;
}
inline void CMsgDotaScenario_Item::set_level(int32_t value) {
  _internal_set_level(value);
  // @@protoc_insertion_point(field_set:CMsgDotaScenario.Item.level)
}
