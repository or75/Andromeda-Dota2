...
class CMsgDOTAPlayerInfo_ProRegistration;
struct CMsgDOTAPlayerInfo_ProRegistrationDefaultTypeInternal;
extern CMsgDOTAPlayerInfo_ProRegistrationDefaultTypeInternal _CMsgDOTAPlayerInfo_ProRegistration_default_instance_;
...
template<> ::CMsgDOTAPlayerInfo_ProRegistration* Arena::CreateMaybeMessage<::CMsgDOTAPlayerInfo_ProRegistration>(Arena*);
...
class CMsgDOTAPlayerInfo_ProRegistration final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:CMsgDOTAPlayerInfo.ProRegistration) */ {
 public:
  inline CMsgDOTAPlayerInfo_ProRegistration() : CMsgDOTAPlayerInfo_ProRegistration(nullptr) {}
  ~CMsgDOTAPlayerInfo_ProRegistration() override;
  explicit PROTOBUF_CONSTEXPR CMsgDOTAPlayerInfo_ProRegistration(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  CMsgDOTAPlayerInfo_ProRegistration(const CMsgDOTAPlayerInfo_ProRegistration& from);
  CMsgDOTAPlayerInfo_ProRegistration(CMsgDOTAPlayerInfo_ProRegistration&& from) noexcept
    : CMsgDOTAPlayerInfo_ProRegistration() {
    *this = ::std::move(from);
  }

  inline CMsgDOTAPlayerInfo_ProRegistration& operator=(const CMsgDOTAPlayerInfo_ProRegistration& from) {
    CopyFrom(from);
    return *this;
  }
  inline CMsgDOTAPlayerInfo_ProRegistration& operator=(CMsgDOTAPlayerInfo_ProRegistration&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const CMsgDOTAPlayerInfo_ProRegistration& default_instance() {
    return *internal_default_instance();
  }
  static inline const CMsgDOTAPlayerInfo_ProRegistration* internal_default_instance() {
    return reinterpret_cast<const CMsgDOTAPlayerInfo_ProRegistration*>(
               &_CMsgDOTAPlayerInfo_ProRegistration_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    2;

  friend void swap(CMsgDOTAPlayerInfo_ProRegistration& a, CMsgDOTAPlayerInfo_ProRegistration& b) {
    a.Swap(&b);
  }
  inline void Swap(CMsgDOTAPlayerInfo_ProRegistration* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(CMsgDOTAPlayerInfo_ProRegistration* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  CMsgDOTAPlayerInfo_ProRegistration* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<CMsgDOTAPlayerInfo_ProRegistration>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const CMsgDOTAPlayerInfo_ProRegistration& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const CMsgDOTAPlayerInfo_ProRegistration& from) {
    CMsgDOTAPlayerInfo_ProRegistration::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(CMsgDOTAPlayerInfo_ProRegistration* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "CMsgDOTAPlayerInfo.ProRegistration";
  }
  protected:
  explicit CMsgDOTAPlayerInfo_ProRegistration(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  // @@protoc_insertion_point(class_scope:CMsgDOTAPlayerInfo.ProRegistration)
 private:
  class _Internal;
...
class CMsgDOTAPlayerInfo final :
 ...
 public:
  ...
  typedef CMsgDOTAPlayerInfo_ProRegistration ProRegistration;
  ...
  enum : int {
    ...
    kProRegistrationFieldNumber = 18,
    kNameFieldNumber = 2,
    ...
    kHasPlayedInInternationalFieldNumber = 19,
  };
  ...
  int pro_registration_size() const;
  private:
  int _internal_pro_registration_size() const;
  public:
  void clear_pro_registration();
  ::CMsgDOTAPlayerInfo_ProRegistration* mutable_pro_registration(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CMsgDOTAPlayerInfo_ProRegistration >*
      mutable_pro_registration();
  private:
  const ::CMsgDOTAPlayerInfo_ProRegistration& _internal_pro_registration(int index) const;
  ::CMsgDOTAPlayerInfo_ProRegistration* _internal_add_pro_registration();
  public:
  const ::CMsgDOTAPlayerInfo_ProRegistration& pro_registration(int index) const;
  ::CMsgDOTAPlayerInfo_ProRegistration* add_pro_registration();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CMsgDOTAPlayerInfo_ProRegistration >&
      pro_registration() const;
  ...
  bool has_has_played_in_international() const;
  private:
  bool _internal_has_has_played_in_international() const;
  public:
  void clear_has_played_in_international();
  bool has_played_in_international() const;
  void set_has_played_in_international(bool value);
  private:
  bool _internal_has_played_in_international() const;
  void _internal_set_has_played_in_international(bool value);
  public:
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CMsgDOTAPlayerInfo_ProRegistration > pro_registration_;
    ...
    bool has_played_in_international_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_dota_5fgcmessages_5fclient_5ffantasy_2eproto;
};
...
// optional uint32 registration_period = 1;
inline bool CMsgDOTAPlayerInfo_ProRegistration::_internal_has_registration_period() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline bool CMsgDOTAPlayerInfo_ProRegistration::has_registration_period() const {
  return _internal_has_registration_period();
}
inline void CMsgDOTAPlayerInfo_ProRegistration::clear_registration_period() {
  _impl_.registration_period_ = 0u;
  _impl_._has_bits_[0] &= ~0x00000001u;
}
inline uint32_t CMsgDOTAPlayerInfo_ProRegistration::_internal_registration_period() const {
  return _impl_.registration_period_;
}
inline uint32_t CMsgDOTAPlayerInfo_ProRegistration::registration_period() const {
  // @@protoc_insertion_point(field_get:CMsgDOTAPlayerInfo.ProRegistration.registration_period)
  return _internal_registration_period();
}
inline void CMsgDOTAPlayerInfo_ProRegistration::_internal_set_registration_period(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.registration_period_ = value;
}
inline void CMsgDOTAPlayerInfo_ProRegistration::set_registration_period(uint32_t value) {
  _internal_set_registration_period(value);
  // @@protoc_insertion_point(field_set:CMsgDOTAPlayerInfo.ProRegistration.registration_period)
}

// optional uint32 timestamp = 2;
inline bool CMsgDOTAPlayerInfo_ProRegistration::_internal_has_timestamp() const {
  bool value = (_impl_._has_bits_[0] & 0x00000002u) != 0;
  return value;
}
inline bool CMsgDOTAPlayerInfo_ProRegistration::has_timestamp() const {
  return _internal_has_timestamp();
}
inline void CMsgDOTAPlayerInfo_ProRegistration::clear_timestamp() {
  _impl_.timestamp_ = 0u;
  _impl_._has_bits_[0] &= ~0x00000002u;
}
inline uint32_t CMsgDOTAPlayerInfo_ProRegistration::_internal_timestamp() const {
  return _impl_.timestamp_;
}
inline uint32_t CMsgDOTAPlayerInfo_ProRegistration::timestamp() const {
  // @@protoc_insertion_point(field_get:CMsgDOTAPlayerInfo.ProRegistration.timestamp)
  return _internal_timestamp();
}
inline void CMsgDOTAPlayerInfo_ProRegistration::_internal_set_timestamp(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000002u;
  _impl_.timestamp_ = value;
}
inline void CMsgDOTAPlayerInfo_ProRegistration::set_timestamp(uint32_t value) {
  _internal_set_timestamp(value);
  // @@protoc_insertion_point(field_set:CMsgDOTAPlayerInfo.ProRegistration.timestamp)
}
...
// repeated .CMsgDOTAPlayerInfo.ProRegistration pro_registration = 18;
inline int CMsgDOTAPlayerInfo::_internal_pro_registration_size() const {
  return _impl_.pro_registration_.size();
}
inline int CMsgDOTAPlayerInfo::pro_registration_size() const {
  return _internal_pro_registration_size();
}
inline void CMsgDOTAPlayerInfo::clear_pro_registration() {
  _impl_.pro_registration_.Clear();
}
inline ::CMsgDOTAPlayerInfo_ProRegistration* CMsgDOTAPlayerInfo::mutable_pro_registration(int index) {
  // @@protoc_insertion_point(field_mutable:CMsgDOTAPlayerInfo.pro_registration)
  return _impl_.pro_registration_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CMsgDOTAPlayerInfo_ProRegistration >*
CMsgDOTAPlayerInfo::mutable_pro_registration() {
  // @@protoc_insertion_point(field_mutable_list:CMsgDOTAPlayerInfo.pro_registration)
  return &_impl_.pro_registration_;
}
inline const ::CMsgDOTAPlayerInfo_ProRegistration& CMsgDOTAPlayerInfo::_internal_pro_registration(int index) const {
  return _impl_.pro_registration_.Get(index);
}
inline const ::CMsgDOTAPlayerInfo_ProRegistration& CMsgDOTAPlayerInfo::pro_registration(int index) const {
  // @@protoc_insertion_point(field_get:CMsgDOTAPlayerInfo.pro_registration)
  return _internal_pro_registration(index);
}
inline ::CMsgDOTAPlayerInfo_ProRegistration* CMsgDOTAPlayerInfo::_internal_add_pro_registration() {
  return _impl_.pro_registration_.Add();
}
inline ::CMsgDOTAPlayerInfo_ProRegistration* CMsgDOTAPlayerInfo::add_pro_registration() {
  ::CMsgDOTAPlayerInfo_ProRegistration* _add = _internal_add_pro_registration();
  // @@protoc_insertion_point(field_add:CMsgDOTAPlayerInfo.pro_registration)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CMsgDOTAPlayerInfo_ProRegistration >&
CMsgDOTAPlayerInfo::pro_registration() const {
  // @@protoc_insertion_point(field_list:CMsgDOTAPlayerInfo.pro_registration)
  return _impl_.pro_registration_;
}

// optional bool has_played_in_international = 19;
inline bool CMsgDOTAPlayerInfo::_internal_has_has_played_in_international() const {
  bool value = (_impl_._has_bits_[0] & 0x00001000u) != 0;
  return value;
}
inline bool CMsgDOTAPlayerInfo::has_has_played_in_international() const {
  return _internal_has_has_played_in_international();
}
inline void CMsgDOTAPlayerInfo::clear_has_played_in_international() {
  _impl_.has_played_in_international_ = false;
  _impl_._has_bits_[0] &= ~0x00001000u;
}
inline bool CMsgDOTAPlayerInfo::_internal_has_played_in_international() const {
  return _impl_.has_played_in_international_;
}
inline bool CMsgDOTAPlayerInfo::has_played_in_international() const {
  // @@protoc_insertion_point(field_get:CMsgDOTAPlayerInfo.has_played_in_international)
  return _internal_has_played_in_international();
}
inline void CMsgDOTAPlayerInfo::_internal_set_has_played_in_international(bool value) {
  _impl_._has_bits_[0] |= 0x00001000u;
  _impl_.has_played_in_international_ = value;
}
inline void CMsgDOTAPlayerInfo::set_has_played_in_international(bool value) {
  _internal_set_has_played_in_international(value);
  // @@protoc_insertion_point(field_set:CMsgDOTAPlayerInfo.has_played_in_international)
}
