...
class CMsgClientToGCOverworldMinigameAction;
struct CMsgClientToGCOverworldMinigameActionDefaultTypeInternal;
extern CMsgClientToGCOverworldMinigameActionDefaultTypeInternal _CMsgClientToGCOverworldMinigameAction_default_instance_;
class CMsgClientToGCOverworldMinigameActionResponse;
struct CMsgClientToGCOverworldMinigameActionResponseDefaultTypeInternal;
extern CMsgClientToGCOverworldMinigameActionResponseDefaultTypeInternal _CMsgClientToGCOverworldMinigameActionResponse_default_instance_;
...
class CMsgClientToGCOverworldRequestTokensNeededByFriendResponse;
struct CMsgClientToGCOverworldRequestTokensNeededByFriendResponseDefaultTypeInternal;
extern CMsgClientToGCOverworldRequestTokensNeededByFriendResponseDefaultTypeInternal _CMsgClientToGCOverworldRequestTokensNeededByFriendResponse_default_instance_;
...
class CMsgOverworldMinigameCustomData;
struct CMsgOverworldMinigameCustomDataDefaultTypeInternal;
extern CMsgOverworldMinigameCustomDataDefaultTypeInternal _CMsgOverworldMinigameCustomData_default_instance_;
class CMsgOverworldMinigameUserData;
struct CMsgOverworldMinigameUserDataDefaultTypeInternal;
extern CMsgOverworldMinigameUserDataDefaultTypeInternal _CMsgOverworldMinigameUserData_default_instance_;
...
class CMsgOverworldUserData_MinigameDataEntry;
struct CMsgOverworldUserData_MinigameDataEntryDefaultTypeInternal;
extern CMsgOverworldUserData_MinigameDataEntryDefaultTypeInternal _CMsgOverworldUserData_MinigameDataEntry_default_instance_;
PROTOBUF_NAMESPACE_OPEN
...
template<> ::CMsgClientToGCOverworldMinigameAction* Arena::CreateMaybeMessage<::CMsgClientToGCOverworldMinigameAction>(Arena*);
...
template<> ::CMsgOverworldMinigameCustomData* Arena::CreateMaybeMessage<::CMsgOverworldMinigameCustomData>(Arena*);
template<> ::CMsgOverworldMinigameUserData* Arena::CreateMaybeMessage<::CMsgOverworldMinigameUserData>(Arena*);
...
template<> ::CMsgOverworldUserData_MinigameDataEntry* Arena::CreateMaybeMessage<::CMsgOverworldUserData_MinigameDataEntry>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
enum CMsgClientToGCOverworldCompletePathResponse_EResponse : int {
  ...
  CMsgClientToGCOverworldCompletePathResponse_EResponse_k_eEventExpired = 10
};
...
constexpr CMsgClientToGCOverworldCompletePathResponse_EResponse CMsgClientToGCOverworldCompletePathResponse_EResponse_EResponse_MAX = CMsgClientToGCOverworldCompletePathResponse_EResponse_k_eEventExpired;
...
enum CMsgClientToGCOverworldClaimEncounterRewardResponse_EResponse : int {
  ...
  CMsgClientToGCOverworldClaimEncounterRewardResponse_EResponse_k_eInvalidRewardData = 15,
  CMsgClientToGCOverworldClaimEncounterRewardResponse_EResponse_k_eEventExpired = 16
};
...
constexpr CMsgClientToGCOverworldClaimEncounterRewardResponse_EResponse CMsgClientToGCOverworldClaimEncounterRewardResponse_EResponse_EResponse_MAX = CMsgClientToGCOverworldClaimEncounterRewardResponse_EResponse_k_eEventExpired;
...
enum CMsgClientToGCOverworldRequestTokensNeededByFriendResponse_EResponse : int {
  CMsgClientToGCOverworldRequestTokensNeededByFriendResponse_EResponse_k_eInternalError = 0,
  CMsgClientToGCOverworldRequestTokensNeededByFriendResponse_EResponse_k_eSuccess = 1,
  CMsgClientToGCOverworldRequestTokensNeededByFriendResponse_EResponse_k_eTooBusy = 2,
  CMsgClientToGCOverworldRequestTokensNeededByFriendResponse_EResponse_k_eDisabled = 3,
  CMsgClientToGCOverworldRequestTokensNeededByFriendResponse_EResponse_k_eTimeout = 4,
  CMsgClientToGCOverworldRequestTokensNeededByFriendResponse_EResponse_k_eNotAllowed = 5,
  CMsgClientToGCOverworldRequestTokensNeededByFriendResponse_EResponse_k_eNodeLocked = 6,
  CMsgClientToGCOverworldRequestTokensNeededByFriendResponse_EResponse_k_eInvalidOverworld = 7,
  CMsgClientToGCOverworldRequestTokensNeededByFriendResponse_EResponse_k_eInvalidFriend = 8,
  CMsgClientToGCOverworldRequestTokensNeededByFriendResponse_EResponse_k_eTooManyRequests = 9
};
bool CMsgClientToGCOverworldRequestTokensNeededByFriendResponse_EResponse_IsValid(int value);
constexpr CMsgClientToGCOverworldRequestTokensNeededByFriendResponse_EResponse CMsgClientToGCOverworldRequestTokensNeededByFriendResponse_EResponse_EResponse_MIN = CMsgClientToGCOverworldRequestTokensNeededByFriendResponse_EResponse_k_eInternalError;
constexpr CMsgClientToGCOverworldRequestTokensNeededByFriendResponse_EResponse CMsgClientToGCOverworldRequestTokensNeededByFriendResponse_EResponse_EResponse_MAX = CMsgClientToGCOverworldRequestTokensNeededByFriendResponse_EResponse_k_eTooManyRequests;
constexpr int CMsgClientToGCOverworldRequestTokensNeededByFriendResponse_EResponse_EResponse_ARRAYSIZE = CMsgClientToGCOverworldRequestTokensNeededByFriendResponse_EResponse_EResponse_MAX + 1;
...
template<typename T>
inline const std::string& CMsgClientToGCOverworldRequestTokensNeededByFriendResponse_EResponse_Name(T enum_t_value) {
  static_assert(::std::is_same<T, CMsgClientToGCOverworldRequestTokensNeededByFriendResponse_EResponse>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function CMsgClientToGCOverworldRequestTokensNeededByFriendResponse_EResponse_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    CMsgClientToGCOverworldRequestTokensNeededByFriendResponse_EResponse_descriptor(), enum_t_value);
}
inline bool CMsgClientToGCOverworldRequestTokensNeededByFriendResponse_EResponse_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, CMsgClientToGCOverworldRequestTokensNeededByFriendResponse_EResponse* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<CMsgClientToGCOverworldRequestTokensNeededByFriendResponse_EResponse>(
    CMsgClientToGCOverworldRequestTokensNeededByFriendResponse_EResponse_descriptor(), name, value);
}
...
enum CMsgClientToGCOverworldMinigameActionResponse_EResponse : int {
  CMsgClientToGCOverworldMinigameActionResponse_EResponse_k_eInternalError = 0,
  CMsgClientToGCOverworldMinigameActionResponse_EResponse_k_eSuccess = 1,
  CMsgClientToGCOverworldMinigameActionResponse_EResponse_k_eTooBusy = 2,
  CMsgClientToGCOverworldMinigameActionResponse_EResponse_k_eDisabled = 3,
  CMsgClientToGCOverworldMinigameActionResponse_EResponse_k_eTimeout = 4,
  CMsgClientToGCOverworldMinigameActionResponse_EResponse_k_eInvalidOverworld = 5,
  CMsgClientToGCOverworldMinigameActionResponse_EResponse_k_eInvalidNode = 6,
  CMsgClientToGCOverworldMinigameActionResponse_EResponse_k_eNodeLocked = 7,
  CMsgClientToGCOverworldMinigameActionResponse_EResponse_k_eInvalidSelection = 8,
  CMsgClientToGCOverworldMinigameActionResponse_EResponse_k_eNotEnoughTokens = 9,
  CMsgClientToGCOverworldMinigameActionResponse_EResponse_k_eNotEnoughMinigameCurrency = 10,
  CMsgClientToGCOverworldMinigameActionResponse_EResponse_k_eNotAllowed = 11
};
bool CMsgClientToGCOverworldMinigameActionResponse_EResponse_IsValid(int value);
constexpr CMsgClientToGCOverworldMinigameActionResponse_EResponse CMsgClientToGCOverworldMinigameActionResponse_EResponse_EResponse_MIN = CMsgClientToGCOverworldMinigameActionResponse_EResponse_k_eInternalError;
constexpr CMsgClientToGCOverworldMinigameActionResponse_EResponse CMsgClientToGCOverworldMinigameActionResponse_EResponse_EResponse_MAX = CMsgClientToGCOverworldMinigameActionResponse_EResponse_k_eNotAllowed;
constexpr int CMsgClientToGCOverworldMinigameActionResponse_EResponse_EResponse_ARRAYSIZE = CMsgClientToGCOverworldMinigameActionResponse_EResponse_EResponse_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* CMsgClientToGCOverworldMinigameActionResponse_EResponse_descriptor();
template<typename T>
inline const std::string& CMsgClientToGCOverworldMinigameActionResponse_EResponse_Name(T enum_t_value) {
  static_assert(::std::is_same<T, CMsgClientToGCOverworldMinigameActionResponse_EResponse>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function CMsgClientToGCOverworldMinigameActionResponse_EResponse_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    CMsgClientToGCOverworldMinigameActionResponse_EResponse_descriptor(), enum_t_value);
}
inline bool CMsgClientToGCOverworldMinigameActionResponse_EResponse_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, CMsgClientToGCOverworldMinigameActionResponse_EResponse* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<CMsgClientToGCOverworldMinigameActionResponse_EResponse>(
    CMsgClientToGCOverworldMinigameActionResponse_EResponse_descriptor(), name, value);
}
...
constexpr EOverworldPathState EOverworldPathState_MIN = k_eOverworldPathState_Invalid;
constexpr EOverworldPathState EOverworldPathState_MAX = k_eOverworldPathState_Complete;
constexpr int EOverworldPathState_ARRAYSIZE = EOverworldPathState_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* EOverworldPathState_descriptor();
template<typename T>
inline const std::string& EOverworldPathState_Name(T enum_t_value) {
  static_assert(::std::is_same<T, EOverworldPathState>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function EOverworldPathState_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    EOverworldPathState_descriptor(), enum_t_value);
}
inline bool EOverworldPathState_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, EOverworldPathState* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<EOverworldPathState>(
    EOverworldPathState_descriptor(), name, value);
}
...
enum EOverworldMinigameAction : int {
...
constexpr EOverworldMinigameAction EOverworldMinigameAction_MIN = k_eOverworldMinigameAction_Invalid;
constexpr EOverworldMinigameAction EOverworldMinigameAction_MAX = k_eOverworldMinigameAction_UnlockDifficulty;
constexpr int EOverworldMinigameAction_ARRAYSIZE = EOverworldMinigameAction_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* EOverworldMinigameAction_descriptor();
template<typename T>
inline const std::string& EOverworldMinigameAction_Name(T enum_t_value) {
  static_assert(::std::is_same<T, EOverworldMinigameAction>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function EOverworldMinigameAction_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    EOverworldMinigameAction_descriptor(), enum_t_value);
}
inline bool EOverworldMinigameAction_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, EOverworldMinigameAction* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<EOverworldMinigameAction>(
    EOverworldMinigameAction_descriptor(), name, value);
}
// ===================================================================
...
class CMsgOverworldPath final :
 ...
 public:
  ...
  bool has_path_state() const;
  private:
  bool _internal_has_path_state() const;
  public:
  void clear_path_state();
  ::EOverworldPathState path_state() const;
  void set_path_state(::EOverworldPathState value);
  private:
  ::EOverworldPathState _internal_path_state() const;
  void _internal_set_path_state(::EOverworldPathState value);
  public:
...
class CMsgOverworldMinigameCustomData final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:CMsgOverworldMinigameCustomData) */ {
 public:
  inline CMsgOverworldMinigameCustomData() : CMsgOverworldMinigameCustomData(nullptr) {}
  ~CMsgOverworldMinigameCustomData() override;
  explicit PROTOBUF_CONSTEXPR CMsgOverworldMinigameCustomData(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  CMsgOverworldMinigameCustomData(const CMsgOverworldMinigameCustomData& from);
  CMsgOverworldMinigameCustomData(CMsgOverworldMinigameCustomData&& from) noexcept
    : CMsgOverworldMinigameCustomData() {
    *this = ::std::move(from);
  }

  inline CMsgOverworldMinigameCustomData& operator=(const CMsgOverworldMinigameCustomData& from) {
    CopyFrom(from);
    return *this;
  }
  inline CMsgOverworldMinigameCustomData& operator=(CMsgOverworldMinigameCustomData&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const CMsgOverworldMinigameCustomData& default_instance() {
    return *internal_default_instance();
  }
  enum MinigameTypeCase {
    kSurvivorsData = 1,
    MINIGAME_TYPE_NOT_SET = 0,
  };

  static inline const CMsgOverworldMinigameCustomData* internal_default_instance() {
    return reinterpret_cast<const CMsgOverworldMinigameCustomData*>(
               &_CMsgOverworldMinigameCustomData_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    12;

  friend void swap(CMsgOverworldMinigameCustomData& a, CMsgOverworldMinigameCustomData& b) {
    a.Swap(&b);
  }
  inline void Swap(CMsgOverworldMinigameCustomData* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(CMsgOverworldMinigameCustomData* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  CMsgOverworldMinigameCustomData* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<CMsgOverworldMinigameCustomData>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const CMsgOverworldMinigameCustomData& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const CMsgOverworldMinigameCustomData& from) {
    CMsgOverworldMinigameCustomData::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(CMsgOverworldMinigameCustomData* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "CMsgOverworldMinigameCustomData";
  }
  protected:
  explicit CMsgOverworldMinigameCustomData(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  enum : int {
    kSurvivorsDataFieldNumber = 1,
  };
  // .CMsgSurvivorsUserData survivors_data = 1;
  bool has_survivors_data() const;
  private:
  bool _internal_has_survivors_data() const;
  public:
  void clear_survivors_data();
  const ::CMsgSurvivorsUserData& survivors_data() const;
  PROTOBUF_NODISCARD ::CMsgSurvivorsUserData* release_survivors_data();
  ::CMsgSurvivorsUserData* mutable_survivors_data();
  void set_allocated_survivors_data(::CMsgSurvivorsUserData* survivors_data);
  private:
  const ::CMsgSurvivorsUserData& _internal_survivors_data() const;
  ::CMsgSurvivorsUserData* _internal_mutable_survivors_data();
  public:
  void unsafe_arena_set_allocated_survivors_data(
      ::CMsgSurvivorsUserData* survivors_data);
  ::CMsgSurvivorsUserData* unsafe_arena_release_survivors_data();

  void clear_minigame_type();
  MinigameTypeCase minigame_type_case() const;
  // @@protoc_insertion_point(class_scope:CMsgOverworldMinigameCustomData)
 private:
  class _Internal;
  void set_has_survivors_data();

  inline bool has_minigame_type() const;
  inline void clear_has_minigame_type();

  template <typename T> friend class ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper;
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  struct Impl_ {
    union MinigameTypeUnion {
      constexpr MinigameTypeUnion() : _constinit_{} {}
        ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized _constinit_;
      ::CMsgSurvivorsUserData* survivors_data_;
    } minigame_type_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
...
class CMsgOverworldMinigameUserData final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:CMsgOverworldMinigameUserData) */ {
 public:
  inline CMsgOverworldMinigameUserData() : CMsgOverworldMinigameUserData(nullptr) {}
  ~CMsgOverworldMinigameUserData() override;
  explicit PROTOBUF_CONSTEXPR CMsgOverworldMinigameUserData(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  CMsgOverworldMinigameUserData(const CMsgOverworldMinigameUserData& from);
  CMsgOverworldMinigameUserData(CMsgOverworldMinigameUserData&& from) noexcept
    : CMsgOverworldMinigameUserData() {
    *this = ::std::move(from);
  }

  inline CMsgOverworldMinigameUserData& operator=(const CMsgOverworldMinigameUserData& from) {
    CopyFrom(from);
    return *this;
  }
  inline CMsgOverworldMinigameUserData& operator=(CMsgOverworldMinigameUserData&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const CMsgOverworldMinigameUserData& default_instance() {
    return *internal_default_instance();
  }
  static inline const CMsgOverworldMinigameUserData* internal_default_instance() {
    return reinterpret_cast<const CMsgOverworldMinigameUserData*>(
               &_CMsgOverworldMinigameUserData_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    13;

  friend void swap(CMsgOverworldMinigameUserData& a, CMsgOverworldMinigameUserData& b) {
    a.Swap(&b);
  }
  inline void Swap(CMsgOverworldMinigameUserData* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(CMsgOverworldMinigameUserData* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  CMsgOverworldMinigameUserData* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<CMsgOverworldMinigameUserData>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const CMsgOverworldMinigameUserData& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const CMsgOverworldMinigameUserData& from) {
    CMsgOverworldMinigameUserData::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(CMsgOverworldMinigameUserData* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "CMsgOverworldMinigameUserData";
  }
  protected:
  explicit CMsgOverworldMinigameUserData(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  const ::CMsgOverworldMinigameCustomData& custom_data() const;
  PROTOBUF_NODISCARD ::CMsgOverworldMinigameCustomData* release_custom_data();
  ::CMsgOverworldMinigameCustomData* mutable_custom_data();
  void set_allocated_custom_data(::CMsgOverworldMinigameCustomData* custom_data);
  private:
  const ::CMsgOverworldMinigameCustomData& _internal_custom_data() const;
  ::CMsgOverworldMinigameCustomData* _internal_mutable_custom_data();
  public:
  void unsafe_arena_set_allocated_custom_data(
      ::CMsgOverworldMinigameCustomData* custom_data);
  ::CMsgOverworldMinigameCustomData* unsafe_arena_release_custom_data();
  ...
  uint32_t currency_amount() const;
  void set_currency_amount(uint32_t value);
  private:
  uint32_t _internal_currency_amount() const;
  void _internal_set_currency_amount(uint32_t value);
  public:

  // @@protoc_insertion_point(class_scope:CMsgOverworldMinigameUserData)
 private:
  class _Internal;
  ...
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::internal::HasBits<1> _has_bits_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
    ::CMsgOverworldMinigameCustomData* custom_data_;
    uint32_t node_id_;
    uint32_t currency_amount_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_dota_5fgcmessages_5fcommon_5foverworld_2eproto;
};
...
class CMsgOverworldUserData_MinigameDataEntry final :
 ...
 public:
  inline CMsgOverworldUserData_MinigameDataEntry() : CMsgOverworldUserData_MinigameDataEntry(nullptr) {}
  ~CMsgOverworldUserData_MinigameDataEntry() override;
  explicit PROTOBUF_CONSTEXPR CMsgOverworldUserData_MinigameDataEntry(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  CMsgOverworldUserData_MinigameDataEntry(const CMsgOverworldUserData_MinigameDataEntry& from);
  CMsgOverworldUserData_MinigameDataEntry(CMsgOverworldUserData_MinigameDataEntry&& from) noexcept
    : CMsgOverworldUserData_MinigameDataEntry() {
    *this = ::std::move(from);
  }

  inline CMsgOverworldUserData_MinigameDataEntry& operator=(const CMsgOverworldUserData_MinigameDataEntry& from) {
    CopyFrom(from);
    return *this;
  }
  inline CMsgOverworldUserData_MinigameDataEntry& operator=(CMsgOverworldUserData_MinigameDataEntry&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const CMsgOverworldUserData_MinigameDataEntry& default_instance() {
    return *internal_default_instance();
  }
  static inline const CMsgOverworldUserData_MinigameDataEntry* internal_default_instance() {
    return reinterpret_cast<const CMsgOverworldUserData_MinigameDataEntry*>(
  ...
  inline void Swap(CMsgOverworldUserData_MinigameDataEntry* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(CMsgOverworldUserData_MinigameDataEntry* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  CMsgOverworldUserData_MinigameDataEntry* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<CMsgOverworldUserData_MinigameDataEntry>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const CMsgOverworldUserData_MinigameDataEntry& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const CMsgOverworldUserData_MinigameDataEntry& from) {
    CMsgOverworldUserData_MinigameDataEntry::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(CMsgOverworldUserData_MinigameDataEntry* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "CMsgOverworldUserData.MinigameDataEntry";
  }
  protected:
  explicit CMsgOverworldUserData_MinigameDataEntry(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  public:
  void clear_value();
  const ::CMsgOverworldMinigameUserData& value() const;
  PROTOBUF_NODISCARD ::CMsgOverworldMinigameUserData* release_value();
  ::CMsgOverworldMinigameUserData* mutable_value();
  void set_allocated_value(::CMsgOverworldMinigameUserData* value);
  private:
  const ::CMsgOverworldMinigameUserData& _internal_value() const;
  ::CMsgOverworldMinigameUserData* _internal_mutable_value();
  public:
  void unsafe_arena_set_allocated_value(
      ::CMsgOverworldMinigameUserData* value);
  ::CMsgOverworldMinigameUserData* unsafe_arena_release_value();
  ...
  // @@protoc_insertion_point(class_scope:CMsgOverworldUserData.MinigameDataEntry)
 private:
  class _Internal;
  ...
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::internal::HasBits<1> _has_bits_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
    ::CMsgOverworldMinigameUserData* value_;
    uint32_t key_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_dota_5fgcmessages_5fcommon_5foverworld_2eproto;
...
class CMsgOverworldUserData final :
 ...
 public:
  ...
  typedef CMsgOverworldUserData_MinigameDataEntry MinigameDataEntry;
  ...
  int minigame_data_size() const;
  private:
  int _internal_minigame_data_size() const;
  public:
  void clear_minigame_data();
  ::CMsgOverworldUserData_MinigameDataEntry* mutable_minigame_data(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CMsgOverworldUserData_MinigameDataEntry >*
      mutable_minigame_data();
  private:
  const ::CMsgOverworldUserData_MinigameDataEntry& _internal_minigame_data(int index) const;
  ::CMsgOverworldUserData_MinigameDataEntry* _internal_add_minigame_data();
  public:
  const ::CMsgOverworldUserData_MinigameDataEntry& minigame_data(int index) const;
  ::CMsgOverworldUserData_MinigameDataEntry* add_minigame_data();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CMsgOverworldUserData_MinigameDataEntry >&
      minigame_data() const;
...
class CMsgClientToGCOverworldCompletePathResponse final :
 ...
 public:
  ...
  static constexpr EResponse k_eEventExpired =
    CMsgClientToGCOverworldCompletePathResponse_EResponse_k_eEventExpired;
  static inline bool EResponse_IsValid(int value) {
...
class CMsgClientToGCOverworldClaimEncounterReward final :
 ...
 public:
  ...
  enum : int {
    ...
    kLeaderboardIndexFieldNumber = 7,
    kShouldClaimRewardFieldNumber = 8,
  };
  ...
  uint32_t leaderboard_data() const;
  void set_leaderboard_data(uint32_t value);
  private:
  uint32_t _internal_leaderboard_data() const;
  void _internal_set_leaderboard_data(uint32_t value);
  public:

  // optional uint32 leaderboard_index = 7;
  bool has_leaderboard_index() const;
  private:
  bool _internal_has_leaderboard_index() const;
  public:
  void clear_leaderboard_index();
  uint32_t leaderboard_index() const;
  void set_leaderboard_index(uint32_t value);
  private:
  uint32_t _internal_leaderboard_index() const;
  void _internal_set_leaderboard_index(uint32_t value);
  public:

  // optional bool should_claim_reward = 8;
  bool has_should_claim_reward() const;
  private:
  bool _internal_has_should_claim_reward() const;
  public:
  void clear_should_claim_reward();
  bool should_claim_reward() const;
  void set_should_claim_reward(bool value);
  private:
  bool _internal_should_claim_reward() const;
  void _internal_set_should_claim_reward(bool value);
  public:
 ...
 private:
  ...
  struct Impl_ {
    ...
    uint32_t leaderboard_data_;
    uint32_t leaderboard_index_;
    bool should_claim_reward_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_dota_5fgcmessages_5fcommon_5foverworld_2eproto;
};
...
class CMsgClientToGCOverworldClaimEncounterRewardResponse final :
 ...
 public:
  ...
  static constexpr EResponse k_eInvalidRewardData =
    CMsgClientToGCOverworldClaimEncounterRewardResponse_EResponse_k_eInvalidRewardData;
  static constexpr EResponse k_eEventExpired =
    CMsgClientToGCOverworldClaimEncounterRewardResponse_EResponse_k_eEventExpired;
  static inline bool EResponse_IsValid(int value) {
...
class CMsgClientToGCOverworldRequestTokensNeededByFriend final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:CMsgClientToGCOverworldRequestTokensNeededByFriend) */ {
 public:
  inline CMsgClientToGCOverworldRequestTokensNeededByFriend() : CMsgClientToGCOverworldRequestTokensNeededByFriend(nullptr) {}
  ~CMsgClientToGCOverworldRequestTokensNeededByFriend() override;
  explicit PROTOBUF_CONSTEXPR CMsgClientToGCOverworldRequestTokensNeededByFriend(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  CMsgClientToGCOverworldRequestTokensNeededByFriend(const CMsgClientToGCOverworldRequestTokensNeededByFriend& from);
  CMsgClientToGCOverworldRequestTokensNeededByFriend(CMsgClientToGCOverworldRequestTokensNeededByFriend&& from) noexcept
    : CMsgClientToGCOverworldRequestTokensNeededByFriend() {
    *this = ::std::move(from);
  }

  inline CMsgClientToGCOverworldRequestTokensNeededByFriend& operator=(const CMsgClientToGCOverworldRequestTokensNeededByFriend& from) {
    CopyFrom(from);
    return *this;
  }
  inline CMsgClientToGCOverworldRequestTokensNeededByFriend& operator=(CMsgClientToGCOverworldRequestTokensNeededByFriend&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const CMsgClientToGCOverworldRequestTokensNeededByFriend& default_instance() {
    return *internal_default_instance();
  }
  static inline const CMsgClientToGCOverworldRequestTokensNeededByFriend* internal_default_instance() {
    return reinterpret_cast<const CMsgClientToGCOverworldRequestTokensNeededByFriend*>(
  ...
  inline void Swap(CMsgClientToGCOverworldRequestTokensNeededByFriend* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(CMsgClientToGCOverworldRequestTokensNeededByFriend* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  CMsgClientToGCOverworldRequestTokensNeededByFriend* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<CMsgClientToGCOverworldRequestTokensNeededByFriend>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const CMsgClientToGCOverworldRequestTokensNeededByFriend& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const CMsgClientToGCOverworldRequestTokensNeededByFriend& from) {
    CMsgClientToGCOverworldRequestTokensNeededByFriend::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(CMsgClientToGCOverworldRequestTokensNeededByFriend* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "CMsgClientToGCOverworldRequestTokensNeededByFriend";
  }
  protected:
  explicit CMsgClientToGCOverworldRequestTokensNeededByFriend(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  // @@protoc_insertion_point(class_scope:CMsgClientToGCOverworldRequestTokensNeededByFriend)
 private:
  class _Internal;
...
class CMsgClientToGCOverworldRequestTokensNeededByFriendResponse final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:CMsgClientToGCOverworldRequestTokensNeededByFriendResponse) */ {
 public:
  inline CMsgClientToGCOverworldRequestTokensNeededByFriendResponse() : CMsgClientToGCOverworldRequestTokensNeededByFriendResponse(nullptr) {}
  ~CMsgClientToGCOverworldRequestTokensNeededByFriendResponse() override;
  explicit PROTOBUF_CONSTEXPR CMsgClientToGCOverworldRequestTokensNeededByFriendResponse(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  CMsgClientToGCOverworldRequestTokensNeededByFriendResponse(const CMsgClientToGCOverworldRequestTokensNeededByFriendResponse& from);
  CMsgClientToGCOverworldRequestTokensNeededByFriendResponse(CMsgClientToGCOverworldRequestTokensNeededByFriendResponse&& from) noexcept
    : CMsgClientToGCOverworldRequestTokensNeededByFriendResponse() {
    *this = ::std::move(from);
  }

  inline CMsgClientToGCOverworldRequestTokensNeededByFriendResponse& operator=(const CMsgClientToGCOverworldRequestTokensNeededByFriendResponse& from) {
    CopyFrom(from);
    return *this;
  }
  inline CMsgClientToGCOverworldRequestTokensNeededByFriendResponse& operator=(CMsgClientToGCOverworldRequestTokensNeededByFriendResponse&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const CMsgClientToGCOverworldRequestTokensNeededByFriendResponse& default_instance() {
    return *internal_default_instance();
  }
  static inline const CMsgClientToGCOverworldRequestTokensNeededByFriendResponse* internal_default_instance() {
    return reinterpret_cast<const CMsgClientToGCOverworldRequestTokensNeededByFriendResponse*>(
  ...
  inline void Swap(CMsgClientToGCOverworldRequestTokensNeededByFriendResponse* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(CMsgClientToGCOverworldRequestTokensNeededByFriendResponse* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  CMsgClientToGCOverworldRequestTokensNeededByFriendResponse* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<CMsgClientToGCOverworldRequestTokensNeededByFriendResponse>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const CMsgClientToGCOverworldRequestTokensNeededByFriendResponse& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const CMsgClientToGCOverworldRequestTokensNeededByFriendResponse& from) {
    CMsgClientToGCOverworldRequestTokensNeededByFriendResponse::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(CMsgClientToGCOverworldRequestTokensNeededByFriendResponse* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "CMsgClientToGCOverworldRequestTokensNeededByFriendResponse";
  }
  protected:
  explicit CMsgClientToGCOverworldRequestTokensNeededByFriendResponse(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  typedef CMsgClientToGCOverworldRequestTokensNeededByFriendResponse_EResponse EResponse;
  static constexpr EResponse k_eInternalError =
    CMsgClientToGCOverworldRequestTokensNeededByFriendResponse_EResponse_k_eInternalError;
  static constexpr EResponse k_eSuccess =
    CMsgClientToGCOverworldRequestTokensNeededByFriendResponse_EResponse_k_eSuccess;
  static constexpr EResponse k_eTooBusy =
    CMsgClientToGCOverworldRequestTokensNeededByFriendResponse_EResponse_k_eTooBusy;
  static constexpr EResponse k_eDisabled =
    CMsgClientToGCOverworldRequestTokensNeededByFriendResponse_EResponse_k_eDisabled;
  static constexpr EResponse k_eTimeout =
    CMsgClientToGCOverworldRequestTokensNeededByFriendResponse_EResponse_k_eTimeout;
  static constexpr EResponse k_eNotAllowed =
    CMsgClientToGCOverworldRequestTokensNeededByFriendResponse_EResponse_k_eNotAllowed;
  static constexpr EResponse k_eNodeLocked =
    CMsgClientToGCOverworldRequestTokensNeededByFriendResponse_EResponse_k_eNodeLocked;
  static constexpr EResponse k_eInvalidOverworld =
    CMsgClientToGCOverworldRequestTokensNeededByFriendResponse_EResponse_k_eInvalidOverworld;
  static constexpr EResponse k_eInvalidFriend =
    CMsgClientToGCOverworldRequestTokensNeededByFriendResponse_EResponse_k_eInvalidFriend;
  static constexpr EResponse k_eTooManyRequests =
    CMsgClientToGCOverworldRequestTokensNeededByFriendResponse_EResponse_k_eTooManyRequests;
  static inline bool EResponse_IsValid(int value) {
    return CMsgClientToGCOverworldRequestTokensNeededByFriendResponse_EResponse_IsValid(value);
  }
  static constexpr EResponse EResponse_MIN =
    CMsgClientToGCOverworldRequestTokensNeededByFriendResponse_EResponse_EResponse_MIN;
  static constexpr EResponse EResponse_MAX =
    CMsgClientToGCOverworldRequestTokensNeededByFriendResponse_EResponse_EResponse_MAX;
  static constexpr int EResponse_ARRAYSIZE =
    CMsgClientToGCOverworldRequestTokensNeededByFriendResponse_EResponse_EResponse_ARRAYSIZE;
  static inline const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor*
  EResponse_descriptor() {
    return CMsgClientToGCOverworldRequestTokensNeededByFriendResponse_EResponse_descriptor();
  }
  template<typename T>
  static inline const std::string& EResponse_Name(T enum_t_value) {
    static_assert(::std::is_same<T, EResponse>::value ||
      ::std::is_integral<T>::value,
      "Incorrect type passed to function EResponse_Name.");
    return CMsgClientToGCOverworldRequestTokensNeededByFriendResponse_EResponse_Name(enum_t_value);
  }
  static inline bool EResponse_Parse(::PROTOBUF_NAMESPACE_ID::ConstStringParam name,
      EResponse* value) {
    return CMsgClientToGCOverworldRequestTokensNeededByFriendResponse_EResponse_Parse(name, value);
  }
  ...
  public:
  void clear_response();
  ::CMsgClientToGCOverworldRequestTokensNeededByFriendResponse_EResponse response() const;
  void set_response(::CMsgClientToGCOverworldRequestTokensNeededByFriendResponse_EResponse value);
  private:
  ::CMsgClientToGCOverworldRequestTokensNeededByFriendResponse_EResponse _internal_response() const;
  void _internal_set_response(::CMsgClientToGCOverworldRequestTokensNeededByFriendResponse_EResponse value);
  public:

  // @@protoc_insertion_point(class_scope:CMsgClientToGCOverworldRequestTokensNeededByFriendResponse)
 private:
  class _Internal;
...
class CMsgClientToGCOverworldMinigameAction final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:CMsgClientToGCOverworldMinigameAction) */ {
 public:
  inline CMsgClientToGCOverworldMinigameAction() : CMsgClientToGCOverworldMinigameAction(nullptr) {}
  ~CMsgClientToGCOverworldMinigameAction() override;
  explicit PROTOBUF_CONSTEXPR CMsgClientToGCOverworldMinigameAction(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  CMsgClientToGCOverworldMinigameAction(const CMsgClientToGCOverworldMinigameAction& from);
  CMsgClientToGCOverworldMinigameAction(CMsgClientToGCOverworldMinigameAction&& from) noexcept
    : CMsgClientToGCOverworldMinigameAction() {
    *this = ::std::move(from);
  }

  inline CMsgClientToGCOverworldMinigameAction& operator=(const CMsgClientToGCOverworldMinigameAction& from) {
    CopyFrom(from);
    return *this;
  }
  inline CMsgClientToGCOverworldMinigameAction& operator=(CMsgClientToGCOverworldMinigameAction&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const CMsgClientToGCOverworldMinigameAction& default_instance() {
    return *internal_default_instance();
  }
  static inline const CMsgClientToGCOverworldMinigameAction* internal_default_instance() {
    return reinterpret_cast<const CMsgClientToGCOverworldMinigameAction*>(
  ...
  inline void Swap(CMsgClientToGCOverworldMinigameAction* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(CMsgClientToGCOverworldMinigameAction* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  CMsgClientToGCOverworldMinigameAction* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<CMsgClientToGCOverworldMinigameAction>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const CMsgClientToGCOverworldMinigameAction& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const CMsgClientToGCOverworldMinigameAction& from) {
    CMsgClientToGCOverworldMinigameAction::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(CMsgClientToGCOverworldMinigameAction* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "CMsgClientToGCOverworldMinigameAction";
  }
  protected:
  explicit CMsgClientToGCOverworldMinigameAction(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  enum : int {
    ...
    kOptionValueFieldNumber = 5,
    kCurrencyAmountFieldNumber = 6,
  };
  // optional uint32 overworld_id = 1;
  bool has_overworld_id() const;
  private:
  ...
  public:
  void clear_action();
  ::EOverworldMinigameAction action() const;
  void set_action(::EOverworldMinigameAction value);
  private:
  ::EOverworldMinigameAction _internal_action() const;
  void _internal_set_action(::EOverworldMinigameAction value);
  public:
  ...
  bool has_option_value() const;
  private:
  bool _internal_has_option_value() const;
  public:
  void clear_option_value();
  uint32_t option_value() const;
  void set_option_value(uint32_t value);
  private:
  uint32_t _internal_option_value() const;
  void _internal_set_option_value(uint32_t value);
  public:
  ...
  // @@protoc_insertion_point(class_scope:CMsgClientToGCOverworldMinigameAction)
 private:
  class _Internal;
...
class CMsgClientToGCOverworldMinigameActionResponse final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:CMsgClientToGCOverworldMinigameActionResponse) */ {
 public:
  inline CMsgClientToGCOverworldMinigameActionResponse() : CMsgClientToGCOverworldMinigameActionResponse(nullptr) {}
  ~CMsgClientToGCOverworldMinigameActionResponse() override;
  explicit PROTOBUF_CONSTEXPR CMsgClientToGCOverworldMinigameActionResponse(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  CMsgClientToGCOverworldMinigameActionResponse(const CMsgClientToGCOverworldMinigameActionResponse& from);
  CMsgClientToGCOverworldMinigameActionResponse(CMsgClientToGCOverworldMinigameActionResponse&& from) noexcept
    : CMsgClientToGCOverworldMinigameActionResponse() {
    *this = ::std::move(from);
  }

  inline CMsgClientToGCOverworldMinigameActionResponse& operator=(const CMsgClientToGCOverworldMinigameActionResponse& from) {
    CopyFrom(from);
    return *this;
  }
  inline CMsgClientToGCOverworldMinigameActionResponse& operator=(CMsgClientToGCOverworldMinigameActionResponse&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const CMsgClientToGCOverworldMinigameActionResponse& default_instance() {
    return *internal_default_instance();
  }
  static inline const CMsgClientToGCOverworldMinigameActionResponse* internal_default_instance() {
    return reinterpret_cast<const CMsgClientToGCOverworldMinigameActionResponse*>(
  ...
  inline void Swap(CMsgClientToGCOverworldMinigameActionResponse* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(CMsgClientToGCOverworldMinigameActionResponse* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  CMsgClientToGCOverworldMinigameActionResponse* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<CMsgClientToGCOverworldMinigameActionResponse>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const CMsgClientToGCOverworldMinigameActionResponse& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const CMsgClientToGCOverworldMinigameActionResponse& from) {
    CMsgClientToGCOverworldMinigameActionResponse::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(CMsgClientToGCOverworldMinigameActionResponse* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "CMsgClientToGCOverworldMinigameActionResponse";
  }
  protected:
  explicit CMsgClientToGCOverworldMinigameActionResponse(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  typedef CMsgClientToGCOverworldMinigameActionResponse_EResponse EResponse;
  static constexpr EResponse k_eInternalError =
    CMsgClientToGCOverworldMinigameActionResponse_EResponse_k_eInternalError;
  static constexpr EResponse k_eSuccess =
    CMsgClientToGCOverworldMinigameActionResponse_EResponse_k_eSuccess;
  static constexpr EResponse k_eTooBusy =
    CMsgClientToGCOverworldMinigameActionResponse_EResponse_k_eTooBusy;
  static constexpr EResponse k_eDisabled =
    CMsgClientToGCOverworldMinigameActionResponse_EResponse_k_eDisabled;
  static constexpr EResponse k_eTimeout =
    CMsgClientToGCOverworldMinigameActionResponse_EResponse_k_eTimeout;
  static constexpr EResponse k_eInvalidOverworld =
    CMsgClientToGCOverworldMinigameActionResponse_EResponse_k_eInvalidOverworld;
  static constexpr EResponse k_eInvalidNode =
    CMsgClientToGCOverworldMinigameActionResponse_EResponse_k_eInvalidNode;
  static constexpr EResponse k_eNodeLocked =
    CMsgClientToGCOverworldMinigameActionResponse_EResponse_k_eNodeLocked;
  static constexpr EResponse k_eInvalidSelection =
    CMsgClientToGCOverworldMinigameActionResponse_EResponse_k_eInvalidSelection;
  static constexpr EResponse k_eNotEnoughTokens =
    CMsgClientToGCOverworldMinigameActionResponse_EResponse_k_eNotEnoughTokens;
  static constexpr EResponse k_eNotEnoughMinigameCurrency =
    CMsgClientToGCOverworldMinigameActionResponse_EResponse_k_eNotEnoughMinigameCurrency;
  static constexpr EResponse k_eNotAllowed =
    CMsgClientToGCOverworldMinigameActionResponse_EResponse_k_eNotAllowed;
  static inline bool EResponse_IsValid(int value) {
    return CMsgClientToGCOverworldMinigameActionResponse_EResponse_IsValid(value);
  }
  static constexpr EResponse EResponse_MIN =
    CMsgClientToGCOverworldMinigameActionResponse_EResponse_EResponse_MIN;
  static constexpr EResponse EResponse_MAX =
    CMsgClientToGCOverworldMinigameActionResponse_EResponse_EResponse_MAX;
  static constexpr int EResponse_ARRAYSIZE =
    CMsgClientToGCOverworldMinigameActionResponse_EResponse_EResponse_ARRAYSIZE;
  static inline const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor*
  EResponse_descriptor() {
    return CMsgClientToGCOverworldMinigameActionResponse_EResponse_descriptor();
  }
  template<typename T>
  static inline const std::string& EResponse_Name(T enum_t_value) {
    static_assert(::std::is_same<T, EResponse>::value ||
      ::std::is_integral<T>::value,
      "Incorrect type passed to function EResponse_Name.");
    return CMsgClientToGCOverworldMinigameActionResponse_EResponse_Name(enum_t_value);
  }
  static inline bool EResponse_Parse(::PROTOBUF_NAMESPACE_ID::ConstStringParam name,
      EResponse* value) {
    return CMsgClientToGCOverworldMinigameActionResponse_EResponse_Parse(name, value);
  }
  ...
  public:
  void clear_response();
  ::CMsgClientToGCOverworldMinigameActionResponse_EResponse response() const;
  void set_response(::CMsgClientToGCOverworldMinigameActionResponse_EResponse value);
  private:
  ::CMsgClientToGCOverworldMinigameActionResponse_EResponse _internal_response() const;
  void _internal_set_response(::CMsgClientToGCOverworldMinigameActionResponse_EResponse value);
  public:

  // @@protoc_insertion_point(class_scope:CMsgClientToGCOverworldMinigameActionResponse)
 private:
  class _Internal;
...
// optional .EOverworldPathState path_state = 3 [default = k_eOverworldPathState_Invalid];
inline bool CMsgOverworldPath::_internal_has_path_state() const {
  bool value = (_impl_._has_bits_[0] & 0x00000004u) != 0;
  return value;
}
inline bool CMsgOverworldPath::has_path_state() const {
  return _internal_has_path_state();
}
inline void CMsgOverworldPath::clear_path_state() {
  _impl_.path_state_ = 0;
  _impl_._has_bits_[0] &= ~0x00000004u;
}
inline ::EOverworldPathState CMsgOverworldPath::_internal_path_state() const {
  return static_cast< ::EOverworldPathState >(_impl_.path_state_);
}
inline ::EOverworldPathState CMsgOverworldPath::path_state() const {
  // @@protoc_insertion_point(field_get:CMsgOverworldPath.path_state)
  return _internal_path_state();
}
inline void CMsgOverworldPath::_internal_set_path_state(::EOverworldPathState value) {
  assert(::EOverworldPathState_IsValid(value));
  _impl_._has_bits_[0] |= 0x00000004u;
  _impl_.path_state_ = value;
}
inline void CMsgOverworldPath::set_path_state(::EOverworldPathState value) {
  _internal_set_path_state(value);
  // @@protoc_insertion_point(field_set:CMsgOverworldPath.path_state)
}
...
// .CMsgSurvivorsUserData survivors_data = 1;
inline bool CMsgOverworldMinigameCustomData::_internal_has_survivors_data() const {
  return minigame_type_case() == kSurvivorsData;
}
inline bool CMsgOverworldMinigameCustomData::has_survivors_data() const {
  return _internal_has_survivors_data();
}
inline void CMsgOverworldMinigameCustomData::set_has_survivors_data() {
  _impl_._oneof_case_[0] = kSurvivorsData;
}
inline ::CMsgSurvivorsUserData* CMsgOverworldMinigameCustomData::release_survivors_data() {
  // @@protoc_insertion_point(field_release:CMsgOverworldMinigameCustomData.survivors_data)
  if (_internal_has_survivors_data()) {
    clear_has_minigame_type();
    ::CMsgSurvivorsUserData* temp = _impl_.minigame_type_.survivors_data_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    _impl_.minigame_type_.survivors_data_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
}
inline const ::CMsgSurvivorsUserData& CMsgOverworldMinigameCustomData::_internal_survivors_data() const {
  return _internal_has_survivors_data()
      ? *_impl_.minigame_type_.survivors_data_
      : reinterpret_cast< ::CMsgSurvivorsUserData&>(::_CMsgSurvivorsUserData_default_instance_);
}
inline const ::CMsgSurvivorsUserData& CMsgOverworldMinigameCustomData::survivors_data() const {
  // @@protoc_insertion_point(field_get:CMsgOverworldMinigameCustomData.survivors_data)
  return _internal_survivors_data();
}
inline ::CMsgSurvivorsUserData* CMsgOverworldMinigameCustomData::unsafe_arena_release_survivors_data() {
  // @@protoc_insertion_point(field_unsafe_arena_release:CMsgOverworldMinigameCustomData.survivors_data)
  if (_internal_has_survivors_data()) {
    clear_has_minigame_type();
    ::CMsgSurvivorsUserData* temp = _impl_.minigame_type_.survivors_data_;
    _impl_.minigame_type_.survivors_data_ = nullptr;
...
inline void CMsgOverworldMinigameCustomData::unsafe_arena_set_allocated_survivors_data(::CMsgSurvivorsUserData* survivors_data) {
  clear_minigame_type();
  if (survivors_data) {
    set_has_survivors_data();
    _impl_.minigame_type_.survivors_data_ = survivors_data;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:CMsgOverworldMinigameCustomData.survivors_data)
}
inline ::CMsgSurvivorsUserData* CMsgOverworldMinigameCustomData::_internal_mutable_survivors_data() {
  if (!_internal_has_survivors_data()) {
    clear_minigame_type();
    set_has_survivors_data();
    _impl_.minigame_type_.survivors_data_ = CreateMaybeMessage< ::CMsgSurvivorsUserData >(GetArenaForAllocation());
  }
  return _impl_.minigame_type_.survivors_data_;
}
inline ::CMsgSurvivorsUserData* CMsgOverworldMinigameCustomData::mutable_survivors_data() {
  ::CMsgSurvivorsUserData* _msg = _internal_mutable_survivors_data();
  // @@protoc_insertion_point(field_mutable:CMsgOverworldMinigameCustomData.survivors_data)
  return _msg;
}

inline bool CMsgOverworldMinigameCustomData::has_minigame_type() const {
  return minigame_type_case() != MINIGAME_TYPE_NOT_SET;
}
inline void CMsgOverworldMinigameCustomData::clear_has_minigame_type() {
  _impl_._oneof_case_[0] = MINIGAME_TYPE_NOT_SET;
}
inline CMsgOverworldMinigameCustomData::MinigameTypeCase CMsgOverworldMinigameCustomData::minigame_type_case() const {
  return CMsgOverworldMinigameCustomData::MinigameTypeCase(_impl_._oneof_case_[0]);
}
// -------------------------------------------------------------------
...
// optional uint32 node_id = 1;
inline bool CMsgOverworldMinigameUserData::_internal_has_node_id() const {
  bool value = (_impl_._has_bits_[0] & 0x00000002u) != 0;
  return value;
}
inline bool CMsgOverworldMinigameUserData::has_node_id() const {
  return _internal_has_node_id();
}
inline void CMsgOverworldMinigameUserData::clear_node_id() {
  _impl_.node_id_ = 0u;
  _impl_._has_bits_[0] &= ~0x00000002u;
}
inline uint32_t CMsgOverworldMinigameUserData::_internal_node_id() const {
  return _impl_.node_id_;
}
inline uint32_t CMsgOverworldMinigameUserData::node_id() const {
  // @@protoc_insertion_point(field_get:CMsgOverworldMinigameUserData.node_id)
  return _internal_node_id();
}
inline void CMsgOverworldMinigameUserData::_internal_set_node_id(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000002u;
  _impl_.node_id_ = value;
}
inline void CMsgOverworldMinigameUserData::set_node_id(uint32_t value) {
  _internal_set_node_id(value);
  // @@protoc_insertion_point(field_set:CMsgOverworldMinigameUserData.node_id)
}

// optional uint32 currency_amount = 2;
inline bool CMsgOverworldMinigameUserData::_internal_has_currency_amount() const {
  bool value = (_impl_._has_bits_[0] & 0x00000004u) != 0;
  return value;
}
inline bool CMsgOverworldMinigameUserData::has_currency_amount() const {
  return _internal_has_currency_amount();
}
inline void CMsgOverworldMinigameUserData::clear_currency_amount() {
  _impl_.currency_amount_ = 0u;
  _impl_._has_bits_[0] &= ~0x00000004u;
}
inline uint32_t CMsgOverworldMinigameUserData::_internal_currency_amount() const {
  return _impl_.currency_amount_;
}
inline uint32_t CMsgOverworldMinigameUserData::currency_amount() const {
  // @@protoc_insertion_point(field_get:CMsgOverworldMinigameUserData.currency_amount)
  return _internal_currency_amount();
}
inline void CMsgOverworldMinigameUserData::_internal_set_currency_amount(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000004u;
  _impl_.currency_amount_ = value;
}
inline void CMsgOverworldMinigameUserData::set_currency_amount(uint32_t value) {
  _internal_set_currency_amount(value);
  // @@protoc_insertion_point(field_set:CMsgOverworldMinigameUserData.currency_amount)
}

// optional .CMsgOverworldMinigameCustomData custom_data = 3;
inline bool CMsgOverworldMinigameUserData::_internal_has_custom_data() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  PROTOBUF_ASSUME(!value || _impl_.custom_data_ != nullptr);
  return value;
}
inline bool CMsgOverworldMinigameUserData::has_custom_data() const {
  return _internal_has_custom_data();
}
inline void CMsgOverworldMinigameUserData::clear_custom_data() {
  if (_impl_.custom_data_ != nullptr) _impl_.custom_data_->Clear();
  _impl_._has_bits_[0] &= ~0x00000001u;
}
inline const ::CMsgOverworldMinigameCustomData& CMsgOverworldMinigameUserData::_internal_custom_data() const {
  const ::CMsgOverworldMinigameCustomData* p = _impl_.custom_data_;
  return p != nullptr ? *p : reinterpret_cast<const ::CMsgOverworldMinigameCustomData&>(
      ::_CMsgOverworldMinigameCustomData_default_instance_);
}
inline const ::CMsgOverworldMinigameCustomData& CMsgOverworldMinigameUserData::custom_data() const {
  // @@protoc_insertion_point(field_get:CMsgOverworldMinigameUserData.custom_data)
  return _internal_custom_data();
}
inline void CMsgOverworldMinigameUserData::unsafe_arena_set_allocated_custom_data(
    ::CMsgOverworldMinigameCustomData* custom_data) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.custom_data_);
  }
  _impl_.custom_data_ = custom_data;
  if (custom_data) {
    _impl_._has_bits_[0] |= 0x00000001u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000001u;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:CMsgOverworldMinigameUserData.custom_data)
}
inline ::CMsgOverworldMinigameCustomData* CMsgOverworldMinigameUserData::release_custom_data() {
  _impl_._has_bits_[0] &= ~0x00000001u;
  ::CMsgOverworldMinigameCustomData* temp = _impl_.custom_data_;
  _impl_.custom_data_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  if (GetArenaForAllocation() == nullptr) { delete old; }
...
inline ::CMsgOverworldMinigameCustomData* CMsgOverworldMinigameUserData::unsafe_arena_release_custom_data() {
  // @@protoc_insertion_point(field_release:CMsgOverworldMinigameUserData.custom_data)
  _impl_._has_bits_[0] &= ~0x00000001u;
  ::CMsgOverworldMinigameCustomData* temp = _impl_.custom_data_;
  _impl_.custom_data_ = nullptr;
  return temp;
}
inline ::CMsgOverworldMinigameCustomData* CMsgOverworldMinigameUserData::_internal_mutable_custom_data() {
  _impl_._has_bits_[0] |= 0x00000001u;
  if (_impl_.custom_data_ == nullptr) {
    auto* p = CreateMaybeMessage<::CMsgOverworldMinigameCustomData>(GetArenaForAllocation());
    _impl_.custom_data_ = p;
  }
  return _impl_.custom_data_;
}
inline ::CMsgOverworldMinigameCustomData* CMsgOverworldMinigameUserData::mutable_custom_data() {
  ::CMsgOverworldMinigameCustomData* _msg = _internal_mutable_custom_data();
  // @@protoc_insertion_point(field_mutable:CMsgOverworldMinigameUserData.custom_data)
  return _msg;
}
inline void CMsgOverworldMinigameUserData::set_allocated_custom_data(::CMsgOverworldMinigameCustomData* custom_data) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.custom_data_;
  }
  if (custom_data) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(custom_data);
    if (message_arena != submessage_arena) {
  ...
  _impl_.custom_data_ = custom_data;
  // @@protoc_insertion_point(field_set_allocated:CMsgOverworldMinigameUserData.custom_data)
}
...
// optional uint32 key = 1;
inline bool CMsgOverworldUserData_MinigameDataEntry::_internal_has_key() const {
  bool value = (_impl_._has_bits_[0] & 0x00000002u) != 0;
  return value;
}
inline bool CMsgOverworldUserData_MinigameDataEntry::has_key() const {
  return _internal_has_key();
}
inline void CMsgOverworldUserData_MinigameDataEntry::clear_key() {
  _impl_.key_ = 0u;
  _impl_._has_bits_[0] &= ~0x00000002u;
}
inline uint32_t CMsgOverworldUserData_MinigameDataEntry::_internal_key() const {
  return _impl_.key_;
}
inline uint32_t CMsgOverworldUserData_MinigameDataEntry::key() const {
  // @@protoc_insertion_point(field_get:CMsgOverworldUserData.MinigameDataEntry.key)
  return _internal_key();
}
inline void CMsgOverworldUserData_MinigameDataEntry::_internal_set_key(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000002u;
  _impl_.key_ = value;
}
inline void CMsgOverworldUserData_MinigameDataEntry::set_key(uint32_t value) {
  _internal_set_key(value);
  // @@protoc_insertion_point(field_set:CMsgOverworldUserData.MinigameDataEntry.key)
}

// optional .CMsgOverworldMinigameUserData value = 2;
inline bool CMsgOverworldUserData_MinigameDataEntry::_internal_has_value() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  PROTOBUF_ASSUME(!value || _impl_.value_ != nullptr);
  return value;
}
inline bool CMsgOverworldUserData_MinigameDataEntry::has_value() const {
  return _internal_has_value();
}
inline void CMsgOverworldUserData_MinigameDataEntry::clear_value() {
  if (_impl_.value_ != nullptr) _impl_.value_->Clear();
  _impl_._has_bits_[0] &= ~0x00000001u;
}
inline const ::CMsgOverworldMinigameUserData& CMsgOverworldUserData_MinigameDataEntry::_internal_value() const {
  const ::CMsgOverworldMinigameUserData* p = _impl_.value_;
  return p != nullptr ? *p : reinterpret_cast<const ::CMsgOverworldMinigameUserData&>(
      ::_CMsgOverworldMinigameUserData_default_instance_);
}
inline const ::CMsgOverworldMinigameUserData& CMsgOverworldUserData_MinigameDataEntry::value() const {
  // @@protoc_insertion_point(field_get:CMsgOverworldUserData.MinigameDataEntry.value)
  return _internal_value();
}
inline void CMsgOverworldUserData_MinigameDataEntry::unsafe_arena_set_allocated_value(
    ::CMsgOverworldMinigameUserData* value) {
  if (GetArenaForAllocation() == nullptr) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:CMsgOverworldUserData.MinigameDataEntry.value)
}
inline ::CMsgOverworldMinigameUserData* CMsgOverworldUserData_MinigameDataEntry::release_value() {
  _impl_._has_bits_[0] &= ~0x00000001u;
  ::CMsgOverworldMinigameUserData* temp = _impl_.value_;
...
inline ::CMsgOverworldMinigameUserData* CMsgOverworldUserData_MinigameDataEntry::unsafe_arena_release_value() {
  // @@protoc_insertion_point(field_release:CMsgOverworldUserData.MinigameDataEntry.value)
  _impl_._has_bits_[0] &= ~0x00000001u;
  ::CMsgOverworldMinigameUserData* temp = _impl_.value_;
  _impl_.value_ = nullptr;
  return temp;
}
inline ::CMsgOverworldMinigameUserData* CMsgOverworldUserData_MinigameDataEntry::_internal_mutable_value() {
  _impl_._has_bits_[0] |= 0x00000001u;
  if (_impl_.value_ == nullptr) {
    auto* p = CreateMaybeMessage<::CMsgOverworldMinigameUserData>(GetArenaForAllocation());
    _impl_.value_ = p;
  }
  return _impl_.value_;
}
inline ::CMsgOverworldMinigameUserData* CMsgOverworldUserData_MinigameDataEntry::mutable_value() {
  ::CMsgOverworldMinigameUserData* _msg = _internal_mutable_value();
  // @@protoc_insertion_point(field_mutable:CMsgOverworldUserData.MinigameDataEntry.value)
  return _msg;
}
inline void CMsgOverworldUserData_MinigameDataEntry::set_allocated_value(::CMsgOverworldMinigameUserData* value) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
  ...
  _impl_.value_ = value;
  // @@protoc_insertion_point(field_set_allocated:CMsgOverworldUserData.MinigameDataEntry.value)
}
...
// repeated .CMsgOverworldUserData.MinigameDataEntry minigame_data = 5;
inline int CMsgOverworldUserData::_internal_minigame_data_size() const {
  return _impl_.minigame_data_.size();
}
inline int CMsgOverworldUserData::minigame_data_size() const {
  return _internal_minigame_data_size();
}
inline void CMsgOverworldUserData::clear_minigame_data() {
  _impl_.minigame_data_.Clear();
}
inline ::CMsgOverworldUserData_MinigameDataEntry* CMsgOverworldUserData::mutable_minigame_data(int index) {
  // @@protoc_insertion_point(field_mutable:CMsgOverworldUserData.minigame_data)
  return _impl_.minigame_data_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CMsgOverworldUserData_MinigameDataEntry >*
CMsgOverworldUserData::mutable_minigame_data() {
  // @@protoc_insertion_point(field_mutable_list:CMsgOverworldUserData.minigame_data)
  return &_impl_.minigame_data_;
}
inline const ::CMsgOverworldUserData_MinigameDataEntry& CMsgOverworldUserData::_internal_minigame_data(int index) const {
  return _impl_.minigame_data_.Get(index);
}
inline const ::CMsgOverworldUserData_MinigameDataEntry& CMsgOverworldUserData::minigame_data(int index) const {
  // @@protoc_insertion_point(field_get:CMsgOverworldUserData.minigame_data)
  return _internal_minigame_data(index);
}
inline ::CMsgOverworldUserData_MinigameDataEntry* CMsgOverworldUserData::_internal_add_minigame_data() {
  return _impl_.minigame_data_.Add();
}
inline ::CMsgOverworldUserData_MinigameDataEntry* CMsgOverworldUserData::add_minigame_data() {
  ::CMsgOverworldUserData_MinigameDataEntry* _add = _internal_add_minigame_data();
  // @@protoc_insertion_point(field_add:CMsgOverworldUserData.minigame_data)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CMsgOverworldUserData_MinigameDataEntry >&
...
// optional uint32 leaderboard_data = 6;
inline bool CMsgClientToGCOverworldClaimEncounterReward::_internal_has_leaderboard_data() const {
  bool value = (_impl_._has_bits_[0] & 0x00000020u) != 0;
  return value;
}
inline bool CMsgClientToGCOverworldClaimEncounterReward::has_leaderboard_data() const {
  return _internal_has_leaderboard_data();
}
inline void CMsgClientToGCOverworldClaimEncounterReward::clear_leaderboard_data() {
  _impl_.leaderboard_data_ = 0u;
  _impl_._has_bits_[0] &= ~0x00000020u;
}
inline uint32_t CMsgClientToGCOverworldClaimEncounterReward::_internal_leaderboard_data() const {
  return _impl_.leaderboard_data_;
}
inline uint32_t CMsgClientToGCOverworldClaimEncounterReward::leaderboard_data() const {
  // @@protoc_insertion_point(field_get:CMsgClientToGCOverworldClaimEncounterReward.leaderboard_data)
  return _internal_leaderboard_data();
}
inline void CMsgClientToGCOverworldClaimEncounterReward::_internal_set_leaderboard_data(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000020u;
  _impl_.leaderboard_data_ = value;
}
inline void CMsgClientToGCOverworldClaimEncounterReward::set_leaderboard_data(uint32_t value) {
  _internal_set_leaderboard_data(value);
  // @@protoc_insertion_point(field_set:CMsgClientToGCOverworldClaimEncounterReward.leaderboard_data)
}

// optional uint32 leaderboard_index = 7;
inline bool CMsgClientToGCOverworldClaimEncounterReward::_internal_has_leaderboard_index() const {
  bool value = (_impl_._has_bits_[0] & 0x00000040u) != 0;
  return value;
}
inline bool CMsgClientToGCOverworldClaimEncounterReward::has_leaderboard_index() const {
  return _internal_has_leaderboard_index();
}
inline void CMsgClientToGCOverworldClaimEncounterReward::clear_leaderboard_index() {
  _impl_.leaderboard_index_ = 0u;
  _impl_._has_bits_[0] &= ~0x00000040u;
}
inline uint32_t CMsgClientToGCOverworldClaimEncounterReward::_internal_leaderboard_index() const {
  return _impl_.leaderboard_index_;
}
inline uint32_t CMsgClientToGCOverworldClaimEncounterReward::leaderboard_index() const {
  // @@protoc_insertion_point(field_get:CMsgClientToGCOverworldClaimEncounterReward.leaderboard_index)
  return _internal_leaderboard_index();
}
inline void CMsgClientToGCOverworldClaimEncounterReward::_internal_set_leaderboard_index(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000040u;
  _impl_.leaderboard_index_ = value;
}
inline void CMsgClientToGCOverworldClaimEncounterReward::set_leaderboard_index(uint32_t value) {
  _internal_set_leaderboard_index(value);
  // @@protoc_insertion_point(field_set:CMsgClientToGCOverworldClaimEncounterReward.leaderboard_index)
}

// optional bool should_claim_reward = 8;
inline bool CMsgClientToGCOverworldClaimEncounterReward::_internal_has_should_claim_reward() const {
  bool value = (_impl_._has_bits_[0] & 0x00000080u) != 0;
  return value;
}
inline bool CMsgClientToGCOverworldClaimEncounterReward::has_should_claim_reward() const {
  return _internal_has_should_claim_reward();
}
inline void CMsgClientToGCOverworldClaimEncounterReward::clear_should_claim_reward() {
  _impl_.should_claim_reward_ = false;
  _impl_._has_bits_[0] &= ~0x00000080u;
}
inline bool CMsgClientToGCOverworldClaimEncounterReward::_internal_should_claim_reward() const {
  return _impl_.should_claim_reward_;
}
inline bool CMsgClientToGCOverworldClaimEncounterReward::should_claim_reward() const {
  // @@protoc_insertion_point(field_get:CMsgClientToGCOverworldClaimEncounterReward.should_claim_reward)
  return _internal_should_claim_reward();
}
inline void CMsgClientToGCOverworldClaimEncounterReward::_internal_set_should_claim_reward(bool value) {
  _impl_._has_bits_[0] |= 0x00000080u;
  _impl_.should_claim_reward_ = value;
}
inline void CMsgClientToGCOverworldClaimEncounterReward::set_should_claim_reward(bool value) {
  _internal_set_should_claim_reward(value);
  // @@protoc_insertion_point(field_set:CMsgClientToGCOverworldClaimEncounterReward.should_claim_reward)
}
...
// optional uint32 friend_account_id = 1;
inline bool CMsgClientToGCOverworldRequestTokensNeededByFriend::_internal_has_friend_account_id() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline bool CMsgClientToGCOverworldRequestTokensNeededByFriend::has_friend_account_id() const {
  return _internal_has_friend_account_id();
}
inline void CMsgClientToGCOverworldRequestTokensNeededByFriend::clear_friend_account_id() {
  _impl_.friend_account_id_ = 0u;
  _impl_._has_bits_[0] &= ~0x00000001u;
}
inline uint32_t CMsgClientToGCOverworldRequestTokensNeededByFriend::_internal_friend_account_id() const {
  return _impl_.friend_account_id_;
}
inline uint32_t CMsgClientToGCOverworldRequestTokensNeededByFriend::friend_account_id() const {
  // @@protoc_insertion_point(field_get:CMsgClientToGCOverworldRequestTokensNeededByFriend.friend_account_id)
  return _internal_friend_account_id();
}
inline void CMsgClientToGCOverworldRequestTokensNeededByFriend::_internal_set_friend_account_id(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.friend_account_id_ = value;
}
inline void CMsgClientToGCOverworldRequestTokensNeededByFriend::set_friend_account_id(uint32_t value) {
  _internal_set_friend_account_id(value);
  // @@protoc_insertion_point(field_set:CMsgClientToGCOverworldRequestTokensNeededByFriend.friend_account_id)
}

// optional uint32 overworld_id = 2;
inline bool CMsgClientToGCOverworldRequestTokensNeededByFriend::_internal_has_overworld_id() const {
  bool value = (_impl_._has_bits_[0] & 0x00000002u) != 0;
  return value;
}
inline bool CMsgClientToGCOverworldRequestTokensNeededByFriend::has_overworld_id() const {
  return _internal_has_overworld_id();
}
inline void CMsgClientToGCOverworldRequestTokensNeededByFriend::clear_overworld_id() {
  _impl_.overworld_id_ = 0u;
  _impl_._has_bits_[0] &= ~0x00000002u;
}
inline uint32_t CMsgClientToGCOverworldRequestTokensNeededByFriend::_internal_overworld_id() const {
  return _impl_.overworld_id_;
}
inline uint32_t CMsgClientToGCOverworldRequestTokensNeededByFriend::overworld_id() const {
  // @@protoc_insertion_point(field_get:CMsgClientToGCOverworldRequestTokensNeededByFriend.overworld_id)
  return _internal_overworld_id();
}
inline void CMsgClientToGCOverworldRequestTokensNeededByFriend::_internal_set_overworld_id(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000002u;
  _impl_.overworld_id_ = value;
}
inline void CMsgClientToGCOverworldRequestTokensNeededByFriend::set_overworld_id(uint32_t value) {
  _internal_set_overworld_id(value);
  // @@protoc_insertion_point(field_set:CMsgClientToGCOverworldRequestTokensNeededByFriend.overworld_id)
}
...
// optional .CMsgClientToGCOverworldRequestTokensNeededByFriendResponse.EResponse response = 1 [default = k_eInternalError];
inline bool CMsgClientToGCOverworldRequestTokensNeededByFriendResponse::_internal_has_response() const {
  bool value = (_impl_._has_bits_[0] & 0x00000002u) != 0;
  return value;
}
inline bool CMsgClientToGCOverworldRequestTokensNeededByFriendResponse::has_response() const {
  return _internal_has_response();
}
inline void CMsgClientToGCOverworldRequestTokensNeededByFriendResponse::clear_response() {
  _impl_.response_ = 0;
  _impl_._has_bits_[0] &= ~0x00000002u;
}
inline ::CMsgClientToGCOverworldRequestTokensNeededByFriendResponse_EResponse CMsgClientToGCOverworldRequestTokensNeededByFriendResponse::_internal_response() const {
  return static_cast< ::CMsgClientToGCOverworldRequestTokensNeededByFriendResponse_EResponse >(_impl_.response_);
}
inline ::CMsgClientToGCOverworldRequestTokensNeededByFriendResponse_EResponse CMsgClientToGCOverworldRequestTokensNeededByFriendResponse::response() const {
  // @@protoc_insertion_point(field_get:CMsgClientToGCOverworldRequestTokensNeededByFriendResponse.response)
  return _internal_response();
}
inline void CMsgClientToGCOverworldRequestTokensNeededByFriendResponse::_internal_set_response(::CMsgClientToGCOverworldRequestTokensNeededByFriendResponse_EResponse value) {
  assert(::CMsgClientToGCOverworldRequestTokensNeededByFriendResponse_EResponse_IsValid(value));
  _impl_._has_bits_[0] |= 0x00000002u;
  _impl_.response_ = value;
}
inline void CMsgClientToGCOverworldRequestTokensNeededByFriendResponse::set_response(::CMsgClientToGCOverworldRequestTokensNeededByFriendResponse_EResponse value) {
  _internal_set_response(value);
  // @@protoc_insertion_point(field_set:CMsgClientToGCOverworldRequestTokensNeededByFriendResponse.response)
}

// optional .CMsgOverworldTokenQuantity token_quantity = 2;
inline bool CMsgClientToGCOverworldRequestTokensNeededByFriendResponse::_internal_has_token_quantity() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  PROTOBUF_ASSUME(!value || _impl_.token_quantity_ != nullptr);
  return value;
}
inline bool CMsgClientToGCOverworldRequestTokensNeededByFriendResponse::has_token_quantity() const {
  return _internal_has_token_quantity();
}
inline void CMsgClientToGCOverworldRequestTokensNeededByFriendResponse::clear_token_quantity() {
  if (_impl_.token_quantity_ != nullptr) _impl_.token_quantity_->Clear();
  _impl_._has_bits_[0] &= ~0x00000001u;
}
inline const ::CMsgOverworldTokenQuantity& CMsgClientToGCOverworldRequestTokensNeededByFriendResponse::_internal_token_quantity() const {
  const ::CMsgOverworldTokenQuantity* p = _impl_.token_quantity_;
  return p != nullptr ? *p : reinterpret_cast<const ::CMsgOverworldTokenQuantity&>(
      ::_CMsgOverworldTokenQuantity_default_instance_);
}
inline const ::CMsgOverworldTokenQuantity& CMsgClientToGCOverworldRequestTokensNeededByFriendResponse::token_quantity() const {
  // @@protoc_insertion_point(field_get:CMsgClientToGCOverworldRequestTokensNeededByFriendResponse.token_quantity)
  return _internal_token_quantity();
}
inline void CMsgClientToGCOverworldRequestTokensNeededByFriendResponse::unsafe_arena_set_allocated_token_quantity(
    ::CMsgOverworldTokenQuantity* token_quantity) {
  if (GetArenaForAllocation() == nullptr) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:CMsgClientToGCOverworldRequestTokensNeededByFriendResponse.token_quantity)
}
inline ::CMsgOverworldTokenQuantity* CMsgClientToGCOverworldRequestTokensNeededByFriendResponse::release_token_quantity() {
  _impl_._has_bits_[0] &= ~0x00000001u;
...
inline ::CMsgOverworldTokenQuantity* CMsgClientToGCOverworldRequestTokensNeededByFriendResponse::unsafe_arena_release_token_quantity() {
  // @@protoc_insertion_point(field_release:CMsgClientToGCOverworldRequestTokensNeededByFriendResponse.token_quantity)
  _impl_._has_bits_[0] &= ~0x00000001u;
  ::CMsgOverworldTokenQuantity* temp = _impl_.token_quantity_;
  _impl_.token_quantity_ = nullptr;
  return temp;
}
inline ::CMsgOverworldTokenQuantity* CMsgClientToGCOverworldRequestTokensNeededByFriendResponse::_internal_mutable_token_quantity() {
  _impl_._has_bits_[0] |= 0x00000001u;
...
inline ::CMsgOverworldTokenQuantity* CMsgClientToGCOverworldRequestTokensNeededByFriendResponse::mutable_token_quantity() {
  ::CMsgOverworldTokenQuantity* _msg = _internal_mutable_token_quantity();
  // @@protoc_insertion_point(field_mutable:CMsgClientToGCOverworldRequestTokensNeededByFriendResponse.token_quantity)
  return _msg;
}
inline void CMsgClientToGCOverworldRequestTokensNeededByFriendResponse::set_allocated_token_quantity(::CMsgOverworldTokenQuantity* token_quantity) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
  ...
  _impl_.token_quantity_ = token_quantity;
  // @@protoc_insertion_point(field_set_allocated:CMsgClientToGCOverworldRequestTokensNeededByFriendResponse.token_quantity)
}
...
// optional uint32 overworld_id = 1;
inline bool CMsgClientToGCOverworldMinigameAction::_internal_has_overworld_id() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline bool CMsgClientToGCOverworldMinigameAction::has_overworld_id() const {
  return _internal_has_overworld_id();
}
inline void CMsgClientToGCOverworldMinigameAction::clear_overworld_id() {
  _impl_.overworld_id_ = 0u;
  _impl_._has_bits_[0] &= ~0x00000001u;
}
inline uint32_t CMsgClientToGCOverworldMinigameAction::_internal_overworld_id() const {
  return _impl_.overworld_id_;
}
inline uint32_t CMsgClientToGCOverworldMinigameAction::overworld_id() const {
  // @@protoc_insertion_point(field_get:CMsgClientToGCOverworldMinigameAction.overworld_id)
  return _internal_overworld_id();
}
inline void CMsgClientToGCOverworldMinigameAction::_internal_set_overworld_id(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.overworld_id_ = value;
}
inline void CMsgClientToGCOverworldMinigameAction::set_overworld_id(uint32_t value) {
  _internal_set_overworld_id(value);
  // @@protoc_insertion_point(field_set:CMsgClientToGCOverworldMinigameAction.overworld_id)
}

// optional uint32 node_id = 2;
inline bool CMsgClientToGCOverworldMinigameAction::_internal_has_node_id() const {
  bool value = (_impl_._has_bits_[0] & 0x00000002u) != 0;
  return value;
}
inline bool CMsgClientToGCOverworldMinigameAction::has_node_id() const {
  return _internal_has_node_id();
}
inline void CMsgClientToGCOverworldMinigameAction::clear_node_id() {
  _impl_.node_id_ = 0u;
  _impl_._has_bits_[0] &= ~0x00000002u;
}
inline uint32_t CMsgClientToGCOverworldMinigameAction::_internal_node_id() const {
  return _impl_.node_id_;
}
inline uint32_t CMsgClientToGCOverworldMinigameAction::node_id() const {
  // @@protoc_insertion_point(field_get:CMsgClientToGCOverworldMinigameAction.node_id)
  return _internal_node_id();
}
inline void CMsgClientToGCOverworldMinigameAction::_internal_set_node_id(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000002u;
  _impl_.node_id_ = value;
}
inline void CMsgClientToGCOverworldMinigameAction::set_node_id(uint32_t value) {
  _internal_set_node_id(value);
  // @@protoc_insertion_point(field_set:CMsgClientToGCOverworldMinigameAction.node_id)
}

// optional .EOverworldMinigameAction action = 3 [default = k_eOverworldMinigameAction_Invalid];
inline bool CMsgClientToGCOverworldMinigameAction::_internal_has_action() const {
  bool value = (_impl_._has_bits_[0] & 0x00000004u) != 0;
  return value;
}
inline bool CMsgClientToGCOverworldMinigameAction::has_action() const {
  return _internal_has_action();
}
inline void CMsgClientToGCOverworldMinigameAction::clear_action() {
  _impl_.action_ = 0;
  _impl_._has_bits_[0] &= ~0x00000004u;
}
inline ::EOverworldMinigameAction CMsgClientToGCOverworldMinigameAction::_internal_action() const {
  return static_cast< ::EOverworldMinigameAction >(_impl_.action_);
}
inline ::EOverworldMinigameAction CMsgClientToGCOverworldMinigameAction::action() const {
  // @@protoc_insertion_point(field_get:CMsgClientToGCOverworldMinigameAction.action)
  return _internal_action();
}
inline void CMsgClientToGCOverworldMinigameAction::_internal_set_action(::EOverworldMinigameAction value) {
  assert(::EOverworldMinigameAction_IsValid(value));
  _impl_._has_bits_[0] |= 0x00000004u;
  _impl_.action_ = value;
}
inline void CMsgClientToGCOverworldMinigameAction::set_action(::EOverworldMinigameAction value) {
  _internal_set_action(value);
  // @@protoc_insertion_point(field_set:CMsgClientToGCOverworldMinigameAction.action)
}

// optional uint32 selection = 4;
inline bool CMsgClientToGCOverworldMinigameAction::_internal_has_selection() const {
  bool value = (_impl_._has_bits_[0] & 0x00000008u) != 0;
  return value;
}
inline bool CMsgClientToGCOverworldMinigameAction::has_selection() const {
  return _internal_has_selection();
}
inline void CMsgClientToGCOverworldMinigameAction::clear_selection() {
  _impl_.selection_ = 0u;
  _impl_._has_bits_[0] &= ~0x00000008u;
}
inline uint32_t CMsgClientToGCOverworldMinigameAction::_internal_selection() const {
  return _impl_.selection_;
}
inline uint32_t CMsgClientToGCOverworldMinigameAction::selection() const {
  // @@protoc_insertion_point(field_get:CMsgClientToGCOverworldMinigameAction.selection)
  return _internal_selection();
}
inline void CMsgClientToGCOverworldMinigameAction::_internal_set_selection(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000008u;
  _impl_.selection_ = value;
}
inline void CMsgClientToGCOverworldMinigameAction::set_selection(uint32_t value) {
  _internal_set_selection(value);
  // @@protoc_insertion_point(field_set:CMsgClientToGCOverworldMinigameAction.selection)
}

// optional uint32 option_value = 5;
inline bool CMsgClientToGCOverworldMinigameAction::_internal_has_option_value() const {
  bool value = (_impl_._has_bits_[0] & 0x00000010u) != 0;
  return value;
}
inline bool CMsgClientToGCOverworldMinigameAction::has_option_value() const {
  return _internal_has_option_value();
}
inline void CMsgClientToGCOverworldMinigameAction::clear_option_value() {
  _impl_.option_value_ = 0u;
  _impl_._has_bits_[0] &= ~0x00000010u;
}
inline uint32_t CMsgClientToGCOverworldMinigameAction::_internal_option_value() const {
  return _impl_.option_value_;
}
inline uint32_t CMsgClientToGCOverworldMinigameAction::option_value() const {
  // @@protoc_insertion_point(field_get:CMsgClientToGCOverworldMinigameAction.option_value)
  return _internal_option_value();
}
inline void CMsgClientToGCOverworldMinigameAction::_internal_set_option_value(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000010u;
  _impl_.option_value_ = value;
}
inline void CMsgClientToGCOverworldMinigameAction::set_option_value(uint32_t value) {
  _internal_set_option_value(value);
  // @@protoc_insertion_point(field_set:CMsgClientToGCOverworldMinigameAction.option_value)
}

// optional uint32 currency_amount = 6;
inline bool CMsgClientToGCOverworldMinigameAction::_internal_has_currency_amount() const {
  bool value = (_impl_._has_bits_[0] & 0x00000020u) != 0;
  return value;
}
inline bool CMsgClientToGCOverworldMinigameAction::has_currency_amount() const {
  return _internal_has_currency_amount();
}
inline void CMsgClientToGCOverworldMinigameAction::clear_currency_amount() {
  _impl_.currency_amount_ = 0u;
  _impl_._has_bits_[0] &= ~0x00000020u;
}
inline uint32_t CMsgClientToGCOverworldMinigameAction::_internal_currency_amount() const {
  return _impl_.currency_amount_;
}
inline uint32_t CMsgClientToGCOverworldMinigameAction::currency_amount() const {
  // @@protoc_insertion_point(field_get:CMsgClientToGCOverworldMinigameAction.currency_amount)
  return _internal_currency_amount();
}
inline void CMsgClientToGCOverworldMinigameAction::_internal_set_currency_amount(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000020u;
  _impl_.currency_amount_ = value;
}
inline void CMsgClientToGCOverworldMinigameAction::set_currency_amount(uint32_t value) {
  _internal_set_currency_amount(value);
  // @@protoc_insertion_point(field_set:CMsgClientToGCOverworldMinigameAction.currency_amount)
}
...
// optional .CMsgClientToGCOverworldMinigameActionResponse.EResponse response = 1 [default = k_eInternalError];
inline bool CMsgClientToGCOverworldMinigameActionResponse::_internal_has_response() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline bool CMsgClientToGCOverworldMinigameActionResponse::has_response() const {
  return _internal_has_response();
}
inline void CMsgClientToGCOverworldMinigameActionResponse::clear_response() {
  _impl_.response_ = 0;
  _impl_._has_bits_[0] &= ~0x00000001u;
}
inline ::CMsgClientToGCOverworldMinigameActionResponse_EResponse CMsgClientToGCOverworldMinigameActionResponse::_internal_response() const {
  return static_cast< ::CMsgClientToGCOverworldMinigameActionResponse_EResponse >(_impl_.response_);
}
inline ::CMsgClientToGCOverworldMinigameActionResponse_EResponse CMsgClientToGCOverworldMinigameActionResponse::response() const {
  // @@protoc_insertion_point(field_get:CMsgClientToGCOverworldMinigameActionResponse.response)
  return _internal_response();
}
inline void CMsgClientToGCOverworldMinigameActionResponse::_internal_set_response(::CMsgClientToGCOverworldMinigameActionResponse_EResponse value) {
  assert(::CMsgClientToGCOverworldMinigameActionResponse_EResponse_IsValid(value));
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.response_ = value;
}
inline void CMsgClientToGCOverworldMinigameActionResponse::set_response(::CMsgClientToGCOverworldMinigameActionResponse_EResponse value) {
  _internal_set_response(value);
  // @@protoc_insertion_point(field_set:CMsgClientToGCOverworldMinigameActionResponse.response)
}
...
template <> struct is_proto_enum< ::CMsgClientToGCOverworldRequestTokensNeededByFriendResponse_EResponse> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::CMsgClientToGCOverworldRequestTokensNeededByFriendResponse_EResponse>() {
  return ::CMsgClientToGCOverworldRequestTokensNeededByFriendResponse_EResponse_descriptor();
}
...
template <> struct is_proto_enum< ::CMsgClientToGCOverworldMinigameActionResponse_EResponse> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::CMsgClientToGCOverworldMinigameActionResponse_EResponse>() {
  return ::CMsgClientToGCOverworldMinigameActionResponse_EResponse_descriptor();
}
...
template <> struct is_proto_enum< ::EOverworldPathState> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::EOverworldPathState>() {
  return ::EOverworldPathState_descriptor();
}
...
template <> struct is_proto_enum< ::EOverworldMinigameAction> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::EOverworldMinigameAction>() {
  return ::EOverworldMinigameAction_descriptor();
}
