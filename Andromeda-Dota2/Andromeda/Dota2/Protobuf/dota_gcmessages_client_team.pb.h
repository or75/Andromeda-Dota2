...
class CMsgDOTATeamInfoCache;
struct CMsgDOTATeamInfoCacheDefaultTypeInternal;
extern CMsgDOTATeamInfoCacheDefaultTypeInternal _CMsgDOTATeamInfoCache_default_instance_;
...
template<> ::CMsgDOTATeamInfoCache* Arena::CreateMaybeMessage<::CMsgDOTATeamInfoCache>(Arena*);
...
class CMsgDOTATeamInfoCache final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:CMsgDOTATeamInfoCache) */ {
 public:
  inline CMsgDOTATeamInfoCache() : CMsgDOTATeamInfoCache(nullptr) {}
  ~CMsgDOTATeamInfoCache() override;
  explicit PROTOBUF_CONSTEXPR CMsgDOTATeamInfoCache(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  CMsgDOTATeamInfoCache(const CMsgDOTATeamInfoCache& from);
  CMsgDOTATeamInfoCache(CMsgDOTATeamInfoCache&& from) noexcept
    : CMsgDOTATeamInfoCache() {
    *this = ::std::move(from);
  }

  inline CMsgDOTATeamInfoCache& operator=(const CMsgDOTATeamInfoCache& from) {
    CopyFrom(from);
    return *this;
  }
  inline CMsgDOTATeamInfoCache& operator=(CMsgDOTATeamInfoCache&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const CMsgDOTATeamInfoCache& default_instance() {
    return *internal_default_instance();
  }
  static inline const CMsgDOTATeamInfoCache* internal_default_instance() {
    return reinterpret_cast<const CMsgDOTATeamInfoCache*>(
               &_CMsgDOTATeamInfoCache_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    9;

  friend void swap(CMsgDOTATeamInfoCache& a, CMsgDOTATeamInfoCache& b) {
    a.Swap(&b);
  }
  inline void Swap(CMsgDOTATeamInfoCache* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(CMsgDOTATeamInfoCache* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  CMsgDOTATeamInfoCache* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<CMsgDOTATeamInfoCache>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const CMsgDOTATeamInfoCache& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const CMsgDOTATeamInfoCache& from) {
    CMsgDOTATeamInfoCache::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(CMsgDOTATeamInfoCache* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "CMsgDOTATeamInfoCache";
  }
  protected:
  explicit CMsgDOTATeamInfoCache(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  enum : int {
    ...
    kCacheTimestampFieldNumber = 1,
  };
  // optional .CMsgDOTATeamInfoList team_list = 2;
  bool has_team_list() const;
  private:
  bool _internal_has_team_list() const;
  public:
  void clear_team_list();
  const ::CMsgDOTATeamInfoList& team_list() const;
  PROTOBUF_NODISCARD ::CMsgDOTATeamInfoList* release_team_list();
  ::CMsgDOTATeamInfoList* mutable_team_list();
  void set_allocated_team_list(::CMsgDOTATeamInfoList* team_list);
  private:
  const ::CMsgDOTATeamInfoList& _internal_team_list() const;
  ::CMsgDOTATeamInfoList* _internal_mutable_team_list();
  public:
  void unsafe_arena_set_allocated_team_list(
      ::CMsgDOTATeamInfoList* team_list);
  ::CMsgDOTATeamInfoList* unsafe_arena_release_team_list();

  // optional uint32 cache_timestamp = 1;
  bool has_cache_timestamp() const;
  private:
  bool _internal_has_cache_timestamp() const;
  public:
  void clear_cache_timestamp();
  uint32_t cache_timestamp() const;
  void set_cache_timestamp(uint32_t value);
  private:
  uint32_t _internal_cache_timestamp() const;
  void _internal_set_cache_timestamp(uint32_t value);
  public:

  // @@protoc_insertion_point(class_scope:CMsgDOTATeamInfoCache)
 private:
  class _Internal;
  ...
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::internal::HasBits<1> _has_bits_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
    ::CMsgDOTATeamInfoList* team_list_;
    uint32_t cache_timestamp_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_dota_5fgcmessages_5fclient_5fteam_2eproto;
};
...
// optional uint32 cache_timestamp = 1;
inline bool CMsgDOTATeamInfoCache::_internal_has_cache_timestamp() const {
  bool value = (_impl_._has_bits_[0] & 0x00000002u) != 0;
  return value;
}
inline bool CMsgDOTATeamInfoCache::has_cache_timestamp() const {
  return _internal_has_cache_timestamp();
}
inline void CMsgDOTATeamInfoCache::clear_cache_timestamp() {
  _impl_.cache_timestamp_ = 0u;
  _impl_._has_bits_[0] &= ~0x00000002u;
}
inline uint32_t CMsgDOTATeamInfoCache::_internal_cache_timestamp() const {
  return _impl_.cache_timestamp_;
}
inline uint32_t CMsgDOTATeamInfoCache::cache_timestamp() const {
  // @@protoc_insertion_point(field_get:CMsgDOTATeamInfoCache.cache_timestamp)
  return _internal_cache_timestamp();
}
inline void CMsgDOTATeamInfoCache::_internal_set_cache_timestamp(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000002u;
  _impl_.cache_timestamp_ = value;
}
inline void CMsgDOTATeamInfoCache::set_cache_timestamp(uint32_t value) {
  _internal_set_cache_timestamp(value);
  // @@protoc_insertion_point(field_set:CMsgDOTATeamInfoCache.cache_timestamp)
}

// optional .CMsgDOTATeamInfoList team_list = 2;
inline bool CMsgDOTATeamInfoCache::_internal_has_team_list() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  PROTOBUF_ASSUME(!value || _impl_.team_list_ != nullptr);
  return value;
}
inline bool CMsgDOTATeamInfoCache::has_team_list() const {
  return _internal_has_team_list();
}
inline void CMsgDOTATeamInfoCache::clear_team_list() {
  if (_impl_.team_list_ != nullptr) _impl_.team_list_->Clear();
  _impl_._has_bits_[0] &= ~0x00000001u;
}
inline const ::CMsgDOTATeamInfoList& CMsgDOTATeamInfoCache::_internal_team_list() const {
  const ::CMsgDOTATeamInfoList* p = _impl_.team_list_;
  return p != nullptr ? *p : reinterpret_cast<const ::CMsgDOTATeamInfoList&>(
      ::_CMsgDOTATeamInfoList_default_instance_);
}
inline const ::CMsgDOTATeamInfoList& CMsgDOTATeamInfoCache::team_list() const {
  // @@protoc_insertion_point(field_get:CMsgDOTATeamInfoCache.team_list)
  return _internal_team_list();
}
inline void CMsgDOTATeamInfoCache::unsafe_arena_set_allocated_team_list(
    ::CMsgDOTATeamInfoList* team_list) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.team_list_);
  }
  _impl_.team_list_ = team_list;
  if (team_list) {
    _impl_._has_bits_[0] |= 0x00000001u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000001u;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:CMsgDOTATeamInfoCache.team_list)
}
inline ::CMsgDOTATeamInfoList* CMsgDOTATeamInfoCache::release_team_list() {
  _impl_._has_bits_[0] &= ~0x00000001u;
  ::CMsgDOTATeamInfoList* temp = _impl_.team_list_;
  _impl_.team_list_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  if (GetArenaForAllocation() == nullptr) { delete old; }
...
inline ::CMsgDOTATeamInfoList* CMsgDOTATeamInfoCache::unsafe_arena_release_team_list() {
  // @@protoc_insertion_point(field_release:CMsgDOTATeamInfoCache.team_list)
  _impl_._has_bits_[0] &= ~0x00000001u;
  ::CMsgDOTATeamInfoList* temp = _impl_.team_list_;
  _impl_.team_list_ = nullptr;
  return temp;
}
inline ::CMsgDOTATeamInfoList* CMsgDOTATeamInfoCache::_internal_mutable_team_list() {
  _impl_._has_bits_[0] |= 0x00000001u;
  if (_impl_.team_list_ == nullptr) {
    auto* p = CreateMaybeMessage<::CMsgDOTATeamInfoList>(GetArenaForAllocation());
    _impl_.team_list_ = p;
  }
  return _impl_.team_list_;
}
inline ::CMsgDOTATeamInfoList* CMsgDOTATeamInfoCache::mutable_team_list() {
  ::CMsgDOTATeamInfoList* _msg = _internal_mutable_team_list();
  // @@protoc_insertion_point(field_mutable:CMsgDOTATeamInfoCache.team_list)
  return _msg;
}
inline void CMsgDOTATeamInfoCache::set_allocated_team_list(::CMsgDOTATeamInfoList* team_list) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.team_list_;
  }
  if (team_list) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(team_list);
    if (message_arena != submessage_arena) {
      team_list = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, team_list, submessage_arena);
    }
    _impl_._has_bits_[0] |= 0x00000001u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000001u;
  ...
  _impl_.team_list_ = team_list;
  // @@protoc_insertion_point(field_set_allocated:CMsgDOTATeamInfoCache.team_list)
}
