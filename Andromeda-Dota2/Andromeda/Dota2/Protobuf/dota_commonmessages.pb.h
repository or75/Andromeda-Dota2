...
class CDOTAMsg_PingWaypointPath;
struct CDOTAMsg_PingWaypointPathDefaultTypeInternal;
extern CDOTAMsg_PingWaypointPathDefaultTypeInternal _CDOTAMsg_PingWaypointPath_default_instance_;
...
template<> ::CDOTAMsg_PingWaypointPath* Arena::CreateMaybeMessage<::CDOTAMsg_PingWaypointPath>(Arena*);
...
constexpr dotaunitorder_t dotaunitorder_t_MAX = DOTA_UNIT_ORDER_SET_ITEM_MARK_FOR_SELL;
...
class CDOTAMsg_PingWaypointPath final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:CDOTAMsg_PingWaypointPath) */ {
 public:
  inline CDOTAMsg_PingWaypointPath() : CDOTAMsg_PingWaypointPath(nullptr) {}
  ~CDOTAMsg_PingWaypointPath() override;
  explicit PROTOBUF_CONSTEXPR CDOTAMsg_PingWaypointPath(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  CDOTAMsg_PingWaypointPath(const CDOTAMsg_PingWaypointPath& from);
  CDOTAMsg_PingWaypointPath(CDOTAMsg_PingWaypointPath&& from) noexcept
    : CDOTAMsg_PingWaypointPath() {
    *this = ::std::move(from);
  }

  inline CDOTAMsg_PingWaypointPath& operator=(const CDOTAMsg_PingWaypointPath& from) {
    CopyFrom(from);
    return *this;
  }
  inline CDOTAMsg_PingWaypointPath& operator=(CDOTAMsg_PingWaypointPath&& from) noexcept {
  ...
  static const CDOTAMsg_PingWaypointPath& default_instance() {
    return *internal_default_instance();
  }
  static inline const CDOTAMsg_PingWaypointPath* internal_default_instance() {
    return reinterpret_cast<const CDOTAMsg_PingWaypointPath*>(
               &_CDOTAMsg_PingWaypointPath_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    0;

  friend void swap(CDOTAMsg_PingWaypointPath& a, CDOTAMsg_PingWaypointPath& b) {
    a.Swap(&b);
  }
  inline void Swap(CDOTAMsg_PingWaypointPath* other) {
  ...
  void UnsafeArenaSwap(CDOTAMsg_PingWaypointPath* other) {
    if (other == this) return;
  ...
  CDOTAMsg_PingWaypointPath* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<CDOTAMsg_PingWaypointPath>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const CDOTAMsg_PingWaypointPath& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const CDOTAMsg_PingWaypointPath& from) {
    CDOTAMsg_PingWaypointPath::MergeImpl(*this, from);
  }
  private:
  ...
  void InternalSwap(CDOTAMsg_PingWaypointPath* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "CDOTAMsg_PingWaypointPath";
  }
  protected:
  explicit CDOTAMsg_PingWaypointPath(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  enum : int {
    kGridNavDirectionsFieldNumber = 3,
    kXFieldNumber = 1,
    kYFieldNumber = 2,
  };
  // optional bytes grid_nav_directions = 3;
  bool has_grid_nav_directions() const;
  private:
  bool _internal_has_grid_nav_directions() const;
  public:
  void clear_grid_nav_directions();
  const std::string& grid_nav_directions() const;
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_grid_nav_directions(ArgT0&& arg0, ArgT... args);
  std::string* mutable_grid_nav_directions();
  PROTOBUF_NODISCARD std::string* release_grid_nav_directions();
  void set_allocated_grid_nav_directions(std::string* grid_nav_directions);
  private:
  const std::string& _internal_grid_nav_directions() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_grid_nav_directions(const std::string& value);
  std::string* _internal_mutable_grid_nav_directions();
  public:
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr grid_nav_directions_;
    int32_t x_;
    int32_t y_;
  };
  union { Impl_ _impl_; };
...
class CDOTAMsg_LocationPing final :
 ...
 public:
  ...
  private:
  bool _internal_has_waypoint_path() const;
  public:
  void clear_waypoint_path();
  const ::CDOTAMsg_PingWaypointPath& waypoint_path() const;
  PROTOBUF_NODISCARD ::CDOTAMsg_PingWaypointPath* release_waypoint_path();
  ::CDOTAMsg_PingWaypointPath* mutable_waypoint_path();
  void set_allocated_waypoint_path(::CDOTAMsg_PingWaypointPath* waypoint_path);
  private:
  const ::CDOTAMsg_PingWaypointPath& _internal_waypoint_path() const;
  ::CDOTAMsg_PingWaypointPath* _internal_mutable_waypoint_path();
  public:
  void unsafe_arena_set_allocated_waypoint_path(
      ::CDOTAMsg_PingWaypointPath* waypoint_path);
  ::CDOTAMsg_PingWaypointPath* unsafe_arena_release_waypoint_path();
 ...
 private:
  ...
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::internal::HasBits<1> _has_bits_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
    ::CDOTAMsg_PingWaypointPath* waypoint_path_;
    int32_t x_;
    int32_t y_;
    bool direct_ping_;
    int ping_source_;
...
// optional int32 x = 1;
inline bool CDOTAMsg_PingWaypointPath::_internal_has_x() const {
  bool value = (_impl_._has_bits_[0] & 0x00000002u) != 0;
  return value;
}
inline bool CDOTAMsg_PingWaypointPath::has_x() const {
  return _internal_has_x();
}
inline void CDOTAMsg_PingWaypointPath::clear_x() {
  _impl_.x_ = 0;
  _impl_._has_bits_[0] &= ~0x00000002u;
}
inline int32_t CDOTAMsg_PingWaypointPath::_internal_x() const {
  return _impl_.x_;
}
inline int32_t CDOTAMsg_PingWaypointPath::x() const {
  // @@protoc_insertion_point(field_get:CDOTAMsg_PingWaypointPath.x)
  return _internal_x();
}
inline void CDOTAMsg_PingWaypointPath::_internal_set_x(int32_t value) {
  _impl_._has_bits_[0] |= 0x00000002u;
  _impl_.x_ = value;
}
inline void CDOTAMsg_PingWaypointPath::set_x(int32_t value) {
  _internal_set_x(value);
  // @@protoc_insertion_point(field_set:CDOTAMsg_PingWaypointPath.x)
}

// optional int32 y = 2;
inline bool CDOTAMsg_PingWaypointPath::_internal_has_y() const {
  bool value = (_impl_._has_bits_[0] & 0x00000004u) != 0;
  return value;
}
inline bool CDOTAMsg_PingWaypointPath::has_y() const {
  return _internal_has_y();
}
inline void CDOTAMsg_PingWaypointPath::clear_y() {
  _impl_.y_ = 0;
  _impl_._has_bits_[0] &= ~0x00000004u;
}
inline int32_t CDOTAMsg_PingWaypointPath::_internal_y() const {
  return _impl_.y_;
}
inline int32_t CDOTAMsg_PingWaypointPath::y() const {
  // @@protoc_insertion_point(field_get:CDOTAMsg_PingWaypointPath.y)
  return _internal_y();
}
inline void CDOTAMsg_PingWaypointPath::_internal_set_y(int32_t value) {
  _impl_._has_bits_[0] |= 0x00000004u;
  _impl_.y_ = value;
}
inline void CDOTAMsg_PingWaypointPath::set_y(int32_t value) {
  _internal_set_y(value);
  // @@protoc_insertion_point(field_set:CDOTAMsg_PingWaypointPath.y)
}

// optional bytes grid_nav_directions = 3;
inline bool CDOTAMsg_PingWaypointPath::_internal_has_grid_nav_directions() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline bool CDOTAMsg_PingWaypointPath::has_grid_nav_directions() const {
  return _internal_has_grid_nav_directions();
}
inline void CDOTAMsg_PingWaypointPath::clear_grid_nav_directions() {
  _impl_.grid_nav_directions_.ClearToEmpty();
  _impl_._has_bits_[0] &= ~0x00000001u;
}
inline const std::string& CDOTAMsg_PingWaypointPath::grid_nav_directions() const {
  // @@protoc_insertion_point(field_get:CDOTAMsg_PingWaypointPath.grid_nav_directions)
  return _internal_grid_nav_directions();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void CDOTAMsg_PingWaypointPath::set_grid_nav_directions(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000001u;
 _impl_.grid_nav_directions_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:CDOTAMsg_PingWaypointPath.grid_nav_directions)
}
inline std::string* CDOTAMsg_PingWaypointPath::mutable_grid_nav_directions() {
  std::string* _s = _internal_mutable_grid_nav_directions();
  // @@protoc_insertion_point(field_mutable:CDOTAMsg_PingWaypointPath.grid_nav_directions)
  return _s;
}
inline const std::string& CDOTAMsg_PingWaypointPath::_internal_grid_nav_directions() const {
  return _impl_.grid_nav_directions_.Get();
}
inline void CDOTAMsg_PingWaypointPath::_internal_set_grid_nav_directions(const std::string& value) {
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.grid_nav_directions_.Set(value, GetArenaForAllocation());
}
inline std::string* CDOTAMsg_PingWaypointPath::_internal_mutable_grid_nav_directions() {
  _impl_._has_bits_[0] |= 0x00000001u;
  return _impl_.grid_nav_directions_.Mutable(GetArenaForAllocation());
}
inline std::string* CDOTAMsg_PingWaypointPath::release_grid_nav_directions() {
  // @@protoc_insertion_point(field_release:CDOTAMsg_PingWaypointPath.grid_nav_directions)
  if (!_internal_has_grid_nav_directions()) {
    return nullptr;
  }
  _impl_._has_bits_[0] &= ~0x00000001u;
  auto* p = _impl_.grid_nav_directions_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.grid_nav_directions_.IsDefault()) {
    _impl_.grid_nav_directions_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  return p;
}
inline void CDOTAMsg_PingWaypointPath::set_allocated_grid_nav_directions(std::string* grid_nav_directions) {
  if (grid_nav_directions != nullptr) {
    _impl_._has_bits_[0] |= 0x00000001u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000001u;
  }
  _impl_.grid_nav_directions_.SetAllocated(grid_nav_directions, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.grid_nav_directions_.IsDefault()) {
    _impl_.grid_nav_directions_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:CDOTAMsg_PingWaypointPath.grid_nav_directions)
}
...
// optional .CDOTAMsg_PingWaypointPath waypoint_path = 7;
inline bool CDOTAMsg_LocationPing::_internal_has_waypoint_path() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  PROTOBUF_ASSUME(!value || _impl_.waypoint_path_ != nullptr);
  return value;
}
inline bool CDOTAMsg_LocationPing::has_waypoint_path() const {
  return _internal_has_waypoint_path();
}
inline void CDOTAMsg_LocationPing::clear_waypoint_path() {
  if (_impl_.waypoint_path_ != nullptr) _impl_.waypoint_path_->Clear();
  _impl_._has_bits_[0] &= ~0x00000001u;
}
inline const ::CDOTAMsg_PingWaypointPath& CDOTAMsg_LocationPing::_internal_waypoint_path() const {
  const ::CDOTAMsg_PingWaypointPath* p = _impl_.waypoint_path_;
  return p != nullptr ? *p : reinterpret_cast<const ::CDOTAMsg_PingWaypointPath&>(
      ::_CDOTAMsg_PingWaypointPath_default_instance_);
}
inline const ::CDOTAMsg_PingWaypointPath& CDOTAMsg_LocationPing::waypoint_path() const {
  // @@protoc_insertion_point(field_get:CDOTAMsg_LocationPing.waypoint_path)
  return _internal_waypoint_path();
}
inline void CDOTAMsg_LocationPing::unsafe_arena_set_allocated_waypoint_path(
    ::CDOTAMsg_PingWaypointPath* waypoint_path) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.waypoint_path_);
  }
  _impl_.waypoint_path_ = waypoint_path;
  if (waypoint_path) {
    _impl_._has_bits_[0] |= 0x00000001u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000001u;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:CDOTAMsg_LocationPing.waypoint_path)
}
inline ::CDOTAMsg_PingWaypointPath* CDOTAMsg_LocationPing::release_waypoint_path() {
  _impl_._has_bits_[0] &= ~0x00000001u;
  ::CDOTAMsg_PingWaypointPath* temp = _impl_.waypoint_path_;
  _impl_.waypoint_path_ = nullptr;
...
inline ::CDOTAMsg_PingWaypointPath* CDOTAMsg_LocationPing::unsafe_arena_release_waypoint_path() {
  // @@protoc_insertion_point(field_release:CDOTAMsg_LocationPing.waypoint_path)
  _impl_._has_bits_[0] &= ~0x00000001u;
  ::CDOTAMsg_PingWaypointPath* temp = _impl_.waypoint_path_;
  _impl_.waypoint_path_ = nullptr;
  return temp;
}
inline ::CDOTAMsg_PingWaypointPath* CDOTAMsg_LocationPing::_internal_mutable_waypoint_path() {
  _impl_._has_bits_[0] |= 0x00000001u;
  if (_impl_.waypoint_path_ == nullptr) {
    auto* p = CreateMaybeMessage<::CDOTAMsg_PingWaypointPath>(GetArenaForAllocation());
    _impl_.waypoint_path_ = p;
  }
  return _impl_.waypoint_path_;
}
inline ::CDOTAMsg_PingWaypointPath* CDOTAMsg_LocationPing::mutable_waypoint_path() {
  ::CDOTAMsg_PingWaypointPath* _msg = _internal_mutable_waypoint_path();
  // @@protoc_insertion_point(field_mutable:CDOTAMsg_LocationPing.waypoint_path)
  return _msg;
}
inline void CDOTAMsg_LocationPing::set_allocated_waypoint_path(::CDOTAMsg_PingWaypointPath* waypoint_path) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.waypoint_path_;
  }
  if (waypoint_path) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(waypoint_path);
    if (message_arena != submessage_arena) {
      waypoint_path = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
  ...
  _impl_.waypoint_path_ = waypoint_path;
  // @@protoc_insertion_point(field_set_allocated:CDOTAMsg_LocationPing.waypoint_path)
}
