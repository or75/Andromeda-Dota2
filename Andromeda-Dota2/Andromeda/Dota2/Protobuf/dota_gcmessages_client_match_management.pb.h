...
constexpr EStartFindingMatchResult EStartFindingMatchResult_MAX = k_EStartFindingMatchResult_RegisteredNameRequired;
...
class CMsgPracticeLobbySetDetails final :
 ...
 public:
  ...
  enum : int {
    ...
    kRequestedHeroTeamsFieldNumber = 54,
...
// repeated int32 requested_hero_teams = 54;
inline int CMsgPracticeLobbySetDetails::_internal_requested_hero_teams_size() const {
  return _impl_.requested_hero_teams_.size();
}
inline int CMsgPracticeLobbySetDetails::requested_hero_teams_size() const {
  return _internal_requested_hero_teams_size();
}
inline void CMsgPracticeLobbySetDetails::clear_requested_hero_teams() {
  _impl_.requested_hero_teams_.Clear();
}
inline int32_t CMsgPracticeLobbySetDetails::_internal_requested_hero_teams(int index) const {
  return _impl_.requested_hero_teams_.Get(index);
}
inline int32_t CMsgPracticeLobbySetDetails::requested_hero_teams(int index) const {
  // @@protoc_insertion_point(field_get:CMsgPracticeLobbySetDetails.requested_hero_teams)
  return _internal_requested_hero_teams(index);
}
inline void CMsgPracticeLobbySetDetails::set_requested_hero_teams(int index, int32_t value) {
  _impl_.requested_hero_teams_.Set(index, value);
  // @@protoc_insertion_point(field_set:CMsgPracticeLobbySetDetails.requested_hero_teams)
}
inline void CMsgPracticeLobbySetDetails::_internal_add_requested_hero_teams(int32_t value) {
  _impl_.requested_hero_teams_.Add(value);
}
inline void CMsgPracticeLobbySetDetails::add_requested_hero_teams(int32_t value) {
  _internal_add_requested_hero_teams(value);
  // @@protoc_insertion_point(field_add:CMsgPracticeLobbySetDetails.requested_hero_teams)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >&
CMsgPracticeLobbySetDetails::_internal_requested_hero_teams() const {
  return _impl_.requested_hero_teams_;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >&
CMsgPracticeLobbySetDetails::requested_hero_teams() const {
  // @@protoc_insertion_point(field_list:CMsgPracticeLobbySetDetails.requested_hero_teams)
  return _internal_requested_hero_teams();
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >*
CMsgPracticeLobbySetDetails::_internal_mutable_requested_hero_teams() {
  return &_impl_.requested_hero_teams_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >*
CMsgPracticeLobbySetDetails::mutable_requested_hero_teams() {
  // @@protoc_insertion_point(field_mutable_list:CMsgPracticeLobbySetDetails.requested_hero_teams)
