...
class CMsgMonsterHunterCodexUpdateData;
struct CMsgMonsterHunterCodexUpdateDataDefaultTypeInternal;
extern CMsgMonsterHunterCodexUpdateDataDefaultTypeInternal _CMsgMonsterHunterCodexUpdateData_default_instance_;
class CMsgMonsterHunterCodexUpdateData_KillInfo;
struct CMsgMonsterHunterCodexUpdateData_KillInfoDefaultTypeInternal;
extern CMsgMonsterHunterCodexUpdateData_KillInfoDefaultTypeInternal _CMsgMonsterHunterCodexUpdateData_KillInfo_default_instance_;
class CMsgMonsterHunterInvestigation;
struct CMsgMonsterHunterInvestigationDefaultTypeInternal;
extern CMsgMonsterHunterInvestigationDefaultTypeInternal _CMsgMonsterHunterInvestigation_default_instance_;
class CMsgMonsterHunterInvestigationGameState;
struct CMsgMonsterHunterInvestigationGameStateDefaultTypeInternal;
extern CMsgMonsterHunterInvestigationGameStateDefaultTypeInternal _CMsgMonsterHunterInvestigationGameState_default_instance_;
class CMsgMonsterHunterInvestigationGameState_HuntedBy;
struct CMsgMonsterHunterInvestigationGameState_HuntedByDefaultTypeInternal;
extern CMsgMonsterHunterInvestigationGameState_HuntedByDefaultTypeInternal _CMsgMonsterHunterInvestigationGameState_HuntedBy_default_instance_;
class CMsgMonsterHunterMaterialQuantity;
struct CMsgMonsterHunterMaterialQuantityDefaultTypeInternal;
extern CMsgMonsterHunterMaterialQuantityDefaultTypeInternal _CMsgMonsterHunterMaterialQuantity_default_instance_;
class CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry;
struct CMsgMonsterHunterMaterialQuantity_MaterialCountsEntryDefaultTypeInternal;
extern CMsgMonsterHunterMaterialQuantity_MaterialCountsEntryDefaultTypeInternal _CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry_default_instance_;
...
template<> ::CMsgMonsterHunterCodexUpdateData* Arena::CreateMaybeMessage<::CMsgMonsterHunterCodexUpdateData>(Arena*);
template<> ::CMsgMonsterHunterCodexUpdateData_KillInfo* Arena::CreateMaybeMessage<::CMsgMonsterHunterCodexUpdateData_KillInfo>(Arena*);
template<> ::CMsgMonsterHunterInvestigation* Arena::CreateMaybeMessage<::CMsgMonsterHunterInvestigation>(Arena*);
template<> ::CMsgMonsterHunterInvestigationGameState* Arena::CreateMaybeMessage<::CMsgMonsterHunterInvestigationGameState>(Arena*);
template<> ::CMsgMonsterHunterInvestigationGameState_HuntedBy* Arena::CreateMaybeMessage<::CMsgMonsterHunterInvestigationGameState_HuntedBy>(Arena*);
template<> ::CMsgMonsterHunterMaterialQuantity* Arena::CreateMaybeMessage<::CMsgMonsterHunterMaterialQuantity>(Arena*);
template<> ::CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry* Arena::CreateMaybeMessage<::CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry>(Arena*);
...
constexpr DOTA_GameMode DOTA_GameMode_MAX = DOTA_GAMEMODE_BOT_CHALLENGE;
...
constexpr EBadgeType EBadgeType_MAX = k_EBadgeType_TI14_Special;
...
constexpr DOTA_COMBATLOG_TYPES DOTA_COMBATLOG_TYPES_MAX = DOTA_COMBATLOG_STAT_TRACKER_PLAYER;
...
enum EItemSuggestPreference : int {
...
constexpr EItemSuggestPreference EItemSuggestPreference_MIN = k_EItemSuggestPreference_None;
constexpr EItemSuggestPreference EItemSuggestPreference_MAX = k_EItemSuggestPreference_Disliked;
constexpr int EItemSuggestPreference_ARRAYSIZE = EItemSuggestPreference_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* EItemSuggestPreference_descriptor();
template<typename T>
inline const std::string& EItemSuggestPreference_Name(T enum_t_value) {
  static_assert(::std::is_same<T, EItemSuggestPreference>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function EItemSuggestPreference_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    EItemSuggestPreference_descriptor(), enum_t_value);
}
inline bool EItemSuggestPreference_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, EItemSuggestPreference* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<EItemSuggestPreference>(
    EItemSuggestPreference_descriptor(), name, value);
}
enum ETimerAlertType : int {
...
constexpr ETimerAlertType ETimerAlertType_MIN = k_TimerAlertType_PowerRune;
constexpr ETimerAlertType ETimerAlertType_MAX = k_TimerAlertType_LotusPool;
constexpr int ETimerAlertType_ARRAYSIZE = ETimerAlertType_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* ETimerAlertType_descriptor();
template<typename T>
inline const std::string& ETimerAlertType_Name(T enum_t_value) {
  static_assert(::std::is_same<T, ETimerAlertType>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function ETimerAlertType_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    ETimerAlertType_descriptor(), enum_t_value);
}
inline bool ETimerAlertType_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, ETimerAlertType* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<ETimerAlertType>(
    ETimerAlertType_descriptor(), name, value);
}
// ===================================================================
...
class CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:CMsgMonsterHunterMaterialQuantity.MaterialCountsEntry) */ {
 public:
  inline CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry() : CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry(nullptr) {}
  ~CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry() override;
  explicit PROTOBUF_CONSTEXPR CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry(const CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry& from);
  CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry(CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry&& from) noexcept
    : CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry() {
    *this = ::std::move(from);
  }

  inline CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry& operator=(const CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry& from) {
    CopyFrom(from);
    return *this;
  }
  inline CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry& operator=(CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry& default_instance() {
    return *internal_default_instance();
  }
  static inline const CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry* internal_default_instance() {
    return reinterpret_cast<const CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry*>(
               &_CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    7;

  friend void swap(CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry& a, CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry& b) {
    a.Swap(&b);
  }
  inline void Swap(CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry& from) {
    CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "CMsgMonsterHunterMaterialQuantity.MaterialCountsEntry";
  }
  protected:
  explicit CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
...
class CMsgMonsterHunterMaterialQuantity final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:CMsgMonsterHunterMaterialQuantity) */ {
 public:
  inline CMsgMonsterHunterMaterialQuantity() : CMsgMonsterHunterMaterialQuantity(nullptr) {}
  ~CMsgMonsterHunterMaterialQuantity() override;
  explicit PROTOBUF_CONSTEXPR CMsgMonsterHunterMaterialQuantity(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  CMsgMonsterHunterMaterialQuantity(const CMsgMonsterHunterMaterialQuantity& from);
  CMsgMonsterHunterMaterialQuantity(CMsgMonsterHunterMaterialQuantity&& from) noexcept
    : CMsgMonsterHunterMaterialQuantity() {
    *this = ::std::move(from);
  }

  inline CMsgMonsterHunterMaterialQuantity& operator=(const CMsgMonsterHunterMaterialQuantity& from) {
    CopyFrom(from);
    return *this;
  }
  inline CMsgMonsterHunterMaterialQuantity& operator=(CMsgMonsterHunterMaterialQuantity&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const CMsgMonsterHunterMaterialQuantity& default_instance() {
    return *internal_default_instance();
  }
  static inline const CMsgMonsterHunterMaterialQuantity* internal_default_instance() {
    return reinterpret_cast<const CMsgMonsterHunterMaterialQuantity*>(
               &_CMsgMonsterHunterMaterialQuantity_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    8;

  friend void swap(CMsgMonsterHunterMaterialQuantity& a, CMsgMonsterHunterMaterialQuantity& b) {
    a.Swap(&b);
  }
  inline void Swap(CMsgMonsterHunterMaterialQuantity* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(CMsgMonsterHunterMaterialQuantity* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  CMsgMonsterHunterMaterialQuantity* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<CMsgMonsterHunterMaterialQuantity>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const CMsgMonsterHunterMaterialQuantity& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const CMsgMonsterHunterMaterialQuantity& from) {
    CMsgMonsterHunterMaterialQuantity::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(CMsgMonsterHunterMaterialQuantity* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "CMsgMonsterHunterMaterialQuantity";
  }
  protected:
  explicit CMsgMonsterHunterMaterialQuantity(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  typedef CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry MaterialCountsEntry;

  // accessors -------------------------------------------------------

  enum : int {
    kMaterialCountsFieldNumber = 1,
  };
  // repeated .CMsgMonsterHunterMaterialQuantity.MaterialCountsEntry material_counts = 1;
  int material_counts_size() const;
  private:
  int _internal_material_counts_size() const;
  public:
  void clear_material_counts();
  ::CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry* mutable_material_counts(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry >*
      mutable_material_counts();
  private:
  const ::CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry& _internal_material_counts(int index) const;
  ::CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry* _internal_add_material_counts();
  public:
  const ::CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry& material_counts(int index) const;
  ::CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry* add_material_counts();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry >&
      material_counts() const;
 ...
 private:
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry > material_counts_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_dota_5fshared_5fenums_2eproto;
...
class CMsgMonsterHunterInvestigation final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:CMsgMonsterHunterInvestigation) */ {
 public:
  inline CMsgMonsterHunterInvestigation() : CMsgMonsterHunterInvestigation(nullptr) {}
  ~CMsgMonsterHunterInvestigation() override;
  explicit PROTOBUF_CONSTEXPR CMsgMonsterHunterInvestigation(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  CMsgMonsterHunterInvestigation(const CMsgMonsterHunterInvestigation& from);
  CMsgMonsterHunterInvestigation(CMsgMonsterHunterInvestigation&& from) noexcept
    : CMsgMonsterHunterInvestigation() {
    *this = ::std::move(from);
  }

  inline CMsgMonsterHunterInvestigation& operator=(const CMsgMonsterHunterInvestigation& from) {
    CopyFrom(from);
    return *this;
  }
  inline CMsgMonsterHunterInvestigation& operator=(CMsgMonsterHunterInvestigation&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const CMsgMonsterHunterInvestigation& default_instance() {
    return *internal_default_instance();
  }
  static inline const CMsgMonsterHunterInvestigation* internal_default_instance() {
    return reinterpret_cast<const CMsgMonsterHunterInvestigation*>(
               &_CMsgMonsterHunterInvestigation_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    9;

  friend void swap(CMsgMonsterHunterInvestigation& a, CMsgMonsterHunterInvestigation& b) {
    a.Swap(&b);
  }
  inline void Swap(CMsgMonsterHunterInvestigation* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(CMsgMonsterHunterInvestigation* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  CMsgMonsterHunterInvestigation* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<CMsgMonsterHunterInvestigation>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const CMsgMonsterHunterInvestigation& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const CMsgMonsterHunterInvestigation& from) {
    CMsgMonsterHunterInvestigation::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(CMsgMonsterHunterInvestigation* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "CMsgMonsterHunterInvestigation";
  }
  protected:
  explicit CMsgMonsterHunterInvestigation(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  enum : int {
    kMatchRewardsFieldNumber = 3,
    kHuntRewardsFieldNumber = 4,
    kHeroIdFieldNumber = 1,
    kPersonaIdFieldNumber = 2,
    kSuccessStateFieldNumber = 5,
  };
  // optional .CMsgMonsterHunterMaterialQuantity match_rewards = 3;
  bool has_match_rewards() const;
  private:
  bool _internal_has_match_rewards() const;
  public:
  void clear_match_rewards();
  const ::CMsgMonsterHunterMaterialQuantity& match_rewards() const;
  PROTOBUF_NODISCARD ::CMsgMonsterHunterMaterialQuantity* release_match_rewards();
  ::CMsgMonsterHunterMaterialQuantity* mutable_match_rewards();
  void set_allocated_match_rewards(::CMsgMonsterHunterMaterialQuantity* match_rewards);
  private:
  const ::CMsgMonsterHunterMaterialQuantity& _internal_match_rewards() const;
  ::CMsgMonsterHunterMaterialQuantity* _internal_mutable_match_rewards();
  public:
  void unsafe_arena_set_allocated_match_rewards(
      ::CMsgMonsterHunterMaterialQuantity* match_rewards);
  ::CMsgMonsterHunterMaterialQuantity* unsafe_arena_release_match_rewards();

  // optional .CMsgMonsterHunterMaterialQuantity hunt_rewards = 4;
  bool has_hunt_rewards() const;
  private:
  bool _internal_has_hunt_rewards() const;
  public:
  void clear_hunt_rewards();
  const ::CMsgMonsterHunterMaterialQuantity& hunt_rewards() const;
  PROTOBUF_NODISCARD ::CMsgMonsterHunterMaterialQuantity* release_hunt_rewards();
  ::CMsgMonsterHunterMaterialQuantity* mutable_hunt_rewards();
  void set_allocated_hunt_rewards(::CMsgMonsterHunterMaterialQuantity* hunt_rewards);
  private:
  const ::CMsgMonsterHunterMaterialQuantity& _internal_hunt_rewards() const;
  ::CMsgMonsterHunterMaterialQuantity* _internal_mutable_hunt_rewards();
  public:
  void unsafe_arena_set_allocated_hunt_rewards(
      ::CMsgMonsterHunterMaterialQuantity* hunt_rewards);
  ::CMsgMonsterHunterMaterialQuantity* unsafe_arena_release_hunt_rewards();
  ...
  bool has_persona_id() const;
  private:
  bool _internal_has_persona_id() const;
  public:
  void clear_persona_id();
  int32_t persona_id() const;
  void set_persona_id(int32_t value);
  private:
  int32_t _internal_persona_id() const;
  void _internal_set_persona_id(int32_t value);
  public:

  // optional bool success_state = 5;
  bool has_success_state() const;
  private:
  bool _internal_has_success_state() const;
  public:
  void clear_success_state();
  bool success_state() const;
  void set_success_state(bool value);
  private:
  bool _internal_success_state() const;
  void _internal_set_success_state(bool value);
  public:
 ...
 private:
  ...
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::internal::HasBits<1> _has_bits_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
    ::CMsgMonsterHunterMaterialQuantity* match_rewards_;
    ::CMsgMonsterHunterMaterialQuantity* hunt_rewards_;
    int32_t hero_id_;
    int32_t persona_id_;
    bool success_state_;
  };
...
class CMsgMonsterHunterInvestigationGameState_HuntedBy final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:CMsgMonsterHunterInvestigationGameState.HuntedBy) */ {
 public:
  inline CMsgMonsterHunterInvestigationGameState_HuntedBy() : CMsgMonsterHunterInvestigationGameState_HuntedBy(nullptr) {}
  ~CMsgMonsterHunterInvestigationGameState_HuntedBy() override;
  explicit PROTOBUF_CONSTEXPR CMsgMonsterHunterInvestigationGameState_HuntedBy(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  CMsgMonsterHunterInvestigationGameState_HuntedBy(const CMsgMonsterHunterInvestigationGameState_HuntedBy& from);
  CMsgMonsterHunterInvestigationGameState_HuntedBy(CMsgMonsterHunterInvestigationGameState_HuntedBy&& from) noexcept
    : CMsgMonsterHunterInvestigationGameState_HuntedBy() {
    *this = ::std::move(from);
  }

  inline CMsgMonsterHunterInvestigationGameState_HuntedBy& operator=(const CMsgMonsterHunterInvestigationGameState_HuntedBy& from) {
    CopyFrom(from);
    return *this;
  }
  inline CMsgMonsterHunterInvestigationGameState_HuntedBy& operator=(CMsgMonsterHunterInvestigationGameState_HuntedBy&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const CMsgMonsterHunterInvestigationGameState_HuntedBy& default_instance() {
    return *internal_default_instance();
  }
  static inline const CMsgMonsterHunterInvestigationGameState_HuntedBy* internal_default_instance() {
    return reinterpret_cast<const CMsgMonsterHunterInvestigationGameState_HuntedBy*>(
               &_CMsgMonsterHunterInvestigationGameState_HuntedBy_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    10;

  friend void swap(CMsgMonsterHunterInvestigationGameState_HuntedBy& a, CMsgMonsterHunterInvestigationGameState_HuntedBy& b) {
    a.Swap(&b);
  }
  inline void Swap(CMsgMonsterHunterInvestigationGameState_HuntedBy* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(CMsgMonsterHunterInvestigationGameState_HuntedBy* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  CMsgMonsterHunterInvestigationGameState_HuntedBy* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<CMsgMonsterHunterInvestigationGameState_HuntedBy>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const CMsgMonsterHunterInvestigationGameState_HuntedBy& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const CMsgMonsterHunterInvestigationGameState_HuntedBy& from) {
    CMsgMonsterHunterInvestigationGameState_HuntedBy::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(CMsgMonsterHunterInvestigationGameState_HuntedBy* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "CMsgMonsterHunterInvestigationGameState.HuntedBy";
  }
  protected:
  explicit CMsgMonsterHunterInvestigationGameState_HuntedBy(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  enum : int {
    kHuntRewardsFieldNumber = 3,
    kHeroIdFieldNumber = 1,
    kPersonaIdFieldNumber = 2,
    kSuccessStateFieldNumber = 4,
  };
...
class CMsgMonsterHunterInvestigationGameState final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:CMsgMonsterHunterInvestigationGameState) */ {
 public:
  inline CMsgMonsterHunterInvestigationGameState() : CMsgMonsterHunterInvestigationGameState(nullptr) {}
  ~CMsgMonsterHunterInvestigationGameState() override;
  explicit PROTOBUF_CONSTEXPR CMsgMonsterHunterInvestigationGameState(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  CMsgMonsterHunterInvestigationGameState(const CMsgMonsterHunterInvestigationGameState& from);
  CMsgMonsterHunterInvestigationGameState(CMsgMonsterHunterInvestigationGameState&& from) noexcept
    : CMsgMonsterHunterInvestigationGameState() {
    *this = ::std::move(from);
  }

  inline CMsgMonsterHunterInvestigationGameState& operator=(const CMsgMonsterHunterInvestigationGameState& from) {
    CopyFrom(from);
    return *this;
  }
  inline CMsgMonsterHunterInvestigationGameState& operator=(CMsgMonsterHunterInvestigationGameState&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const CMsgMonsterHunterInvestigationGameState& default_instance() {
    return *internal_default_instance();
  }
  static inline const CMsgMonsterHunterInvestigationGameState* internal_default_instance() {
    return reinterpret_cast<const CMsgMonsterHunterInvestigationGameState*>(
               &_CMsgMonsterHunterInvestigationGameState_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    11;

  friend void swap(CMsgMonsterHunterInvestigationGameState& a, CMsgMonsterHunterInvestigationGameState& b) {
    a.Swap(&b);
  }
  inline void Swap(CMsgMonsterHunterInvestigationGameState* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(CMsgMonsterHunterInvestigationGameState* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  CMsgMonsterHunterInvestigationGameState* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<CMsgMonsterHunterInvestigationGameState>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const CMsgMonsterHunterInvestigationGameState& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const CMsgMonsterHunterInvestigationGameState& from) {
    CMsgMonsterHunterInvestigationGameState::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(CMsgMonsterHunterInvestigationGameState* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "CMsgMonsterHunterInvestigationGameState";
  }
  protected:
  explicit CMsgMonsterHunterInvestigationGameState(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  typedef CMsgMonsterHunterInvestigationGameState_HuntedBy HuntedBy;

  // accessors -------------------------------------------------------

  enum : int {
    kHuntedByFieldNumber = 2,
    kSelectedInvestigationFieldNumber = 1,
  };
  // repeated .CMsgMonsterHunterInvestigationGameState.HuntedBy hunted_by = 2;
  int hunted_by_size() const;
  private:
  int _internal_hunted_by_size() const;
  public:
  void clear_hunted_by();
  ::CMsgMonsterHunterInvestigationGameState_HuntedBy* mutable_hunted_by(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CMsgMonsterHunterInvestigationGameState_HuntedBy >*
      mutable_hunted_by();
  private:
  const ::CMsgMonsterHunterInvestigationGameState_HuntedBy& _internal_hunted_by(int index) const;
  ::CMsgMonsterHunterInvestigationGameState_HuntedBy* _internal_add_hunted_by();
  public:
  const ::CMsgMonsterHunterInvestigationGameState_HuntedBy& hunted_by(int index) const;
  ::CMsgMonsterHunterInvestigationGameState_HuntedBy* add_hunted_by();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CMsgMonsterHunterInvestigationGameState_HuntedBy >&
      hunted_by() const;

  // optional .CMsgMonsterHunterInvestigation selected_investigation = 1;
  bool has_selected_investigation() const;
  private:
  bool _internal_has_selected_investigation() const;
  public:
  void clear_selected_investigation();
  const ::CMsgMonsterHunterInvestigation& selected_investigation() const;
  PROTOBUF_NODISCARD ::CMsgMonsterHunterInvestigation* release_selected_investigation();
  ::CMsgMonsterHunterInvestigation* mutable_selected_investigation();
  void set_allocated_selected_investigation(::CMsgMonsterHunterInvestigation* selected_investigation);
  private:
  const ::CMsgMonsterHunterInvestigation& _internal_selected_investigation() const;
  ::CMsgMonsterHunterInvestigation* _internal_mutable_selected_investigation();
  public:
  void unsafe_arena_set_allocated_selected_investigation(
      ::CMsgMonsterHunterInvestigation* selected_investigation);
  ::CMsgMonsterHunterInvestigation* unsafe_arena_release_selected_investigation();
 ...
 private:
  ...
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::internal::HasBits<1> _has_bits_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CMsgMonsterHunterInvestigationGameState_HuntedBy > hunted_by_;
    ::CMsgMonsterHunterInvestigation* selected_investigation_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_dota_5fshared_5fenums_2eproto;
};
...
class CMsgMonsterHunterCodexUpdateData_KillInfo final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:CMsgMonsterHunterCodexUpdateData.KillInfo) */ {
 public:
  inline CMsgMonsterHunterCodexUpdateData_KillInfo() : CMsgMonsterHunterCodexUpdateData_KillInfo(nullptr) {}
  ~CMsgMonsterHunterCodexUpdateData_KillInfo() override;
  explicit PROTOBUF_CONSTEXPR CMsgMonsterHunterCodexUpdateData_KillInfo(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  CMsgMonsterHunterCodexUpdateData_KillInfo(const CMsgMonsterHunterCodexUpdateData_KillInfo& from);
  CMsgMonsterHunterCodexUpdateData_KillInfo(CMsgMonsterHunterCodexUpdateData_KillInfo&& from) noexcept
    : CMsgMonsterHunterCodexUpdateData_KillInfo() {
    *this = ::std::move(from);
  }

  inline CMsgMonsterHunterCodexUpdateData_KillInfo& operator=(const CMsgMonsterHunterCodexUpdateData_KillInfo& from) {
    CopyFrom(from);
    return *this;
  }
  inline CMsgMonsterHunterCodexUpdateData_KillInfo& operator=(CMsgMonsterHunterCodexUpdateData_KillInfo&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const CMsgMonsterHunterCodexUpdateData_KillInfo& default_instance() {
    return *internal_default_instance();
  }
  static inline const CMsgMonsterHunterCodexUpdateData_KillInfo* internal_default_instance() {
    return reinterpret_cast<const CMsgMonsterHunterCodexUpdateData_KillInfo*>(
               &_CMsgMonsterHunterCodexUpdateData_KillInfo_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    12;

  friend void swap(CMsgMonsterHunterCodexUpdateData_KillInfo& a, CMsgMonsterHunterCodexUpdateData_KillInfo& b) {
    a.Swap(&b);
  }
  inline void Swap(CMsgMonsterHunterCodexUpdateData_KillInfo* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(CMsgMonsterHunterCodexUpdateData_KillInfo* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  CMsgMonsterHunterCodexUpdateData_KillInfo* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<CMsgMonsterHunterCodexUpdateData_KillInfo>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const CMsgMonsterHunterCodexUpdateData_KillInfo& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const CMsgMonsterHunterCodexUpdateData_KillInfo& from) {
    CMsgMonsterHunterCodexUpdateData_KillInfo::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(CMsgMonsterHunterCodexUpdateData_KillInfo* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "CMsgMonsterHunterCodexUpdateData.KillInfo";
  }
  protected:
  explicit CMsgMonsterHunterCodexUpdateData_KillInfo(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  // @@protoc_insertion_point(class_scope:CMsgMonsterHunterCodexUpdateData.KillInfo)
 private:
  class _Internal;
...
class CMsgMonsterHunterCodexUpdateData final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:CMsgMonsterHunterCodexUpdateData) */ {
 public:
  inline CMsgMonsterHunterCodexUpdateData() : CMsgMonsterHunterCodexUpdateData(nullptr) {}
  ~CMsgMonsterHunterCodexUpdateData() override;
  explicit PROTOBUF_CONSTEXPR CMsgMonsterHunterCodexUpdateData(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  CMsgMonsterHunterCodexUpdateData(const CMsgMonsterHunterCodexUpdateData& from);
  CMsgMonsterHunterCodexUpdateData(CMsgMonsterHunterCodexUpdateData&& from) noexcept
    : CMsgMonsterHunterCodexUpdateData() {
    *this = ::std::move(from);
  }

  inline CMsgMonsterHunterCodexUpdateData& operator=(const CMsgMonsterHunterCodexUpdateData& from) {
    CopyFrom(from);
    return *this;
  }
  inline CMsgMonsterHunterCodexUpdateData& operator=(CMsgMonsterHunterCodexUpdateData&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const CMsgMonsterHunterCodexUpdateData& default_instance() {
    return *internal_default_instance();
  }
  static inline const CMsgMonsterHunterCodexUpdateData* internal_default_instance() {
    return reinterpret_cast<const CMsgMonsterHunterCodexUpdateData*>(
               &_CMsgMonsterHunterCodexUpdateData_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    13;

  friend void swap(CMsgMonsterHunterCodexUpdateData& a, CMsgMonsterHunterCodexUpdateData& b) {
    a.Swap(&b);
  }
  inline void Swap(CMsgMonsterHunterCodexUpdateData* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(CMsgMonsterHunterCodexUpdateData* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  CMsgMonsterHunterCodexUpdateData* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<CMsgMonsterHunterCodexUpdateData>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const CMsgMonsterHunterCodexUpdateData& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const CMsgMonsterHunterCodexUpdateData& from) {
    CMsgMonsterHunterCodexUpdateData::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(CMsgMonsterHunterCodexUpdateData* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "CMsgMonsterHunterCodexUpdateData";
  }
  protected:
  explicit CMsgMonsterHunterCodexUpdateData(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  typedef CMsgMonsterHunterCodexUpdateData_KillInfo KillInfo;

  // accessors -------------------------------------------------------

  enum : int {
    kAlliesFieldNumber = 2,
    kEnemiesFieldNumber = 3,
    kPlayerKillsFieldNumber = 4,
    kPlayerHeroFieldNumber = 1,
  };
  // repeated int32 allies = 2;
  int allies_size() const;
  private:
  int _internal_allies_size() const;
  public:
  void clear_allies();
  private:
  int32_t _internal_allies(int index) const;
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >&
      _internal_allies() const;
  void _internal_add_allies(int32_t value);
  ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >*
      _internal_mutable_allies();
  public:
  int32_t allies(int index) const;
  void set_allies(int index, int32_t value);
  void add_allies(int32_t value);
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >&
      allies() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >*
      mutable_allies();
  ...
  void clear_enemies();
  private:
  int32_t _internal_enemies(int index) const;
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >&
      _internal_enemies() const;
  void _internal_add_enemies(int32_t value);
  ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >*
      _internal_mutable_enemies();
  public:
  int32_t enemies(int index) const;
  void set_enemies(int index, int32_t value);
  void add_enemies(int32_t value);
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >&
      enemies() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >*
      mutable_enemies();
  ...
  int player_kills_size() const;
  private:
  int _internal_player_kills_size() const;
  public:
  void clear_player_kills();
  ::CMsgMonsterHunterCodexUpdateData_KillInfo* mutable_player_kills(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CMsgMonsterHunterCodexUpdateData_KillInfo >*
      mutable_player_kills();
  private:
  const ::CMsgMonsterHunterCodexUpdateData_KillInfo& _internal_player_kills(int index) const;
  ::CMsgMonsterHunterCodexUpdateData_KillInfo* _internal_add_player_kills();
  public:
  const ::CMsgMonsterHunterCodexUpdateData_KillInfo& player_kills(int index) const;
  ::CMsgMonsterHunterCodexUpdateData_KillInfo* add_player_kills();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CMsgMonsterHunterCodexUpdateData_KillInfo >&
      player_kills() const;

  // optional int32 player_hero = 1;
  bool has_player_hero() const;
  private:
  bool _internal_has_player_hero() const;
  public:
  void clear_player_hero();
  int32_t player_hero() const;
  void set_player_hero(int32_t value);
  private:
  int32_t _internal_player_hero() const;
  void _internal_set_player_hero(int32_t value);
  public:

  // @@protoc_insertion_point(class_scope:CMsgMonsterHunterCodexUpdateData)
 private:
  class _Internal;
  ...
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::internal::HasBits<1> _has_bits_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
    ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t > allies_;
    ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t > enemies_;
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CMsgMonsterHunterCodexUpdateData_KillInfo > player_kills_;
    int32_t player_hero_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_dota_5fshared_5fenums_2eproto;
};
...
inline uint32_t CMsgDOTACombatLogEntry::tracked_stat_id() const {
  // @@protoc_insertion_point(field_get:CMsgDOTACombatLogEntry.tracked_stat_id)
...
// optional uint32 key = 1;
inline bool CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry::_internal_has_key() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline bool CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry::has_key() const {
  return _internal_has_key();
}
inline void CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry::clear_key() {
  _impl_.key_ = 0u;
  _impl_._has_bits_[0] &= ~0x00000001u;
}
inline uint32_t CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry::_internal_key() const {
  return _impl_.key_;
}
inline uint32_t CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry::key() const {
  // @@protoc_insertion_point(field_get:CMsgMonsterHunterMaterialQuantity.MaterialCountsEntry.key)
  return _internal_key();
}
inline void CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry::_internal_set_key(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.key_ = value;
}
inline void CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry::set_key(uint32_t value) {
  _internal_set_key(value);
  // @@protoc_insertion_point(field_set:CMsgMonsterHunterMaterialQuantity.MaterialCountsEntry.key)
}

// optional int32 value = 2;
inline bool CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry::_internal_has_value() const {
  bool value = (_impl_._has_bits_[0] & 0x00000002u) != 0;
  return value;
}
inline bool CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry::has_value() const {
  return _internal_has_value();
}
inline void CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry::clear_value() {
  _impl_.value_ = 0;
  _impl_._has_bits_[0] &= ~0x00000002u;
}
inline int32_t CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry::_internal_value() const {
  return _impl_.value_;
}
inline int32_t CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry::value() const {
  // @@protoc_insertion_point(field_get:CMsgMonsterHunterMaterialQuantity.MaterialCountsEntry.value)
  return _internal_value();
}
inline void CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry::_internal_set_value(int32_t value) {
  _impl_._has_bits_[0] |= 0x00000002u;
  _impl_.value_ = value;
}
inline void CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry::set_value(int32_t value) {
  _internal_set_value(value);
  // @@protoc_insertion_point(field_set:CMsgMonsterHunterMaterialQuantity.MaterialCountsEntry.value)
}
...
// repeated .CMsgMonsterHunterMaterialQuantity.MaterialCountsEntry material_counts = 1;
inline int CMsgMonsterHunterMaterialQuantity::_internal_material_counts_size() const {
  return _impl_.material_counts_.size();
}
inline int CMsgMonsterHunterMaterialQuantity::material_counts_size() const {
  return _internal_material_counts_size();
}
inline void CMsgMonsterHunterMaterialQuantity::clear_material_counts() {
  _impl_.material_counts_.Clear();
}
inline ::CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry* CMsgMonsterHunterMaterialQuantity::mutable_material_counts(int index) {
  // @@protoc_insertion_point(field_mutable:CMsgMonsterHunterMaterialQuantity.material_counts)
  return _impl_.material_counts_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry >*
CMsgMonsterHunterMaterialQuantity::mutable_material_counts() {
  // @@protoc_insertion_point(field_mutable_list:CMsgMonsterHunterMaterialQuantity.material_counts)
  return &_impl_.material_counts_;
}
inline const ::CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry& CMsgMonsterHunterMaterialQuantity::_internal_material_counts(int index) const {
  return _impl_.material_counts_.Get(index);
}
inline const ::CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry& CMsgMonsterHunterMaterialQuantity::material_counts(int index) const {
  // @@protoc_insertion_point(field_get:CMsgMonsterHunterMaterialQuantity.material_counts)
  return _internal_material_counts(index);
}
inline ::CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry* CMsgMonsterHunterMaterialQuantity::_internal_add_material_counts() {
  return _impl_.material_counts_.Add();
}
inline ::CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry* CMsgMonsterHunterMaterialQuantity::add_material_counts() {
  ::CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry* _add = _internal_add_material_counts();
  // @@protoc_insertion_point(field_add:CMsgMonsterHunterMaterialQuantity.material_counts)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry >&
CMsgMonsterHunterMaterialQuantity::material_counts() const {
  // @@protoc_insertion_point(field_list:CMsgMonsterHunterMaterialQuantity.material_counts)
  return _impl_.material_counts_;
}
...
// optional int32 hero_id = 1;
inline bool CMsgMonsterHunterInvestigation::_internal_has_hero_id() const {
  bool value = (_impl_._has_bits_[0] & 0x00000004u) != 0;
  return value;
}
inline bool CMsgMonsterHunterInvestigation::has_hero_id() const {
  return _internal_has_hero_id();
}
inline void CMsgMonsterHunterInvestigation::clear_hero_id() {
  _impl_.hero_id_ = 0;
  _impl_._has_bits_[0] &= ~0x00000004u;
}
inline int32_t CMsgMonsterHunterInvestigation::_internal_hero_id() const {
  return _impl_.hero_id_;
}
inline int32_t CMsgMonsterHunterInvestigation::hero_id() const {
  // @@protoc_insertion_point(field_get:CMsgMonsterHunterInvestigation.hero_id)
  return _internal_hero_id();
}
inline void CMsgMonsterHunterInvestigation::_internal_set_hero_id(int32_t value) {
  _impl_._has_bits_[0] |= 0x00000004u;
  _impl_.hero_id_ = value;
}
inline void CMsgMonsterHunterInvestigation::set_hero_id(int32_t value) {
  _internal_set_hero_id(value);
  // @@protoc_insertion_point(field_set:CMsgMonsterHunterInvestigation.hero_id)
}

// optional int32 persona_id = 2;
inline bool CMsgMonsterHunterInvestigation::_internal_has_persona_id() const {
  bool value = (_impl_._has_bits_[0] & 0x00000008u) != 0;
  return value;
}
inline bool CMsgMonsterHunterInvestigation::has_persona_id() const {
  return _internal_has_persona_id();
}
inline void CMsgMonsterHunterInvestigation::clear_persona_id() {
  _impl_.persona_id_ = 0;
  _impl_._has_bits_[0] &= ~0x00000008u;
}
inline int32_t CMsgMonsterHunterInvestigation::_internal_persona_id() const {
  return _impl_.persona_id_;
}
inline int32_t CMsgMonsterHunterInvestigation::persona_id() const {
  // @@protoc_insertion_point(field_get:CMsgMonsterHunterInvestigation.persona_id)
  return _internal_persona_id();
}
inline void CMsgMonsterHunterInvestigation::_internal_set_persona_id(int32_t value) {
  _impl_._has_bits_[0] |= 0x00000008u;
  _impl_.persona_id_ = value;
}
inline void CMsgMonsterHunterInvestigation::set_persona_id(int32_t value) {
  _internal_set_persona_id(value);
  // @@protoc_insertion_point(field_set:CMsgMonsterHunterInvestigation.persona_id)
}

// optional .CMsgMonsterHunterMaterialQuantity match_rewards = 3;
inline bool CMsgMonsterHunterInvestigation::_internal_has_match_rewards() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  PROTOBUF_ASSUME(!value || _impl_.match_rewards_ != nullptr);
  return value;
}
inline bool CMsgMonsterHunterInvestigation::has_match_rewards() const {
  return _internal_has_match_rewards();
}
inline void CMsgMonsterHunterInvestigation::clear_match_rewards() {
  if (_impl_.match_rewards_ != nullptr) _impl_.match_rewards_->Clear();
  _impl_._has_bits_[0] &= ~0x00000001u;
}
inline const ::CMsgMonsterHunterMaterialQuantity& CMsgMonsterHunterInvestigation::_internal_match_rewards() const {
  const ::CMsgMonsterHunterMaterialQuantity* p = _impl_.match_rewards_;
  return p != nullptr ? *p : reinterpret_cast<const ::CMsgMonsterHunterMaterialQuantity&>(
      ::_CMsgMonsterHunterMaterialQuantity_default_instance_);
}
inline const ::CMsgMonsterHunterMaterialQuantity& CMsgMonsterHunterInvestigation::match_rewards() const {
  // @@protoc_insertion_point(field_get:CMsgMonsterHunterInvestigation.match_rewards)
  return _internal_match_rewards();
}
inline void CMsgMonsterHunterInvestigation::unsafe_arena_set_allocated_match_rewards(
    ::CMsgMonsterHunterMaterialQuantity* match_rewards) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.match_rewards_);
  }
  _impl_.match_rewards_ = match_rewards;
  if (match_rewards) {
    _impl_._has_bits_[0] |= 0x00000001u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000001u;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:CMsgMonsterHunterInvestigation.match_rewards)
}
inline ::CMsgMonsterHunterMaterialQuantity* CMsgMonsterHunterInvestigation::release_match_rewards() {
  _impl_._has_bits_[0] &= ~0x00000001u;
  ::CMsgMonsterHunterMaterialQuantity* temp = _impl_.match_rewards_;
  _impl_.match_rewards_ = nullptr;
...
inline ::CMsgMonsterHunterMaterialQuantity* CMsgMonsterHunterInvestigation::unsafe_arena_release_match_rewards() {
  // @@protoc_insertion_point(field_release:CMsgMonsterHunterInvestigation.match_rewards)
  _impl_._has_bits_[0] &= ~0x00000001u;
  ::CMsgMonsterHunterMaterialQuantity* temp = _impl_.match_rewards_;
  _impl_.match_rewards_ = nullptr;
  return temp;
}
inline ::CMsgMonsterHunterMaterialQuantity* CMsgMonsterHunterInvestigation::_internal_mutable_match_rewards() {
  _impl_._has_bits_[0] |= 0x00000001u;
  if (_impl_.match_rewards_ == nullptr) {
    auto* p = CreateMaybeMessage<::CMsgMonsterHunterMaterialQuantity>(GetArenaForAllocation());
    _impl_.match_rewards_ = p;
  }
  return _impl_.match_rewards_;
}
inline ::CMsgMonsterHunterMaterialQuantity* CMsgMonsterHunterInvestigation::mutable_match_rewards() {
  ::CMsgMonsterHunterMaterialQuantity* _msg = _internal_mutable_match_rewards();
  // @@protoc_insertion_point(field_mutable:CMsgMonsterHunterInvestigation.match_rewards)
  return _msg;
}
inline void CMsgMonsterHunterInvestigation::set_allocated_match_rewards(::CMsgMonsterHunterMaterialQuantity* match_rewards) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.match_rewards_;
  }
  if (match_rewards) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(match_rewards);
    if (message_arena != submessage_arena) {
      match_rewards = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, match_rewards, submessage_arena);
    }
    _impl_._has_bits_[0] |= 0x00000001u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000001u;
  ...
  _impl_.match_rewards_ = match_rewards;
  // @@protoc_insertion_point(field_set_allocated:CMsgMonsterHunterInvestigation.match_rewards)
}

// optional .CMsgMonsterHunterMaterialQuantity hunt_rewards = 4;
inline bool CMsgMonsterHunterInvestigation::_internal_has_hunt_rewards() const {
  bool value = (_impl_._has_bits_[0] & 0x00000002u) != 0;
  PROTOBUF_ASSUME(!value || _impl_.hunt_rewards_ != nullptr);
  return value;
}
inline bool CMsgMonsterHunterInvestigation::has_hunt_rewards() const {
  return _internal_has_hunt_rewards();
}
inline void CMsgMonsterHunterInvestigation::clear_hunt_rewards() {
  if (_impl_.hunt_rewards_ != nullptr) _impl_.hunt_rewards_->Clear();
  _impl_._has_bits_[0] &= ~0x00000002u;
}
inline const ::CMsgMonsterHunterMaterialQuantity& CMsgMonsterHunterInvestigation::_internal_hunt_rewards() const {
  const ::CMsgMonsterHunterMaterialQuantity* p = _impl_.hunt_rewards_;
  return p != nullptr ? *p : reinterpret_cast<const ::CMsgMonsterHunterMaterialQuantity&>(
      ::_CMsgMonsterHunterMaterialQuantity_default_instance_);
}
inline const ::CMsgMonsterHunterMaterialQuantity& CMsgMonsterHunterInvestigation::hunt_rewards() const {
  // @@protoc_insertion_point(field_get:CMsgMonsterHunterInvestigation.hunt_rewards)
  return _internal_hunt_rewards();
}
inline void CMsgMonsterHunterInvestigation::unsafe_arena_set_allocated_hunt_rewards(
    ::CMsgMonsterHunterMaterialQuantity* hunt_rewards) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.hunt_rewards_);
  }
  _impl_.hunt_rewards_ = hunt_rewards;
  if (hunt_rewards) {
    _impl_._has_bits_[0] |= 0x00000002u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000002u;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:CMsgMonsterHunterInvestigation.hunt_rewards)
}
inline ::CMsgMonsterHunterMaterialQuantity* CMsgMonsterHunterInvestigation::release_hunt_rewards() {
  _impl_._has_bits_[0] &= ~0x00000002u;
  ::CMsgMonsterHunterMaterialQuantity* temp = _impl_.hunt_rewards_;
  _impl_.hunt_rewards_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  if (GetArenaForAllocation() == nullptr) { delete old; }
...
inline ::CMsgMonsterHunterMaterialQuantity* CMsgMonsterHunterInvestigation::unsafe_arena_release_hunt_rewards() {
  // @@protoc_insertion_point(field_release:CMsgMonsterHunterInvestigation.hunt_rewards)
  _impl_._has_bits_[0] &= ~0x00000002u;
  ::CMsgMonsterHunterMaterialQuantity* temp = _impl_.hunt_rewards_;
  _impl_.hunt_rewards_ = nullptr;
  return temp;
}
inline ::CMsgMonsterHunterMaterialQuantity* CMsgMonsterHunterInvestigation::_internal_mutable_hunt_rewards() {
  _impl_._has_bits_[0] |= 0x00000002u;
  if (_impl_.hunt_rewards_ == nullptr) {
    auto* p = CreateMaybeMessage<::CMsgMonsterHunterMaterialQuantity>(GetArenaForAllocation());
    _impl_.hunt_rewards_ = p;
  }
  return _impl_.hunt_rewards_;
}
inline ::CMsgMonsterHunterMaterialQuantity* CMsgMonsterHunterInvestigation::mutable_hunt_rewards() {
  ::CMsgMonsterHunterMaterialQuantity* _msg = _internal_mutable_hunt_rewards();
  // @@protoc_insertion_point(field_mutable:CMsgMonsterHunterInvestigation.hunt_rewards)
  return _msg;
}
inline void CMsgMonsterHunterInvestigation::set_allocated_hunt_rewards(::CMsgMonsterHunterMaterialQuantity* hunt_rewards) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.hunt_rewards_;
  }
  if (hunt_rewards) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(hunt_rewards);
    if (message_arena != submessage_arena) {
      hunt_rewards = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, hunt_rewards, submessage_arena);
    }
    _impl_._has_bits_[0] |= 0x00000002u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000002u;
  ...
  _impl_.hunt_rewards_ = hunt_rewards;
  // @@protoc_insertion_point(field_set_allocated:CMsgMonsterHunterInvestigation.hunt_rewards)
}

// optional bool success_state = 5;
inline bool CMsgMonsterHunterInvestigation::_internal_has_success_state() const {
  bool value = (_impl_._has_bits_[0] & 0x00000010u) != 0;
  return value;
}
inline bool CMsgMonsterHunterInvestigation::has_success_state() const {
  return _internal_has_success_state();
}
inline void CMsgMonsterHunterInvestigation::clear_success_state() {
  _impl_.success_state_ = false;
  _impl_._has_bits_[0] &= ~0x00000010u;
}
inline bool CMsgMonsterHunterInvestigation::_internal_success_state() const {
  return _impl_.success_state_;
}
inline bool CMsgMonsterHunterInvestigation::success_state() const {
  // @@protoc_insertion_point(field_get:CMsgMonsterHunterInvestigation.success_state)
  return _internal_success_state();
}
inline void CMsgMonsterHunterInvestigation::_internal_set_success_state(bool value) {
  _impl_._has_bits_[0] |= 0x00000010u;
  _impl_.success_state_ = value;
}
inline void CMsgMonsterHunterInvestigation::set_success_state(bool value) {
  _internal_set_success_state(value);
  // @@protoc_insertion_point(field_set:CMsgMonsterHunterInvestigation.success_state)
}
...
// optional int32 hero_id = 1;
inline bool CMsgMonsterHunterInvestigationGameState_HuntedBy::_internal_has_hero_id() const {
  bool value = (_impl_._has_bits_[0] & 0x00000002u) != 0;
  return value;
}
inline bool CMsgMonsterHunterInvestigationGameState_HuntedBy::has_hero_id() const {
  return _internal_has_hero_id();
}
inline void CMsgMonsterHunterInvestigationGameState_HuntedBy::clear_hero_id() {
  _impl_.hero_id_ = 0;
  _impl_._has_bits_[0] &= ~0x00000002u;
}
inline int32_t CMsgMonsterHunterInvestigationGameState_HuntedBy::_internal_hero_id() const {
  return _impl_.hero_id_;
}
inline int32_t CMsgMonsterHunterInvestigationGameState_HuntedBy::hero_id() const {
  // @@protoc_insertion_point(field_get:CMsgMonsterHunterInvestigationGameState.HuntedBy.hero_id)
  return _internal_hero_id();
}
inline void CMsgMonsterHunterInvestigationGameState_HuntedBy::_internal_set_hero_id(int32_t value) {
  _impl_._has_bits_[0] |= 0x00000002u;
  _impl_.hero_id_ = value;
}
inline void CMsgMonsterHunterInvestigationGameState_HuntedBy::set_hero_id(int32_t value) {
  _internal_set_hero_id(value);
  // @@protoc_insertion_point(field_set:CMsgMonsterHunterInvestigationGameState.HuntedBy.hero_id)
}

// optional int32 persona_id = 2;
inline bool CMsgMonsterHunterInvestigationGameState_HuntedBy::_internal_has_persona_id() const {
  bool value = (_impl_._has_bits_[0] & 0x00000004u) != 0;
  return value;
}
inline bool CMsgMonsterHunterInvestigationGameState_HuntedBy::has_persona_id() const {
  return _internal_has_persona_id();
}
inline void CMsgMonsterHunterInvestigationGameState_HuntedBy::clear_persona_id() {
  _impl_.persona_id_ = 0;
  _impl_._has_bits_[0] &= ~0x00000004u;
}
inline int32_t CMsgMonsterHunterInvestigationGameState_HuntedBy::_internal_persona_id() const {
  return _impl_.persona_id_;
}
inline int32_t CMsgMonsterHunterInvestigationGameState_HuntedBy::persona_id() const {
  // @@protoc_insertion_point(field_get:CMsgMonsterHunterInvestigationGameState.HuntedBy.persona_id)
  return _internal_persona_id();
}
inline void CMsgMonsterHunterInvestigationGameState_HuntedBy::_internal_set_persona_id(int32_t value) {
  _impl_._has_bits_[0] |= 0x00000004u;
  _impl_.persona_id_ = value;
}
inline void CMsgMonsterHunterInvestigationGameState_HuntedBy::set_persona_id(int32_t value) {
  _internal_set_persona_id(value);
  // @@protoc_insertion_point(field_set:CMsgMonsterHunterInvestigationGameState.HuntedBy.persona_id)
}

// optional .CMsgMonsterHunterMaterialQuantity hunt_rewards = 3;
inline bool CMsgMonsterHunterInvestigationGameState_HuntedBy::_internal_has_hunt_rewards() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  PROTOBUF_ASSUME(!value || _impl_.hunt_rewards_ != nullptr);
  return value;
}
inline bool CMsgMonsterHunterInvestigationGameState_HuntedBy::has_hunt_rewards() const {
  return _internal_has_hunt_rewards();
}
inline void CMsgMonsterHunterInvestigationGameState_HuntedBy::clear_hunt_rewards() {
  if (_impl_.hunt_rewards_ != nullptr) _impl_.hunt_rewards_->Clear();
  _impl_._has_bits_[0] &= ~0x00000001u;
}
inline const ::CMsgMonsterHunterMaterialQuantity& CMsgMonsterHunterInvestigationGameState_HuntedBy::_internal_hunt_rewards() const {
  const ::CMsgMonsterHunterMaterialQuantity* p = _impl_.hunt_rewards_;
  return p != nullptr ? *p : reinterpret_cast<const ::CMsgMonsterHunterMaterialQuantity&>(
      ::_CMsgMonsterHunterMaterialQuantity_default_instance_);
}
inline const ::CMsgMonsterHunterMaterialQuantity& CMsgMonsterHunterInvestigationGameState_HuntedBy::hunt_rewards() const {
  // @@protoc_insertion_point(field_get:CMsgMonsterHunterInvestigationGameState.HuntedBy.hunt_rewards)
  return _internal_hunt_rewards();
}
inline void CMsgMonsterHunterInvestigationGameState_HuntedBy::unsafe_arena_set_allocated_hunt_rewards(
    ::CMsgMonsterHunterMaterialQuantity* hunt_rewards) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.hunt_rewards_);
  }
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:CMsgMonsterHunterInvestigationGameState.HuntedBy.hunt_rewards)
}
inline ::CMsgMonsterHunterMaterialQuantity* CMsgMonsterHunterInvestigationGameState_HuntedBy::release_hunt_rewards() {
  _impl_._has_bits_[0] &= ~0x00000001u;
  ::CMsgMonsterHunterMaterialQuantity* temp = _impl_.hunt_rewards_;
  _impl_.hunt_rewards_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
...
inline ::CMsgMonsterHunterMaterialQuantity* CMsgMonsterHunterInvestigationGameState_HuntedBy::unsafe_arena_release_hunt_rewards() {
  // @@protoc_insertion_point(field_release:CMsgMonsterHunterInvestigationGameState.HuntedBy.hunt_rewards)
  _impl_._has_bits_[0] &= ~0x00000001u;
  ::CMsgMonsterHunterMaterialQuantity* temp = _impl_.hunt_rewards_;
  _impl_.hunt_rewards_ = nullptr;
  return temp;
}
inline ::CMsgMonsterHunterMaterialQuantity* CMsgMonsterHunterInvestigationGameState_HuntedBy::_internal_mutable_hunt_rewards() {
  _impl_._has_bits_[0] |= 0x00000001u;
  if (_impl_.hunt_rewards_ == nullptr) {
    auto* p = CreateMaybeMessage<::CMsgMonsterHunterMaterialQuantity>(GetArenaForAllocation());
    _impl_.hunt_rewards_ = p;
...
inline ::CMsgMonsterHunterMaterialQuantity* CMsgMonsterHunterInvestigationGameState_HuntedBy::mutable_hunt_rewards() {
  ::CMsgMonsterHunterMaterialQuantity* _msg = _internal_mutable_hunt_rewards();
  // @@protoc_insertion_point(field_mutable:CMsgMonsterHunterInvestigationGameState.HuntedBy.hunt_rewards)
  return _msg;
}
inline void CMsgMonsterHunterInvestigationGameState_HuntedBy::set_allocated_hunt_rewards(::CMsgMonsterHunterMaterialQuantity* hunt_rewards) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.hunt_rewards_;
  }
  ...
  _impl_.hunt_rewards_ = hunt_rewards;
  // @@protoc_insertion_point(field_set_allocated:CMsgMonsterHunterInvestigationGameState.HuntedBy.hunt_rewards)
}

// optional bool success_state = 4;
inline bool CMsgMonsterHunterInvestigationGameState_HuntedBy::_internal_has_success_state() const {
  bool value = (_impl_._has_bits_[0] & 0x00000008u) != 0;
  return value;
}
inline bool CMsgMonsterHunterInvestigationGameState_HuntedBy::has_success_state() const {
  return _internal_has_success_state();
}
inline void CMsgMonsterHunterInvestigationGameState_HuntedBy::clear_success_state() {
  _impl_.success_state_ = false;
  _impl_._has_bits_[0] &= ~0x00000008u;
}
inline bool CMsgMonsterHunterInvestigationGameState_HuntedBy::_internal_success_state() const {
  return _impl_.success_state_;
}
inline bool CMsgMonsterHunterInvestigationGameState_HuntedBy::success_state() const {
  // @@protoc_insertion_point(field_get:CMsgMonsterHunterInvestigationGameState.HuntedBy.success_state)
  return _internal_success_state();
}
inline void CMsgMonsterHunterInvestigationGameState_HuntedBy::_internal_set_success_state(bool value) {
  _impl_._has_bits_[0] |= 0x00000008u;
  _impl_.success_state_ = value;
}
inline void CMsgMonsterHunterInvestigationGameState_HuntedBy::set_success_state(bool value) {
  _internal_set_success_state(value);
  // @@protoc_insertion_point(field_set:CMsgMonsterHunterInvestigationGameState.HuntedBy.success_state)
}
...
// optional .CMsgMonsterHunterInvestigation selected_investigation = 1;
inline bool CMsgMonsterHunterInvestigationGameState::_internal_has_selected_investigation() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  PROTOBUF_ASSUME(!value || _impl_.selected_investigation_ != nullptr);
  return value;
}
inline bool CMsgMonsterHunterInvestigationGameState::has_selected_investigation() const {
  return _internal_has_selected_investigation();
}
inline void CMsgMonsterHunterInvestigationGameState::clear_selected_investigation() {
  if (_impl_.selected_investigation_ != nullptr) _impl_.selected_investigation_->Clear();
  _impl_._has_bits_[0] &= ~0x00000001u;
}
inline const ::CMsgMonsterHunterInvestigation& CMsgMonsterHunterInvestigationGameState::_internal_selected_investigation() const {
  const ::CMsgMonsterHunterInvestigation* p = _impl_.selected_investigation_;
  return p != nullptr ? *p : reinterpret_cast<const ::CMsgMonsterHunterInvestigation&>(
      ::_CMsgMonsterHunterInvestigation_default_instance_);
}
inline const ::CMsgMonsterHunterInvestigation& CMsgMonsterHunterInvestigationGameState::selected_investigation() const {
  // @@protoc_insertion_point(field_get:CMsgMonsterHunterInvestigationGameState.selected_investigation)
  return _internal_selected_investigation();
}
inline void CMsgMonsterHunterInvestigationGameState::unsafe_arena_set_allocated_selected_investigation(
    ::CMsgMonsterHunterInvestigation* selected_investigation) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.selected_investigation_);
  }
  _impl_.selected_investigation_ = selected_investigation;
  if (selected_investigation) {
    _impl_._has_bits_[0] |= 0x00000001u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000001u;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:CMsgMonsterHunterInvestigationGameState.selected_investigation)
}
inline ::CMsgMonsterHunterInvestigation* CMsgMonsterHunterInvestigationGameState::release_selected_investigation() {
  _impl_._has_bits_[0] &= ~0x00000001u;
  ::CMsgMonsterHunterInvestigation* temp = _impl_.selected_investigation_;
  _impl_.selected_investigation_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  if (GetArenaForAllocation() == nullptr) { delete old; }
...
inline ::CMsgMonsterHunterInvestigation* CMsgMonsterHunterInvestigationGameState::unsafe_arena_release_selected_investigation() {
  // @@protoc_insertion_point(field_release:CMsgMonsterHunterInvestigationGameState.selected_investigation)
  _impl_._has_bits_[0] &= ~0x00000001u;
  ::CMsgMonsterHunterInvestigation* temp = _impl_.selected_investigation_;
  _impl_.selected_investigation_ = nullptr;
  return temp;
}
inline ::CMsgMonsterHunterInvestigation* CMsgMonsterHunterInvestigationGameState::_internal_mutable_selected_investigation() {
  _impl_._has_bits_[0] |= 0x00000001u;
  if (_impl_.selected_investigation_ == nullptr) {
    auto* p = CreateMaybeMessage<::CMsgMonsterHunterInvestigation>(GetArenaForAllocation());
    _impl_.selected_investigation_ = p;
  }
  return _impl_.selected_investigation_;
}
inline ::CMsgMonsterHunterInvestigation* CMsgMonsterHunterInvestigationGameState::mutable_selected_investigation() {
  ::CMsgMonsterHunterInvestigation* _msg = _internal_mutable_selected_investigation();
  // @@protoc_insertion_point(field_mutable:CMsgMonsterHunterInvestigationGameState.selected_investigation)
  return _msg;
}
inline void CMsgMonsterHunterInvestigationGameState::set_allocated_selected_investigation(::CMsgMonsterHunterInvestigation* selected_investigation) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.selected_investigation_;
  }
  if (selected_investigation) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(selected_investigation);
    if (message_arena != submessage_arena) {
      selected_investigation = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, selected_investigation, submessage_arena);
    }
    _impl_._has_bits_[0] |= 0x00000001u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000001u;
  ...
  _impl_.selected_investigation_ = selected_investigation;
  // @@protoc_insertion_point(field_set_allocated:CMsgMonsterHunterInvestigationGameState.selected_investigation)
}

// repeated .CMsgMonsterHunterInvestigationGameState.HuntedBy hunted_by = 2;
inline int CMsgMonsterHunterInvestigationGameState::_internal_hunted_by_size() const {
  return _impl_.hunted_by_.size();
}
inline int CMsgMonsterHunterInvestigationGameState::hunted_by_size() const {
  return _internal_hunted_by_size();
}
inline void CMsgMonsterHunterInvestigationGameState::clear_hunted_by() {
  _impl_.hunted_by_.Clear();
}
inline ::CMsgMonsterHunterInvestigationGameState_HuntedBy* CMsgMonsterHunterInvestigationGameState::mutable_hunted_by(int index) {
  // @@protoc_insertion_point(field_mutable:CMsgMonsterHunterInvestigationGameState.hunted_by)
  return _impl_.hunted_by_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CMsgMonsterHunterInvestigationGameState_HuntedBy >*
CMsgMonsterHunterInvestigationGameState::mutable_hunted_by() {
  // @@protoc_insertion_point(field_mutable_list:CMsgMonsterHunterInvestigationGameState.hunted_by)
  return &_impl_.hunted_by_;
}
inline const ::CMsgMonsterHunterInvestigationGameState_HuntedBy& CMsgMonsterHunterInvestigationGameState::_internal_hunted_by(int index) const {
  return _impl_.hunted_by_.Get(index);
}
inline const ::CMsgMonsterHunterInvestigationGameState_HuntedBy& CMsgMonsterHunterInvestigationGameState::hunted_by(int index) const {
  // @@protoc_insertion_point(field_get:CMsgMonsterHunterInvestigationGameState.hunted_by)
  return _internal_hunted_by(index);
}
inline ::CMsgMonsterHunterInvestigationGameState_HuntedBy* CMsgMonsterHunterInvestigationGameState::_internal_add_hunted_by() {
  return _impl_.hunted_by_.Add();
}
inline ::CMsgMonsterHunterInvestigationGameState_HuntedBy* CMsgMonsterHunterInvestigationGameState::add_hunted_by() {
  ::CMsgMonsterHunterInvestigationGameState_HuntedBy* _add = _internal_add_hunted_by();
  // @@protoc_insertion_point(field_add:CMsgMonsterHunterInvestigationGameState.hunted_by)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CMsgMonsterHunterInvestigationGameState_HuntedBy >&
CMsgMonsterHunterInvestigationGameState::hunted_by() const {
  // @@protoc_insertion_point(field_list:CMsgMonsterHunterInvestigationGameState.hunted_by)
  return _impl_.hunted_by_;
}
...
// optional int32 hero_id = 1;
inline bool CMsgMonsterHunterCodexUpdateData_KillInfo::_internal_has_hero_id() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline bool CMsgMonsterHunterCodexUpdateData_KillInfo::has_hero_id() const {
  return _internal_has_hero_id();
}
inline void CMsgMonsterHunterCodexUpdateData_KillInfo::clear_hero_id() {
  _impl_.hero_id_ = 0;
  _impl_._has_bits_[0] &= ~0x00000001u;
}
inline int32_t CMsgMonsterHunterCodexUpdateData_KillInfo::_internal_hero_id() const {
  return _impl_.hero_id_;
}
inline int32_t CMsgMonsterHunterCodexUpdateData_KillInfo::hero_id() const {
  // @@protoc_insertion_point(field_get:CMsgMonsterHunterCodexUpdateData.KillInfo.hero_id)
  return _internal_hero_id();
}
inline void CMsgMonsterHunterCodexUpdateData_KillInfo::_internal_set_hero_id(int32_t value) {
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.hero_id_ = value;
}
inline void CMsgMonsterHunterCodexUpdateData_KillInfo::set_hero_id(int32_t value) {
  _internal_set_hero_id(value);
  // @@protoc_insertion_point(field_set:CMsgMonsterHunterCodexUpdateData.KillInfo.hero_id)
}

// optional int32 kill_count = 2;
inline bool CMsgMonsterHunterCodexUpdateData_KillInfo::_internal_has_kill_count() const {
  bool value = (_impl_._has_bits_[0] & 0x00000002u) != 0;
  return value;
}
inline bool CMsgMonsterHunterCodexUpdateData_KillInfo::has_kill_count() const {
  return _internal_has_kill_count();
}
inline void CMsgMonsterHunterCodexUpdateData_KillInfo::clear_kill_count() {
  _impl_.kill_count_ = 0;
  _impl_._has_bits_[0] &= ~0x00000002u;
}
inline int32_t CMsgMonsterHunterCodexUpdateData_KillInfo::_internal_kill_count() const {
  return _impl_.kill_count_;
}
inline int32_t CMsgMonsterHunterCodexUpdateData_KillInfo::kill_count() const {
  // @@protoc_insertion_point(field_get:CMsgMonsterHunterCodexUpdateData.KillInfo.kill_count)
  return _internal_kill_count();
}
inline void CMsgMonsterHunterCodexUpdateData_KillInfo::_internal_set_kill_count(int32_t value) {
  _impl_._has_bits_[0] |= 0x00000002u;
  _impl_.kill_count_ = value;
}
inline void CMsgMonsterHunterCodexUpdateData_KillInfo::set_kill_count(int32_t value) {
  _internal_set_kill_count(value);
  // @@protoc_insertion_point(field_set:CMsgMonsterHunterCodexUpdateData.KillInfo.kill_count)
}
...
// optional int32 player_hero = 1;
inline bool CMsgMonsterHunterCodexUpdateData::_internal_has_player_hero() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline bool CMsgMonsterHunterCodexUpdateData::has_player_hero() const {
  return _internal_has_player_hero();
}
inline void CMsgMonsterHunterCodexUpdateData::clear_player_hero() {
  _impl_.player_hero_ = 0;
  _impl_._has_bits_[0] &= ~0x00000001u;
}
inline int32_t CMsgMonsterHunterCodexUpdateData::_internal_player_hero() const {
  return _impl_.player_hero_;
}
inline int32_t CMsgMonsterHunterCodexUpdateData::player_hero() const {
  // @@protoc_insertion_point(field_get:CMsgMonsterHunterCodexUpdateData.player_hero)
  return _internal_player_hero();
}
inline void CMsgMonsterHunterCodexUpdateData::_internal_set_player_hero(int32_t value) {
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.player_hero_ = value;
}
inline void CMsgMonsterHunterCodexUpdateData::set_player_hero(int32_t value) {
  _internal_set_player_hero(value);
  // @@protoc_insertion_point(field_set:CMsgMonsterHunterCodexUpdateData.player_hero)
}

// repeated int32 allies = 2;
inline int CMsgMonsterHunterCodexUpdateData::_internal_allies_size() const {
  return _impl_.allies_.size();
}
inline int CMsgMonsterHunterCodexUpdateData::allies_size() const {
  return _internal_allies_size();
}
inline void CMsgMonsterHunterCodexUpdateData::clear_allies() {
  _impl_.allies_.Clear();
}
inline int32_t CMsgMonsterHunterCodexUpdateData::_internal_allies(int index) const {
  return _impl_.allies_.Get(index);
}
inline int32_t CMsgMonsterHunterCodexUpdateData::allies(int index) const {
  // @@protoc_insertion_point(field_get:CMsgMonsterHunterCodexUpdateData.allies)
  return _internal_allies(index);
}
inline void CMsgMonsterHunterCodexUpdateData::set_allies(int index, int32_t value) {
  _impl_.allies_.Set(index, value);
  // @@protoc_insertion_point(field_set:CMsgMonsterHunterCodexUpdateData.allies)
}
inline void CMsgMonsterHunterCodexUpdateData::_internal_add_allies(int32_t value) {
  _impl_.allies_.Add(value);
}
inline void CMsgMonsterHunterCodexUpdateData::add_allies(int32_t value) {
  _internal_add_allies(value);
  // @@protoc_insertion_point(field_add:CMsgMonsterHunterCodexUpdateData.allies)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >&
CMsgMonsterHunterCodexUpdateData::_internal_allies() const {
  return _impl_.allies_;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >&
CMsgMonsterHunterCodexUpdateData::allies() const {
  // @@protoc_insertion_point(field_list:CMsgMonsterHunterCodexUpdateData.allies)
  return _internal_allies();
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >*
CMsgMonsterHunterCodexUpdateData::_internal_mutable_allies() {
  return &_impl_.allies_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >*
CMsgMonsterHunterCodexUpdateData::mutable_allies() {
  // @@protoc_insertion_point(field_mutable_list:CMsgMonsterHunterCodexUpdateData.allies)
  return _internal_mutable_allies();
}

// repeated int32 enemies = 3;
inline int CMsgMonsterHunterCodexUpdateData::_internal_enemies_size() const {
  return _impl_.enemies_.size();
}
inline int CMsgMonsterHunterCodexUpdateData::enemies_size() const {
  return _internal_enemies_size();
}
inline void CMsgMonsterHunterCodexUpdateData::clear_enemies() {
  _impl_.enemies_.Clear();
}
inline int32_t CMsgMonsterHunterCodexUpdateData::_internal_enemies(int index) const {
  return _impl_.enemies_.Get(index);
}
inline int32_t CMsgMonsterHunterCodexUpdateData::enemies(int index) const {
  // @@protoc_insertion_point(field_get:CMsgMonsterHunterCodexUpdateData.enemies)
  return _internal_enemies(index);
}
inline void CMsgMonsterHunterCodexUpdateData::set_enemies(int index, int32_t value) {
  _impl_.enemies_.Set(index, value);
  // @@protoc_insertion_point(field_set:CMsgMonsterHunterCodexUpdateData.enemies)
}
inline void CMsgMonsterHunterCodexUpdateData::_internal_add_enemies(int32_t value) {
  _impl_.enemies_.Add(value);
}
inline void CMsgMonsterHunterCodexUpdateData::add_enemies(int32_t value) {
  _internal_add_enemies(value);
  // @@protoc_insertion_point(field_add:CMsgMonsterHunterCodexUpdateData.enemies)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >&
CMsgMonsterHunterCodexUpdateData::_internal_enemies() const {
  return _impl_.enemies_;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >&
CMsgMonsterHunterCodexUpdateData::enemies() const {
  // @@protoc_insertion_point(field_list:CMsgMonsterHunterCodexUpdateData.enemies)
  return _internal_enemies();
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >*
CMsgMonsterHunterCodexUpdateData::_internal_mutable_enemies() {
  return &_impl_.enemies_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >*
CMsgMonsterHunterCodexUpdateData::mutable_enemies() {
  // @@protoc_insertion_point(field_mutable_list:CMsgMonsterHunterCodexUpdateData.enemies)
  return _internal_mutable_enemies();
}

// repeated .CMsgMonsterHunterCodexUpdateData.KillInfo player_kills = 4;
inline int CMsgMonsterHunterCodexUpdateData::_internal_player_kills_size() const {
  return _impl_.player_kills_.size();
}
inline int CMsgMonsterHunterCodexUpdateData::player_kills_size() const {
  return _internal_player_kills_size();
}
inline void CMsgMonsterHunterCodexUpdateData::clear_player_kills() {
  _impl_.player_kills_.Clear();
}
inline ::CMsgMonsterHunterCodexUpdateData_KillInfo* CMsgMonsterHunterCodexUpdateData::mutable_player_kills(int index) {
  // @@protoc_insertion_point(field_mutable:CMsgMonsterHunterCodexUpdateData.player_kills)
  return _impl_.player_kills_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CMsgMonsterHunterCodexUpdateData_KillInfo >*
CMsgMonsterHunterCodexUpdateData::mutable_player_kills() {
  // @@protoc_insertion_point(field_mutable_list:CMsgMonsterHunterCodexUpdateData.player_kills)
  return &_impl_.player_kills_;
}
inline const ::CMsgMonsterHunterCodexUpdateData_KillInfo& CMsgMonsterHunterCodexUpdateData::_internal_player_kills(int index) const {
  return _impl_.player_kills_.Get(index);
}
inline const ::CMsgMonsterHunterCodexUpdateData_KillInfo& CMsgMonsterHunterCodexUpdateData::player_kills(int index) const {
  // @@protoc_insertion_point(field_get:CMsgMonsterHunterCodexUpdateData.player_kills)
  return _internal_player_kills(index);
}
inline ::CMsgMonsterHunterCodexUpdateData_KillInfo* CMsgMonsterHunterCodexUpdateData::_internal_add_player_kills() {
  return _impl_.player_kills_.Add();
}
inline ::CMsgMonsterHunterCodexUpdateData_KillInfo* CMsgMonsterHunterCodexUpdateData::add_player_kills() {
  ::CMsgMonsterHunterCodexUpdateData_KillInfo* _add = _internal_add_player_kills();
  // @@protoc_insertion_point(field_add:CMsgMonsterHunterCodexUpdateData.player_kills)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CMsgMonsterHunterCodexUpdateData_KillInfo >&
CMsgMonsterHunterCodexUpdateData::player_kills() const {
  // @@protoc_insertion_point(field_list:CMsgMonsterHunterCodexUpdateData.player_kills)
  return _impl_.player_kills_;
}
...
template <> struct is_proto_enum< ::EItemSuggestPreference> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::EItemSuggestPreference>() {
  return ::EItemSuggestPreference_descriptor();
}
template <> struct is_proto_enum< ::ETimerAlertType> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::ETimerAlertType>() {
  return ::ETimerAlertType_descriptor();
}
